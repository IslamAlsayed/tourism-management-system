    ...
    <div class="kt-container-fixed">
        <form action="{{ route('dashboard.touristservices.services.update', $touristService->id) }}" method="POST"
            ...
            <div class="grid gap-6 lg:gap-4">
                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 border-custom-b pb-6">
                            <div>
                                ...
                                <input type="text" name="name" class="kt-input h-[42px] font-medium"
                                            ...
                                            <select name="pricing_unit" id="pricing_unit"
                                                ...
                                                @foreach ($pricing_units as $unit)
                                                    <option value="{{ $unit->key }}"
                                                        {{ $touristService->pricing_unit == $unit->key ? 'selected' : '' }}>
                                                        {{ $unit->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    @foreach ($modules ?? [] as $key => $module)
                                        ...
                                        <label class="module-toggle cursor-pointer">
                                            <input type="checkbox" name="target_modules[]" value="{{ $key }}"
                                                class="module-checkbox sr-only" {{ $isSelected ? 'checked' : '' }}
                                                onchange="toggleModuleVisual(this)">
                                            <div
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <label id="label_flat" class="relative cursor-pointer group">
                                    <input type="radio" name="pricing_type" value="flat" class="peer sr-only"
                                        {{ $touristService->pricing_type === 'flat' ? 'checked' : '' }}
                                        onchange="togglePricingMode('flat')">
                                    <div
                                ...
                                <label id="label_seasonal" class="relative cursor-pointer group">
                                    <input type="radio" name="pricing_type" value="seasonal" class="peer sr-only"
                                        {{ $touristService->pricing_type === 'seasonal' ? 'checked' : '' }}
                            ...
                            <div>
                                ...
                                @if (!empty($touristService->photo))
                                    <div id="existing-photo" class="relative w-fit mt-8">
                                        <img src="{{ asset('storage/' . $touristService->photo) }}"
                ...
                <x-custom-fields module-name="tourists" entity-type="TouristService" :entity="$touristService" />
