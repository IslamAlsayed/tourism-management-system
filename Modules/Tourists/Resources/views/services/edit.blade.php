...
@section('content')
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('dashboard.tourists.services.update', $touristService->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="grid gap-6 lg:gap-4">
                ...
                <div class="kt-card">
                    ...
                    <div class="kt-card-body p-4 pb-0">
                        ...
                        @livewire('geography::livewire.regions.location-select-base', ['record' => $touristService])
                    </div>
                </div>
