    ...
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.tourists.sites.edit', $touristSite->id) }}" class="kt-btn kt-btn-primary md:hidden">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        ...
                        @if ($touristSite->city)
                            <div>
                                ...
                                <a href="{{ route('dashboard.geography.cities.show', $touristSite->city->id) }}" class="block text-sm text-primary underline">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        @if ($touristSite->city || $touristSite->country)
                            <div>
                                ...
                                <a href="{{ route('dashboard.geography.countries.show', $touristSite->city->country->id) }}"
                        ...
                        @if ($touristSite->city || $touristSite->state)
                            <div>
                                ...
                                <a href="{{ route('dashboard.geography.states.show', $touristSite->city->state->id) }}"
                                    class="block text-sm text-primary underline">
