...
class TouristServices extends Component
{
    ...
    public function exportSelectedPDF()
    {
        ...
        $result = $this->exportSelectedPdfForModel($this->selectedIds ?? [], TouristService::class, $cols, 'tourist-services');
        $this->selectedIds = [];
    ...
    {
        $cols = !empty($this->pendingColumns) ? $this->pendingColumns : ($this->columns ?? null);
        $result = $this->exportSelectedExcelForModel($this->selectedIds ?? [], TouristService::class, $cols, 'tourist-services', $extension);
        $this->selectedIds = [];
        $this->selectPage = false;
        $this->dispatch('reset-checkout-boxes');
        return $result;
    ...
    public function render()
    {
        ...
        return view('tourists::livewire.services', ['data' => $data]);
    }
}
