...
namespace Modules\TravelDocuments\Http\Requests\TravelPass;
...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'visa_type' => ['required', 'string', 'in:none_required,on_arrival,e_visa,embassy_required,transit,restricted'],
            'visa_category' => ['required', 'string', 'in:tourist,business,medical,student,work,transit'],
