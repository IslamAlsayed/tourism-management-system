...
@section('content')
    ...
    <div class="container-fixed">
        <form action="{{ route('dashboard.traveldocuments.visa-requirements.update', $visaRequirement->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid gap-4 lg:gap-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="">
                                ...
                                <select name="visa_type" id="visa_type" class="kt-select basic-single" required>
                                    <option value="none_required" {{ $visaRequirement->visa_type == 'none_required' ? 'selected' : '' }}>
                                        {{ __('main.none_required') }}</option>
                                    <option value="on_arrival" {{ $visaRequirement->visa_type == 'on_arrival' ? 'selected' : '' }}>{{ __('main.on_arrival') }}
                                    </option>
                                    <option value="e_visa" {{ $visaRequirement->visa_type == 'e_visa' ? 'selected' : '' }}>{{ __('main.e_visa') }}</option>
                                    <option value="embassy_required" {{ $visaRequirement->visa_type == 'embassy_required' ? 'selected' : '' }}>
                                        {{ __('main.embassy_required') }}</option>
                                    <option value="transit" {{ $visaRequirement->visa_type == 'transit' ? 'selected' : '' }}>{{ __('main.transit') }}</option>
                                    <option value="restricted" {{ $visaRequirement->visa_type == 'restricted' ? 'selected' : '' }}>{{ __('main.restricted') }}
                                    </option>
                                </select>
                                @error('visa_type')
                            ...
                            <div class="">
                                ...
                                <select name="visa_category" id="visa_category" class="kt-select basic-single" required>
                                    ...
                                    <option value="business" {{ $visaRequirement->visa_category == 'business' ? 'selected' : '' }}>{{ __('main.business') }}
                                    </option>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            ...
                            <div class="">
                                ...
                                <input type="number" step="0.01" min="0" name="visa_fee" id="visa_fee" class="kt-input h-[45px]"
                                    value="{{ $visaRequirement->visa_fee }}">
                                @error('visa_fee')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="number" min="0" name="max_stay_days" id="max_stay_days" class="kt-input h-[45px]"
                                    value="{{ $visaRequirement->max_stay_days }}">
                                @error('max_stay_days')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="number" min="0" name="visa_validity_days" id="visa_validity_days" class="kt-input h-[45px]"
                                    value="{{ $visaRequirement->visa_validity_days }}">
                            ...
                            <div class="">
                                ...
                                <input type="number" step="0.01" min="0" name="departure_tax" id="departure_tax" class="kt-input h-[45px]"
                                    value="{{ $visaRequirement->departure_tax }}">
                                @error('departure_tax')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="number" min="0" name="processing_time_days" id="processing_time_days" class="kt-input h-[45px]"
                                    value="{{ $visaRequirement->processing_time_days }}">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div class="">
                                ...
                                <input type="url" name="application_url" id="application_url" class="kt-input h-[45px]"
                                    value="{{ $visaRequirement->application_url }}" placeholder="https://...">
                            ...
                            <div class="">
                                ...
                                <input type="url" name="official_source_url" id="official_source_url" class="kt-input h-[45px]"
                                    value="{{ $visaRequirement->official_source_url }}" placeholder="https://...">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div class="">
                                ...
                                <input type="date" name="effective_from" id="effective_from" class="kt-input h-[45px]"
                                    value="{{ $visaRequirement->effective_from }}">
                            ...
                            <div class="">
                                ...
                                <input type="date" name="effective_until" id="effective_until" class="kt-input h-[45px]"
                                    value="{{ $visaRequirement->effective_until }}">
                ...
                <!-- Update Submit -->
                @include('components.elements.update-save-submit', [
