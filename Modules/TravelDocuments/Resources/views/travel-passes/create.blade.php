...
@section('content')
    ...
    <div class="container-fixed">
        <form action="{{ route('dashboard.traveldocuments.travel-passes.store') }}" method="POST">
            @csrf
            ...
            <div class="grid gap-4 lg:gap-6">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="">
                                ...
                                <input type="text" name="name_ar" id="name_ar" class="kt-input h-[45px]" dir="rtl" value="{{ old('name_ar') }}"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="">
                                ...
                                <input type="number" min="1" name="validity_days" id="validity_days" class="kt-input h-[45px]"
                                    value="{{ old('validity_days', 14) }}" required>
                                @error('validity_days')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="number" min="0" name="special_attraction_days" id="special_attraction_days" class="kt-input h-[45px]"
                                    value="{{ old('special_attraction_days', 1) }}">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="url" name="official_purchase_url" id="official_purchase_url" class="kt-input h-[45px]"
                                    value="{{ old('official_purchase_url') }}" placeholder="https://...">
                ...
                <!-- Save Submit -->
                @include('components.elements.save-submit', ['models' => 'dashboard.traveldocuments.travel-passes', 'model' => 'travel-pass'])
            </div>
        </form>
    </div>
@endsection
