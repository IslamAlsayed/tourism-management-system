...
@section('content')
    ...
    <div class="container-fixed">
        <form class="space-y-6" method="POST" action="{{ route('dashboard.cruises.update', $cruise) }}"
                            ...
                            <div class="kt-card-body p-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    @php
                                        $startCountryId = old(
                                            'start_country_id',
                                            $cruise->main_start_point_id
                                                ? \Modules\Geography\Entities\City::find($cruise->main_start_point_id)
                                                        ->country_id ?? ''
                                                : '',
                                        );
                                        $endCountryId = old(
                                            'end_country_id',
                                            $cruise->main_end_point_id
                                                ? \Modules\Geography\Entities\City::find($cruise->main_end_point_id)
                                                        ->country_id ?? ''
                                                : '',
                                        );
                                    @endphp
                                                ...
                                                <select id="start_country_id" name="start_country_id" class="kt-input"
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option value="{{ $country->id }}"
                                                            {{ $startCountryId == $country->id ? 'selected' : '' }}>
                                                ...
                                                <select name="main_start_point_id" id="main_start_point_id" class="kt-input"
                                                    ...
                                                    @foreach ($cities as $city)
                                                        <option value="{{ $city->id }}"
                                                            ...
                                                            {{ old('main_start_point_id', $cruise->main_start_point_id) == $city->id ? 'selected' : '' }}
                                                            style="display: none;">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <div class="kt-input-group">
                                                ...
                                                <select id="end_country_id" class="kt-input" data-control="select2">
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option value="{{ $country->id }}"
                                                            {{ $endCountryId == $country->id ? 'selected' : '' }}>
                                                            {{ app()->getLocale() == 'ar' ? $country->name_ar : $country->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div>
                                            <label for="main_end_point_id"
                                                class="kt-label mb-2">{{ __('main.main_end_point') }}
                                                ({{ __('main.city') }})</label>
                                            <div class="kt-input-group">
                                                <span class="kt-input-addon kt-input-addon-icon">
                                                    <i class="fa-duotone fa-solid fa-location-dot"></i>
                                                ...
                                                <select name="main_end_point_id" id="main_end_point_id" class="kt-input"
                                                    ...
                                                    @foreach ($cities as $city)
                                                        <option value="{{ $city->id }}"
                                                            data-country="{{ $city->country_id }}"
                                                            {{ old('main_end_point_id', $cruise->main_end_point_id) == $city->id ? 'selected' : '' }}
                                                            style="display: none;">
                                                            {{ app()->getLocale() == 'ar' ? $city->name_ar : $city->name }}
                                                        </option>
                                                    @endforeach
                        ...
                        <div class="kt-card">
                            ...
                            <div class="kt-card-body p-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="kt-input-group">
                                            ...
                                            <input type="text" name="name" id="name" class="kt-input"
                                                value="{{ old('name', $cruise->name) }}" required>
                                        </div>
                                        @error('name')
                                    ...
                                    <div>
                                        ...
                                        <div class="kt-input-group">
                                            ...
                                            <input type="text" name="name_ar" id="name_ar" class="kt-input"
                                                value="{{ old('name_ar', $cruise->name_ar) }}">
                                        </div>
                                        @error('name_ar')
                                            <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                        @enderror
                                    ...
                                    {{-- Vessel Class --}}
                                    <div>
                                        <label for="vessel_class"
                                            class="kt-label mb-2">{{ __('main.vessel_class') }}</label>
                                        <div class="kt-input-group">
                                            <span class="kt-input-addon kt-input-addon-icon">
                                            ...
                                            <select name="vessel_class" id="vessel_class" class="kt-input">
                                                ...
                                                <option value="Standard"
                                                    {{ old('vessel_class', $cruise->vessel_class) == 'Standard' ? 'selected' : '' }}>
                                                    {{ __('main.vessel_class_standard') }}</option>
                                                <option value="Luxury"
                                                    {{ old('vessel_class', $cruise->vessel_class) == 'Luxury' ? 'selected' : '' }}>
                                                    {{ __('main.vessel_class_luxury') }}</option>
                                                <option value="Mega"
                                                    {{ old('vessel_class', $cruise->vessel_class) == 'Mega' ? 'selected' : '' }}>
                                    ...
                                    <div>
                                        ...
                                        <div class="kt-input-group">
                                            ...
                                            <select name="type" id="type" class="kt-input">
                                                <option value="" disabled>{{ __('main.select_option') }}</option>
                                                <option value="Ocean"
                                                    {{ old('type', $cruise->type) == 'Ocean' ? 'selected' : '' }}>
                                                    {{ __('main.type_ocean') }}
                                                </option>
                                                <option value="River"
                                                    {{ old('type', $cruise->type) == 'River' ? 'selected' : '' }}>
                                                    {{ __('main.type_river') }}
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="kt-input-group">
                                            ...
                                            <select name="vessel_nationality_id" id="vessel_nationality_id"
                                                class="kt-input" data-control="select2">
                                                <option value="" selected disabled>{{ __('main.select_option') }}
                                                </option>
                                                @foreach ($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                        {{ old('vessel_nationality_id', $cruise->vessel_nationality_id) == $country->id ? 'selected' : '' }}>
                                                        {{ app()->getLocale() == 'ar' ? $country->name_ar : $country->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                        ...
                        <div class="kt-card">
                            ...
                            <div class="kt-card-body p-4">
                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                                    {{-- Cabins --}}
                                    <div>
                                        <label for="total_cabins"
                                            class="kt-label mb-2">{{ __('main.total_cabins') }}</label>
                                        <div class="kt-input-group">
                                            <span class="kt-input-addon kt-input-addon-icon">
                                                <i class="fa-duotone fa-solid fa-store"></i>
                                            </span>
                                            <input type="number" name="total_cabins" id="total_cabins" class="kt-input"
                                                value="{{ old('total_cabins', $cruise->total_cabins) }}" min="0">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="kt-input-group">
                                            ...
                                            <input type="number" name="deck_count" id="deck_count" class="kt-input"
                                                value="{{ old('deck_count', $cruise->deck_count) }}" min="0">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="kt-input-group">
                                            ...
                                            <input type="number" name="built_year" id="built_year" class="kt-input"
                                                value="{{ old('built_year', $cruise->built_year) }}" min="1900"
                                                max="{{ date('Y') }}">
                                        </div>
                                    </div>
                                    ...
                                    {{-- Renovated Year --}}
                                    <div>
                                        <label for="renovated_year"
                                            class="kt-label mb-2">{{ __('main.renovated_year') }}</label>
                                        <div class="kt-input-group">
                                            <span class="kt-input-addon kt-input-addon-icon">
                                                <i class="fa-duotone fa-solid fa-calendar-add"></i>
                                            </span>
                                            <input type="number" name="renovated_year" id="renovated_year"
                                                class="kt-input"
                                                value="{{ old('renovated_year', $cruise->renovated_year) }}"
                                                min="1900" max="{{ date('Y') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <label for="length_meters"
                                            class="kt-label mb-2">{{ __('main.length_meters') }}</label>
                                        <div class="kt-input-group">
                                            <span class="kt-input-addon kt-input-addon-icon">
                                            ...
                                            <input type="number" step="0.01" name="length_meters" id="length_meters"
                                                class="kt-input"
                                                value="{{ old('length_meters', $cruise->length_meters) }}"
                                                min="0">
                                        </div>
                                    </div>
                                    ...
                                    {{-- Draft --}}
                                    <div>
                                        <label for="draft_meters"
                                            class="kt-label mb-2">{{ __('main.draft_meters') }}</label>
                                        <div class="kt-input-group">
                                            <span class="kt-input-addon kt-input-addon-icon">
                                                <i class="fa-duotone fa-solid fa-arrow-down-2"></i>
                                            </span>
                                            <input type="number" step="0.01" name="draft_meters" id="draft_meters"
                                                class="kt-input" value="{{ old('draft_meters', $cruise->draft_meters) }}"
                                                min="0">
                                        </div>
                                    </div>
                                </div>
