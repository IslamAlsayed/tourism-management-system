    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.accommodations.meals.edit', $meal->id) }}" class="kt-btn kt-btn-primary md:hidden">
                    <i class="fa-duotone fa-solid fa-pen text-sm me-2"></i>
                    {{ __('main.edit') }}
                </a>
                <a href="{{ route('dashboard.accommodations.meals.index') }}" class="kt-btn kt-btn-outline">
        ...
        <div class="grid gap-4 lg:gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                @livewire('toggle-switch', [
                                    'modelId' => $meal->id,
                                    'modelType' => '\\Modules\\Accommodations\\Entities\\Meal',
                                    'field' => 'is_included',
            ...
            <div class="flex items-center gap-4">
                ...
                @include('components.elements.delete-form', [
                    'model' => 'dashboard.accommodations.meals',
                    'id' => $meal->id,
                ])
                <a href="{{ route('dashboard.accommodations.meals.index') }}" class="kt-btn kt-btn-outline">
                    {{ __('main.back_to_types', ['types' => __('main.meals')]) }}
