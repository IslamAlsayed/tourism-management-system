    ...
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.accommodations.types.edit', $type['id']) }}" class="kt-btn kt-btn-primary md:hidden">
        ...
        <div class="grid gap-4 lg:gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                @livewire('toggle-switch', [
                                    'modelId' => $type['id'],
                                    'modelType' => '\\Modules\\Accommodations\\Entities\\Type',
                                    'field' => 'is_active',
                ...
                <div class="kt-card">
                    <div class="kt-card-header">
                        ...
                        <div class="flex items-center gap-4">
                            <a href="{{ route('dashboard.accommodations.create') }}" class="kt-btn bg-primary text-white" toggle-button>
                                {{ __('main.create_type', ['type' => __('main.accommodation')]) }}
                            </a>
                            <a href="{{ route('dashboard.restaurants.create') }}" class="kt-btn bg-primary text-white" toggle-button>
            ...
            <div class="flex items-center gap-4">
                ...
                @include('components.elements.delete-form', [
                    'model' => 'dashboard.accommodations.types',
                    'id' => $type['id'],
                ])
                <a href="{{ route('dashboard.accommodations.types.index') }}" class="kt-btn kt-btn-outline">
