    ...
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.restaurants.meals.edit', $meal->id) }}" class="kt-btn kt-btn-primary md:hidden">
        ...
        <div class="grid gap-4 lg:gap-6">
                ...
                <div class="kt-card-body p-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-secondary-foreground">
                                {{ $meal->restaurant?->name ?: __('main.na') }}</p>
                        </div>
                        <div>
            ...
            <div class="flex items-center gap-4">
                ...
                @include('components.elements.delete-form', [
                    'model' => 'dashboard.restaurants.meals',
                    'id' => $meal->id,
                ])
                <a href="{{ route('dashboard.restaurants.meals.index') }}" class="kt-btn kt-btn-outline">
                    {{ __('main.back_to_types', ['types' => __('main.meals')]) }}
