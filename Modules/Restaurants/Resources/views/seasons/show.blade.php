...
@section('content')
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.restaurants.seasons.edit', $season->id) }}" class="kt-btn kt-btn-primary md:hidden">
                    <i class="fa-duotone fa-solid fa-pen text-sm me-2"></i>
                    {{ __('main.edit') }}
                </a>
                <a href="{{ route('dashboard.restaurants.seasons.index') }}" class="kt-btn kt-btn-outline">
    ...
    <div class="container-fixed">
        <div class="grid gap-4 lg:gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                @livewire('toggle-switch', [
                                    'modelId' => $season->id,
                                    'modelType' => '\\Modules\\restaurants\\Entities\\Season',
                                    'field' => 'is_active',
            ...
            @if ($season->model && Str::contains($season->model_type, 'Restaurant'))
            ...
            <div class="flex items-center gap-4">
                ...
                @include('components.elements.delete-form', [
                    'model' => 'dashboard.restaurants.seasons',
                    'id' => $season->id,
                ])
                <a href="{{ route('dashboard.restaurants.seasons.index') }}" class="kt-btn kt-btn-outline">
                    {{ __('main.back_to_types', ['types' => __('main.seasons')]) }}
