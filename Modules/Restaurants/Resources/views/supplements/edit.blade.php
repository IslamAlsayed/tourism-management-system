        ...
        <div class="kt-card p-4">
            <div class="kt-card-body">
                <form class="space-y-6" method="POST"
                    action="{{ route('dashboard.restaurants.supplements.update', $supplement->id) }}">
                    @csrf
                    ...
                    <div class="grid gap-4 lg:gap-6">
                            ...
                            <div class="align-self-end">
                                ...
                                <select name="restaurant_id" id="restaurant_id" class="kt-select basic-single" required>
                                    ...
                                    @foreach ($restaurants as $id => $name)
                                        <option value="{{ $id }}"
                                            {{ $supplement->restaurant_id == $id ? 'selected' : '' }}>
                                            {{ $name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <x-custom-fields module-name="restaurants" entity-type="RestaurantSupplement" :entity="$supplement" />
