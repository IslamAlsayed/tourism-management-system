    ...
    <div class="kt-container-fixed">
        <div class="kt-card p-4">
            <div class="kt-card-body">
                <form class="space-y-6" method="POST" action="{{ route('dashboard.restaurants.supplements.store') }}">
                    @csrf
                    ...
                    <div class="grid gap-4 lg:gap-6">
                        ...
                        <x-custom-fields module-name="restaurants" entity-type="RestaurantSupplement" />
