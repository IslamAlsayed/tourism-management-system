                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 mb-4">
                            ...
                            <div class="align-self-end">
                                ...
                                <select name="rating" id="rating" class="kt-select basic-single">
                                    ...
                                    @foreach (range(1, 5) as $item)
                                        <option value="{{ $item }}" {{ old('rating') == $item ? 'selected' : '' }}>
                                            {{ $item }} {{ __('main.stars') }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="text" name="specialty" id="specialty" class="kt-input h-[45px]" value="{{ old('specialty') }}">
                                @error('specialty')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="email" name="email_01" id="email_01" class="kt-input h-[45px]" value="{{ old('email_01') }}">
                                @error('email_01')
                                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="email" name="email_02" id="email_02" class="kt-input h-[45px]" value="{{ old('email_02') }}">
                                @error('email_02')
                                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="tel" name="phone_01" id="phone_01" class="kt-input h-[45px]" value="{{ old('phone_01') }}">
                                @error('phone_01')
                                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="tel" name="phone_02" id="phone_02" class="kt-input h-[45px]" value="{{ old('phone_02') }}">
                                @error('phone_02')
                                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="text" name="fax" id="fax" class="kt-input h-[45px]" value="{{ old('fax') }}">
                                @error('fax')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
