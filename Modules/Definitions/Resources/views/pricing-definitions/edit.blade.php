...
@section('content')
    ...
    <div class="container-fixed">
        <form action="{{ route('dashboard.definitions.pricing-definitions.update', $pricing->id) }}" method="POST"
            ...
            <div class="grid gap-4 lg:gap-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            ...
                            <div>
                                ...
                                <select name="category" id="category" class="kt-select h-[45px]">
                                    ...
                                    @foreach (\Modules\Definitions\Entities\PricingDefinition::getCategories() as $catKey => $catLabel)
                                        <option value="{{ $catKey }}"
                ...
                <div class="kt-card">
                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            @foreach (\Modules\Definitions\Entities\PricingDefinition::getAvailableModules() as $modKey => $modLabel)
                                @php
                ...
                @include('components.elements.update-submit', [
                    'models' => 'dashboard.definitions.pricing-definitions',
