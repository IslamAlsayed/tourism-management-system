...
use Modules\Definitions\Entities\PricingDefinitionModule;
...
class PricingDefinitionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('definitions::pricing-definitions.index', compact('category'));
    }

    public function create()
    {
        return view('definitions::pricing-definitions.create');
    }
    ...
    public function store(StoreRequest $request)
    {
        ...
        if (!$pricing)
            return redirect()->route('dashboard.definitions.pricing-definitions.index')->withError(__('messages.type_creation_failed', ['type' => __('main.pricing-definition')]));
        ...
        return $request->has('save_and_add')
            ...
            : redirect()->route('dashboard.definitions.pricing-definitions.index')->withSuccess(__('messages.type_created', ['type' => __('main.pricing-definition')]));
    }
    ...
    public function show($id)
    {
        ...
        return view('definitions::pricing-definitions.show', compact('pricing'));
    }
    ...
    public function edit($id)
    {
        ...
        if (!$pricing)
            return redirect()->back()->withError(__('messages.not_found_this_type', ['type' => __('main.pricing-definition')]));
        return view('definitions::pricing-definitions.edit', compact('pricing'));
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return $updated
            ? redirect()->route('dashboard.definitions.pricing-definitions.index')->withSuccess(__('messages.type_updated', ['type' => __('main.pricing-definition')]))
    ...
    public function destroy($id)
    {
        ...
        return $deleted
            ? redirect()->route('dashboard.definitions.pricing-definitions.index')->withSuccess(__('messages.type_deleted', ['type' => __('main.pricing-definition')]))
