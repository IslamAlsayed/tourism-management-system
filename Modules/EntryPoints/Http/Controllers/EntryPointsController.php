...
class EntryPointsController extends Controller
{
    ...
    {
        return view('entrypoints::entry-points.index');
    }

    public function create()
    {
        $crossing_port_types = array_keys(config('helpers.crossing_port_types'));
        return view('entrypoints::entry-points.create', compact('crossing_port_types'));
    }
    ...
    public function show($id)
    {
        ...
        return view('entrypoints::entry-points.show', compact('EntryPoint'));
    }
    ...
    public function edit($id)
    {
        ...
        $crossing_port_types = array_keys(config('helpers.crossing_port_types'));
        return view('entrypoints::entry-points.edit', compact('EntryPoint', 'crossing_port_types'));
    }
