...
namespace Modules\EntryPoints\Http\Requests\EntryPoint;
...
class UpdateRequest extends FormRequest
{
    ...
    {
        $EntryPointId = $this->route('crossings_port');

        return [
            'code' => ['nullable', 'string', 'max:12', Rule::unique('crossing_ports', 'code')->ignore($EntryPointId)],
