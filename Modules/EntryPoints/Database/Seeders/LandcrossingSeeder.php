...
class LandcrossingSeeder extends Seeder
{
     ...
     */
    private function createRealEntryPoints(): void
    {
        $realEntryPoints = [
            [
                'code' => 'RUH',
                ...
                'departure_tax' => 75.00,
                'departure_tax_currency_id' => \Modules\Localization\Entities\Currency::where('code', 'SAR')->first()?->id,
        ...
        foreach ($realEntryPoints as $EntryPoint) {
            Landcrossing::create($EntryPoint);
        }
    }
}
