...
@section('title', __('main.view_type', ['type' => __('main.seaport')]))
        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-4">
            <div class="flex flex-col justify-center gap-2">
                ...
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    {{ __('main.view_type_description', ['type' => __('main.seaport')]) }}
                </div>
            </div>
            <div class="flex items-center gap-2.5">
                ...
                <a href="{{ route('dashboard.entrypoints.seaports.edit', $EntryPoint->id) }}" class="kt-btn kt-btn-primary md:hidden">
                    {{ __('main.edit') }}
                </a>
            </div>
        </div>
