...
@section('title', __('main.create_type', ['type' => __('main.seaport')]))
...
@section('content')
        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-4">
            <div class="flex flex-col justify-center gap-2">
                <h1 class="text-xl font-medium leading-none text-mono">
                    {{ __('main.create_type', ['type' => __('main.seaport')]) }}
                </h1>
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    {{ __('main.create_type_description', ['type' => __('main.seaport')]) }}
                </div>
            </div>
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.entrypoints.seaports.index') }}" class="kt-btn kt-btn-outline">
                    {{ __('main.back_to_types', ['types' => __('main.seaports')]) }}
                </a>
            </div>
        </div>
    ...
    <div class="kt-container-fixed">
        <form class="space-y-6" method="POST" action="{{ route('dashboard.entrypoints.seaports.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="grid gap-4 lg:gap-6">
                ...
                <div class="kt-card">
                    <div class="kt-card-header">
                        <h3 class="kt-card-title">
                            {{ __('main.type_information', ['type' => __('main.seaport')]) }}
                        </h3>
                    </div>
                    <div class="kt-card-body p-4">
                ...
                @include('components.elements.save-submit', [
                    'models' => 'dashboard.entrypoints.seaports',
                    'model' => 'seaport',
                ])
            </div>
        </form>
