...
@section('title', __('main.view_type', ['type' => __('main.airport')]))
        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-4">
            <div class="flex flex-col justify-center gap-2">
                ...
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    {{ __('main.view_type_description', ['type' => __('main.airport')]) }}
                </div>
            </div>
            <div class="flex items-center gap-2.5">
                ...
                <a href="{{ route('dashboard.entrypoints.airports.edit', $EntryPoint->id) }}" class="kt-btn kt-btn-primary md:hidden">
                    {{ __('main.edit') }}
                </a>
            </div>
        </div>
            ...
            <div class="kt-card">
                <div class="kt-card-header">
                    <h3 class="kt-card-title">
                        {{ __('main.type_information', ['type' => __('main.airport')]) }}
                    </h3>
                </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                @livewire('toggle-switch', [
                                    ...
                                    'modelType' => '\\Modules\\EntryPoints\\Entities\\Airport',
                                    'field' => 'is_active',
