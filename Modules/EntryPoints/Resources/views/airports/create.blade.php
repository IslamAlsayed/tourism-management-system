...
@section('title', __('main.create_type', ['type' => __('main.airports')]))
...
@section('content')
        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-4">
            <div class="flex flex-col justify-center gap-2">
                <h1 class="text-xl font-medium leading-none text-mono">
                    {{ __('main.create_type', ['type' => __('main.airports')]) }}
                </h1>
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    {{ __('main.create_type_description', ['type' => __('main.airports')]) }}
                </div>
            </div>
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.entrypoints.airports.index') }}" class="kt-btn kt-btn-outline">
                    {{ __('main.back_to_types', ['types' => __('main.airports')]) }}
                </a>
            </div>
        </div>
    ...
    <div class="container-fixed">
        <form class="space-y-6" method="POST" action="{{ route('dashboard.entrypoints.airports.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="grid gap-4 lg:gap-6">
                ...
                <div class="kt-card">
                    <div class="kt-card-header">
                        <h3 class="kt-card-title">
                            {{ __('main.type_information', ['type' => __('main.airports')]) }}
                        </h3>
                    </div>
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            {{-- Type --}}
                            <div>
                                <label for="crossings-ports-type" class="kt-label required mb-2">
                                    {{ __('main.type') }}
                ...
                <div class="kt-card">
                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div>
                            ...
                            <textarea name="visa_conditions" id="visa_conditions" class="kt-textarea">{{ old('visa_conditions') }}</textarea>
                ...
                @include('components.elements.save-submit', [
                    'models' => 'dashboard.entrypoints.airports',
                    'model' => 'airport',
                ])
            </div>
        </form>
