...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\Modules\CRM\Entities\Client>
 */
class ClientFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'nationality_id' => \Modules\Geography\Entities\Nationality::inRandomOrder()->first()?->id,
            ...
            'timezone_id' => \Modules\Localization\Entities\Timezone::inRandomOrder()->first()?->id,
