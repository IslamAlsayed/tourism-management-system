...
class CompanySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        truncateWithReset(PricingDefinition::class);
        RichText::where('record_type', PricingDefinition::class)->delete();
        truncateWithReset(Company::class);
        RichText::where('record_type', Company::class)->delete();
        truncateWithReset(CompanyContact::class);
        RichText::where('record_type', CompanyContact::class)->delete();
        truncateWithReset(VehicleType::class);
        RichText::where('record_type', VehicleType::class)->delete();
        truncateWithReset(Pricing::class);
        RichText::where('record_type', Pricing::class)->delete();
        ...
        $contacts = [
            ['company_id' => Company::inRandomOrder()->first()?->id, 'contact_person' => fake()->name(), 'email' => fake()->unique()->safeEmail(), 'phone' => fake()->phoneNumber(), 'mobile' => fake()->phoneNumber(), 'fax' => fake()->phoneNumber()],
            ['company_id' => Company::inRandomOrder()->first()?->id, 'contact_person' => fake()->name(), 'email' => fake()->unique()->safeEmail(), 'phone' => fake()->phoneNumber(), 'mobile' => fake()->phoneNumber(), 'fax' => fake()->phoneNumber()],
            ['company_id' => Company::inRandomOrder()->first()?->id, 'contact_person' => fake()->name(), 'email' => fake()->unique()->safeEmail(), 'phone' => fake()->phoneNumber(), 'mobile' => fake()->phoneNumber(), 'fax' => fake()->phoneNumber()],
            ['company_id' => Company::inRandomOrder()->first()?->id, 'contact_person' => fake()->name(), 'email' => fake()->unique()->safeEmail(), 'phone' => fake()->phoneNumber(), 'mobile' => fake()->phoneNumber(), 'fax' => fake()->phoneNumber()],
            ['company_id' => Company::inRandomOrder()->first()?->id, 'contact_person' => fake()->name(), 'email' => fake()->unique()->safeEmail(), 'phone' => fake()->phoneNumber(), 'mobile' => fake()->phoneNumber(), 'fax' => fake()->phoneNumber()],
        ...
        foreach ($contacts as $contact) {
            ...
            CompanyContact::factory()->create($contact);
        }

        // أنواع المركبات المصرية والأردنية
        $vehicleTypes = [
            ['name' => 'Tourist Bus', 'name_ar' => 'اتوبيس سياحي', 'min_capacity' => 20, 'max_capacity' => 50, 'has_luggage' => fake()->boolean(70), 'is_air_conditioning' => fake()->boolean(80), 'is_active' => true, 'company_id' => Company::inRandomOrder()->first()?->id],
            ['name' => 'Microbus', 'name_ar' => 'ميكروباص', 'min_capacity' => 8, 'max_capacity' => 14, 'has_luggage' => fake()->boolean(70), 'is_air_conditioning' => fake()->boolean(80), 'is_active' => true, 'company_id' => Company::inRandomOrder()->first()?->id],
            ['name' => 'Limousine', 'name_ar' => 'ليموزين', 'min_capacity' => 2, 'max_capacity' => 4, 'has_luggage' => fake()->boolean(70), 'is_air_conditioning' => fake()->boolean(80), 'is_active' => true, 'company_id' => Company::inRandomOrder()->first()?->id],
            ['name' => 'Tourist Coach', 'name_ar' => 'حافلة سياحية', 'min_capacity' => 30, 'max_capacity' => 55, 'has_luggage' => fake()->boolean(70), 'is_air_conditioning' => fake()->boolean(80), 'is_active' => true, 'company_id' => Company::inRandomOrder()->first()?->id],
            ['name' => 'Van', 'name_ar' => 'سيارة فان', 'min_capacity' => 6, 'max_capacity' => 12, 'has_luggage' => fake()->boolean(70), 'is_air_conditioning' => fake()->boolean(80), 'is_active' => true, 'company_id' => Company::inRandomOrder()->first()?->id],
            ['name' => 'Limousine', 'name_ar' => 'ليموزين', 'min_capacity' => 2, 'max_capacity' => 4, 'has_luggage' => fake()->boolean(70), 'is_air_conditioning' => fake()->boolean(80), 'is_active' => true, 'company_id' => Company::inRandomOrder()->first()?->id],
        ];
        ...
        $transportationCompany = Company::all();
        foreach ($transportationCompany as $company) {
            ...
            $vehicleType = VehicleType::where('company_id', $company->id)->inRandomOrder()->first()
                ?? VehicleType::inRandomOrder()->first();
