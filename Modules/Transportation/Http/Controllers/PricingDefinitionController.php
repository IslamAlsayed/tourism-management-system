...
class PricingDefinitionController extends Controller
{
    ...
    {
        return view('transportation::pricing-definitions.index');
    }

    public function create()
    {
        return view('transportation::pricing-definitions.create');
    }
    ...
    public function show($id)
    {
        ...
        dd($pricing->toArray());
        return view('transportation::pricing-definitions.show', compact('pricing'));
    }
    ...
    public function edit($id)
    {
        ...
        if (!$pricing)
            return redirect()->back()->withError(__('messages.not_found_this_type', ['type' => __('main.pricing-definition')]));
        return view('transportation::pricing-definitions.edit', compact('pricing'));
    }
