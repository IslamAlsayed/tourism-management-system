...
class VehicleTypes extends Component
{
    ...
    public function mount()
    {
        ...
        $this->mountWithCustomColumns(VehicleType::class);
        $this->resetPage();
    }

    public function destroy($id)
    {
        $this->safeDestroy($id, VehicleType::class, 'transportation-vehicle-type');
    }
    ...
    {
        $paginator = VehicleType::paginate(getPaginate());
