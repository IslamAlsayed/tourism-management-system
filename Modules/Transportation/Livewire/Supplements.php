...
class Supplements extends Component
{
    ...
    public function exportSelectedPDF()
    {
        ...
        return $this->exportSelectedPdfForModel($this->selectedIds ?? [], Supplement::class, $cols, 'transportation-supplements');
    }

    public function exportSelectedExcel($extension)
    {
        $cols = !empty($this->pendingColumns) ? $this->pendingColumns : ($this->columns ?? null);
        return $this->exportSelectedExcelForModel($this->selectedIds ?? [], Supplement::class, $cols, 'transportation-supplements', $extension);
    }
    ...
    public function render()
    {
        ...
        return view('transportation::livewire.supplements', ['data' => $data, 'totalCount' => $this->totalCount ?: Supplement::count(), 'selectedIds' => $this->selectedIds]);
    }
}
