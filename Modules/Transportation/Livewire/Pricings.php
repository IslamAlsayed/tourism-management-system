...
class Pricings extends Component
{
    ...
    public function mount()
    {
        ...
        $this->mountWithCustomColumns(Pricing::class);
        $this->resetPage();
    }

    public function destroy($id)
    {
        $this->safeDestroy($id, Pricing::class, 'pricing');
    }
    ...
    {
        $paginator = Pricing::paginate(getPaginate());
    ...
    public function deleteSelected()
    {
        ...
        $this->dispatch('show-toast', [
            'type' => 'success',
            'message' => __('messages.type_deleted_count', ['type' => __('main.transportations-pricings'), 'count' => $count]),
        ]);
    }
