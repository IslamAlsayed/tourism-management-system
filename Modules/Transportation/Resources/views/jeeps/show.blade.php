    ...
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.transportation.jeeps.edit', $jeep->id) }}" class="kt-btn kt-btn-primary">
                        ...
                        <div class="col-span-full">
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 items-center gap-6">
                                <div>
                                    ...
                                    <select class="kt-input kt-input-sm basic-single js-async-field" data-model="jeeps" data-id="{{ $jeep->id }}"
                                        data-field="status">
                        ...
                        @if ($jeep->photo)
                            <div class="flex flex-col w-fit">
                                ...
                                <div class="image-container">
                                    @if ($jeep->photo)
                                        <img src="{{ asset('storage/' . $jeep->photo) }}" alt="Main Image" class="w-auto h-[250px] object-cover shadow"
                                            loading="lazy">
                                    @else
                                    ...
                                    <div class="image-overlay">
                                        <a href="{{ $jeep->photo ? asset('storage/' . $jeep->photo) : '#' }}" download="{{ $jeep->photo }}"
