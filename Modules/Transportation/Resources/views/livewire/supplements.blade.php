        ...
        <div class="kt-card-content" wire:loading.class="loading"
            ...
            <div class="mb-4 grid grid-cols-1 md-grid-cols-2 gap-4 px-4 filterTable">
                <div>
                    ...
                    <select wire:model.live="filterPriceType" class="kt-select h-[40px] w-48 max-w-full" id="price_type" data-kt-select="true"
                        data-kt-select-placeholder="{{ __('main.price_type') }}">
                ...
                <div>
                    ...
                    <select wire:model.live="filterMandatory" class="kt-select h-[40px] w-48 max-w-full" id="is_mandatory" data-kt-select="true"
                ...
                <div>
                    ...
                    <select wire:model.live="filterActive" class="kt-select h-[40px] w-48 max-w-full" id="active" data-kt-select="true"
                        data-kt-select-placeholder="{{ __('main.active') }}">
                        <option value="all">{{ __('main.all') }}</option>
            ...
            <div data-kt-datatable-state-save="false" id="supplements_table">
                @component('components.data-table', [
                        ...
                        'columns' => $columns,
                        'search' => $search,
                        'models' => 'dashboard.transportation.supplements',
                        'selectedIds' => $selectedIds ?? [],
                    ])
                    @endcomponent
            </div>
