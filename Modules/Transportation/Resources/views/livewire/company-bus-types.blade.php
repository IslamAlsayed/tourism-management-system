<div class="kt-card kt-card-grid min-w-full">
    @component('includes.pagination-info', [
        ...
        'entityName' => __('main.transportations-company-bus-types'),
    ...
    <div class="kt-card-content">
        <div data-kt-datatable-state-save="false" id="transportations-company_bus_types_table">
            <div class="kt-scrollable-x-auto" wire:loading.class="loading"
                ...
                @component('components.data-table', [
                    ...
                    'columns' => $columns,
                    'search' => $search,
                    'models' => 'dashboard.transportation.company-bus-types',
                    'selectedIds' => $selectedIds ?? [],
                ])
                @endcomponent
            </div>
