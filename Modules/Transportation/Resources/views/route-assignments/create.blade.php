...
@section('title', __('main.create_type', ['type' => __('main.route-assignment')]))
...
@section('content')
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-4">
            <div class="flex flex-col justify-center gap-2">
                <h1 class="text-xl font-medium leading-none text-mono">
                    {{ __('main.create_type', ['type' => __('main.route-assignment')]) }}
                </h1>
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    {{ __('main.create_type_description', ['type' => __('main.route-assignment')]) }}
                </div>
            </div>
        ...
        @include('components.must-add-first', [
            'requirements' => [
                [
                    'condition' => \Modules\Transportation\Entities\Route::count() > 0,
                    'route' => route('dashboard.transportation.routes.index'),
                ...
                [
                    ...
                    'route' => route('dashboard.transportation.vehicle-types.index'),
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('dashboard.transportation.route-assignments.store') }}" method="POST">
            @csrf
            <div class="grid gap-4 lg:gap-6">
                ...
                <div class="kt-card">
                    ...
                    <div class="kt-card-body p-4">
                        @livewire('transportation::route-assignment', ['routes' => $routes])
                    </div>
                </div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="base_price" id="base_price" step="0.01" class="kt-input h-[45px]" value="{{ old('base_price', 0) }}"
                                    placeholder="0.00">
                                @error('base_price')
                            ...
                            <div>
                                ...
                                <input type="number" name="price_per_person" id="price_per_person" step="0.01" class="kt-input h-[45px]"
                                    value="{{ old('price_per_person', 0) }}" placeholder="0.00">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="time" name="departure_time" id="departure_time" class="kt-input h-[45px]" value="{{ old('departure_time') }}">
                            ...
                            <div>
                                ...
                                <input type="time" name="arrival_time" id="arrival_time" class="kt-input h-[45px]" value="{{ old('arrival_time') }}">
                                @error('arrival_time')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="frequency_per_day" id="frequency_per_day" class="kt-input h-[45px]"
                                    value="{{ old('frequency_per_day', 1) }}" min="1">
                                ...
                                @foreach ([0, 1, 2, 3, 4, 5, 6] as $day)
                                    <div class="flex items-center gap-3">
                                        ...
                                        @include('components.elements.checkbox-button', [
                                            ...
                                            'id' => 'day_' . $day,
                                            'value' => $day,
                                            'checked' => in_array($day, old('available_days', [])),
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="valid_from" id="valid_from" class="kt-input h-[45px]" value="{{ old('valid_from') }}">
                                @error('valid_from')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="valid_to" id="valid_to" class="kt-input h-[45px]" value="{{ old('valid_to') }}">
                                @error('valid_to')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
