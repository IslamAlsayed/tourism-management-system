...
@section('table-content')
    ...
    @component('includes.table-breadcrumb', [
        ...
        'import_url' => route('import.data', ['models' => 'dashboard.transportation.route-assignments']),
        'page_create_url' => route('dashboard.transportation.route-assignments.create'),
    ...
    <div class="grid gap-4 lg:gap-6">
        <div class="kt-card kt-card-grid min-w-full">
            @livewire('transportation::route-assignments')
        </div>
    </div>
    <!-- End of Container -->
@endsection
