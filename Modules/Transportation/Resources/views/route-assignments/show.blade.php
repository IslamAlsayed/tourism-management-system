    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.transportation.route-assignments.edit', $assignment->id) }}" class="kt-btn kt-btn-primary md:hidden">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        @if ($assignment->route)
                            <div>
                                ...
                                <a href="{{ route('dashboard.transportation.routes.show', $assignment->route->id) }}" class="block text-sm text-primary underline">
                        ...
                        @if ($assignment->company)
                            <div>
                                ...
                                <a href="{{ route('dashboard.transportation.companies.show', $assignment->company->id) }}"
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                @livewire('toggle-switch', [
                                    ...
                                    'modelType' => '\\Modules\\Transportation\\Entities\\RouteAssignment',
                                    'field' => 'is_active',
