    ...
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.transportation.companies.edit', $company->id) }}" class="kt-btn kt-btn-primary md:hidden">
        ...
        <div class="grid gap-4 lg:gap-6">
                    ...
                    <div class="flex flex-wrap" style="gap: 20px 80px;">
                        @if ($company->country)
                            <div>
                                ...
                                <a href="{{ route('dashboard.geography.regions.show', $company->country?->region?->id) }}"
                            ...
                            <div>
                                ...
                                <a href="{{ route('dashboard.geography.subregions.show', $company->country?->subregion?->id) }}"
                                    class="block text-sm text-primary underline">
                        ...
                        <div>
                            ...
                            @if ($company->country)
                                <a href="{{ route('dashboard.geography.countries.show', $company->country?->id) }}" class="block text-sm text-primary underline">
                        ...
                        <div>
                            ...
                            @if ($company->state)
                                <a href="{{ route('dashboard.geography.states.show', $company->state?->id) }}" class="block text-sm text-primary underline">
                        ...
                        <div>
                            ...
                            @if ($company->city)
                                <a href="{{ route('dashboard.geography.cities.show', $company->city?->id) }}" class="block text-sm text-primary underline">
                ...
                <div class="kt-card-body p-4">
                    @if ($company->latitude && $company->longitude)
                        ...
                        <div class="col-span-full mt-4">
                            ...
                            <a href="https://maps.google.com?q={{ $company->latitude }},{{ $company->longitude }}" target="_blank"
                                class="text-sm text-primary hover:underline">
                                {{ __('main.view_on_google_maps') }}
                            </a>
                            <div class="w-full bg-white p-4 rounded-lg shadow-lg">
                                <div id="map" data-title="{{ $company->title }}" data-latitude="{{ $company->latitude }}"
                                    data-longitude="{{ $company->longitude }}" class="rounded-md overflow-hidden shadow"></div>
                            </div>
                        </div>
                    @endif
                </div>
            ...
            <div class="flex items-center gap-4">
                ...
                @include('components.elements.delete-form', [
                    'model' => 'transportation.companies',
                    'id' => $company->id,
                ])
                <a href="{{ route('dashboard.transportation.companies.index') }}" class="kt-btn kt-btn-outline">
                    {{ __('main.back_to_types', ['types' => __('main.companies')]) }}
