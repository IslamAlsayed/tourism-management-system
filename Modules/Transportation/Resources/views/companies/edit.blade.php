            ...
            <div class="grid gap-4 lg:gap-6">
                ...
                <div class="kt-card">
                    ...
                    <div class="kt-card-body p-4">
                        ...
                        @livewire('geography::livewire.regions.location-select-base', ['record' => $company])
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="number" name="latitude" id="latitude" step="0.0000001" class="kt-input h-[45px]" value="{{ $company->latitude }}"
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="number" name="longitude" id="longitude" step="0.0000001" class="kt-input h-[45px]" value="{{ $company->longitude }}"
