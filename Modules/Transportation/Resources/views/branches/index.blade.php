...
@section('table-content')
    ...
    @include('includes.table-breadcrumb', [
        ...
        'import_url' => route('import.data', ['models' => 'dashboard.transportation.branches']),
        'page_create_url' => route('dashboard.transportation.branches.create'),
    ...
    <div class="grid gap-4 lg:gap-6">
        <div class="kt-card kt-card-grid min-w-full">
            @livewire('transportation::branches')
        </div>
    </div>
    <!-- End of Container -->
@endsection
