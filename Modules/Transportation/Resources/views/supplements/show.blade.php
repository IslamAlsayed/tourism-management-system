    ...
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.transportation.supplements.edit', $supplement->id) }}" class="kt-btn kt-btn-primary">
                    <i class="ki-filled ki-pencil text-sm me-2"></i>
                    {{ __('main.edit') }}
                </a>
                <a href="{{ route('dashboard.transportation.supplements.index') }}" class="kt-btn kt-btn-outline">
        ...
        <div class="grid gap-4 lg:gap-6">
            ...
            <div class="flex items-center gap-4">
                ...
                @include('components.elements.delete-form', [
                    'model' => 'dashboard.transportation.supplements',
                    'id' => $supplement->id,
                ])
                <a href="{{ route('dashboard.transportation.supplements.index') }}" class="kt-btn kt-btn-outline">
                    {{ __('main.back_to_types', ['types' => __('main.supplements')]) }}
