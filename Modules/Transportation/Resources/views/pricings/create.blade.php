...
@section('content')
        ...
        @include('components.must-add-first', [
            'requirements' => [
                ...
                [
                    ...
                    'route' => route('dashboard.tourguides.guides-types.index'),
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('dashboard.transportation.pricings.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 items-end gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="tax" id="tax" class="kt-input h-[45px]" value="{{ old('tax') }}" minlength="0"
                                    maxlength="100">
                                @error('tax')
                                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
