...
use Modules\TouristServices\Entities\Facility;
use Modules\TouristSites\Entities\SiteHoliday;
use Modules\TouristSites\Entities\SiteSeasonalHour;
use Modules\TravelDocuments\Entities\TravelPasse;
use Tonysm\RichTextLaravel\Models\Traits\HasRichText;

class TouristSite extends Model
{
    use HasSearch, HasUuid, HasRichText, HasFactory, BroadcastsRecordEvents, ClearsEmptyRichText, HasCustomFields;
    ...
    protected $fillable = [
        ...
        // Additional Pricing
        'local_guide_price',
        'local_guide_price_unit_id',
        'club_car_price',
        'club_car_price_unit_id',
    ...
    protected $casts = [
        // Booleans
        'unesco_site' => 'boolean',
        'iucn_green_list' => 'boolean',
        'gstc_certified' => 'boolean',
        'blue_flag' => 'boolean',
        'green_destinations' => 'boolean',
        'earthcheck_certified' => 'boolean',
    ...
    public function localGuidePriceUnit()
    {
        return $this->belongsTo(PricingDefinition::class, 'local_guide_price_unit_id');
    }

    public function clubCarPriceUnit()
    {
        return $this->belongsTo(PricingDefinition::class, 'club_car_price_unit_id');
    }

    // NOTE: tourist_services is an independent entity with no site_id FK.
    // This relationship is disabled until a pivot table is created.
    // public function services()
    // {
    //     return $this->hasMany(TouristService::class, 'site_id');
    // }

    public function nationalityEntryFees()
    {
        return $this->hasMany(TouristSiteEntryFee::class);
    }

    public function facilities()
    {
        return $this->belongsToMany(Facility::class, 'tourist_site_facilities');
    }

    public function travelPasses()
    {
        return $this->belongsToMany(TravelPasse::class, 'travel_pass_sites', 'tourist_site_id', 'travel_pass_id');
    }

    public function holidays()
    {
        return $this->hasMany(SiteHoliday::class);
    }

    public function seasonalHours()
    {
        return $this->hasMany(SiteSeasonalHour::class);
    }
