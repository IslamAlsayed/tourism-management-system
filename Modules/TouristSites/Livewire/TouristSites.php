...
class TouristSites extends Component
{
    ...
    public function deleteSelected()
    {
        ...
        $this->resetAutoIncrementIfEmpty(TouristSite::class);
    ...
    public function exportSelectedPDF()
    {
        ...
        return $this->exportSelectedPdfForModel($this->selectedIds ?? [], TouristSite::class, $cols, 'tourist-sites');
    }

    public function exportSelectedExcel($extension)
    {
        $cols = !empty($this->pendingColumns) ? $this->pendingColumns : ($this->columns ?? null);
        return $this->exportSelectedExcelForModel($this->selectedIds ?? [], TouristSite::class, $cols, 'tourist-sites', $extension);
    }
    ...
    public function render()
    {
        ...
        return view('touristsites::livewire.sites', ['data' => $data]);
    }
}
