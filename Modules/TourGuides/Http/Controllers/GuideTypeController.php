...
use Modules\TourGuides\Http\Requests\TourGuideType\StoreRequest;
use Modules\TourGuides\Http\Requests\TourGuideType\UpdateRequest;
...
class GuideTypeController extends Controller
{
    ...
    {
        return view('tourguides::guides-types.index');
    }

    public function create()
    {
        return view('tourguides::guides-types.create');
    }
    ...
    public function store(StoreRequest $request)
    {
        ...
        return $tourGuideType
            ? ($request->has('save_and_add')
                ...
                : redirect()->route('dashboard.tourguides.guides-types.index', ['type' => $request->input('type')])->with('success', __('messages.type_created', ['type' => __('main.tours.guide-type')])))
            : redirect()->route('dashboard.tourguides.guides-types.index', ['type' => $request->input('type')])->with('error', __('messages.type_creation_failed', ['type' => __('main.tours.guide-type')]));
    }
    ...
    public function show($id)
    {
        ...
        return view('tourguides::guides-types.show', compact('tourGuideType'));
    }
    ...
    public function edit($id)
    {
        ...
        if (!$tourGuideType)
            return redirect()->back()->withError(__('messages.not_found_this_type', ['type' => __('main.tours.guide-type')]));
        return view('tourguides::guides-types.edit', compact('tourGuideType'));
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        if (!$tourGuideType)
            return redirect()->route('dashboard.tourguides.guides-types.index')->withError(__('messages.type_creation_failed', ['type' => __('main.tours.guide-type')]));
        $validated = $request->validated();
        unset($validated['state_id'], $validated['city_id']);
        // States
        $stateIds = [];
    ...
    public function destroy($id)
    {
        ...
        return $deleted
            ? redirect()->route('dashboard.tourguides.guides-types.index')->withSuccess(__('messages.type_deleted', ['type' => __('main.tours.guide-type')]))
            : redirect()->route('dashboard.tourguides.guides-types.index')->withError(__('messages.type_deletion_failed', ['type' => __('main.tours.guide-type')]));
    }
}
