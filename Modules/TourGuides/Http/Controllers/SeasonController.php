...
class SeasonController extends Controller
{
    ...
    {
        return view('tourguides::seasons.index');
    }
    ...
    public function create()
    {
        ...
        return view('tourguides::seasons.create', compact('accommodations', 'restaurants'));
    }
    ...
    public function store(StoreRequest $request)
    {
        ...
        return $created
            ? ($request->has('save_and_add')
                ...
                : redirect()->route('dashboard.tourguides.seasons.index', ['type' => $request->input('type')])->with('success', __('messages.type_created', ['type' => __('main.season')])))
            : redirect()->route('dashboard.tourguides.seasons.index', ['type' => $request->input('type')])->with('error', __('messages.type_creation_failed', ['type' => __('main.season')]));
    }
    ...
    public function show($id)
    {
        ...
        return view('tourguides::seasons.show', compact('season'));
    }
    ...
    public function edit($id)
    {
        ...
        if (!$season)
            return redirect()->back()->withError(__('messages.not_found_this_type', ['type' => __('main.season')]));
        return view('tourguides::seasons.edit', compact('season'));
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return $updated
            ? redirect()->route('dashboard.tourguides.seasons.index', ['type' => $request->input('type')])->withSuccess(__('messages.type_updated', ['type' => __('main.season')]))
    ...
    public function destroy($id)
    {
        ...
        return $deleted
            ? redirect()->route('dashboard.tourguides.seasons.index')->withSuccess(__('messages.type_deleted', ['type' => __('main.season')]))
            : redirect()->route('dashboard.tourguides.seasons.index')->withError(__('messages.type_deletion_failed', ['type' => __('main.season')]));
    }
}
