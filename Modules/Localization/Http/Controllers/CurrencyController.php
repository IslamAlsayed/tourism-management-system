...
class CurrencyController extends Controller
{
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return $updated
            ? redirect()->route('dashboard.localization.currencies.index')->withSuccess(__('messages.type_updated', ['type' => __('main.currency')]))
    ...
    public function destroy($id)
    {
        ...
        return $deleted
            ? redirect()->route('dashboard.localization.currencies.index')->withSuccess(__('messages.type_deleted', ['type' => __('main.currency')]))
            : redirect()->route('dashboard.localization.currencies.index')->withError(__('messages.type_deletion_failed', ['type' => __('main.currency')]));
    }
}
