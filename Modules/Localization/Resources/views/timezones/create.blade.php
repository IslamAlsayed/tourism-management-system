                    ...
                    <div class="grid gap-4 lg:gap-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-end gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="name_ar" id="name_ar" class="kt-input h-[45px]" value="{{ old('name_ar') }}" placeholder="مصر">
                                @error('name_ar')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="country_code" id="country_code" class="kt-input h-[45px]" maxlength="2"
                                    value="{{ old('country_code') }}" placeholder="EG">
                                @error('country_code')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="abbreviation" id="abbreviation" class="kt-input h-[45px]" maxlength="10"
                                    value="{{ old('abbreviation') }}" placeholder="EET">
                                @error('abbreviation')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="abbreviation_dst" id="abbreviation_dst" class="kt-input h-[45px]" maxlength="10"
                                    value="{{ old('abbreviation_dst') }}" placeholder="EEST">
                            ...
                            <div>
                                ...
                                <input type="text" name="gmt_offset_name" id="gmt_offset_name" class="kt-input h-[45px]" value="{{ old('gmt_offset_name') }}"
                                    placeholder="GMT+2">
                            ...
                            <div>
                                ...
                                <input type="number" name="offset" id="offset" class="kt-input h-[45px]" value="{{ old('offset', 7200) }}" placeholder="7200">
                                @error('offset')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="offset_dst" id="offset_dst" class="kt-input h-[45px]" value="{{ old('offset_dst', 10800) }}"
                                    placeholder="10800">
                                @error('offset_dst')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
