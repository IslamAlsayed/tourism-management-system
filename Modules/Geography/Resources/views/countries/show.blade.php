    ...
    <div class="container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.geography.countries.edit', $country->id) }}" class="kt-btn kt-btn-primary md:hidden">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                @livewire('toggle-switch', [
                                    'modelId' => $country->id,
                                    'modelType' => '\\Modules\\Geography\\Entities\\Country',
                                    'field' => 'is_active',
                            ...
                            @if ($country->latitude && $country->longitude)
                                <div class="col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-4 mt-2">
                                    <button type="button" class="kt-btn kt-btn-sm kt-btn-light w-fit" 
                                        ...
                                        <i class="fa-duotone fa-solid fa-location-dot text-base me-2"></i>
                                        {{ __('main.view_on_map') }}
                                    </button>
                                </div>
                            @endif
