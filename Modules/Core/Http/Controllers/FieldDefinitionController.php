...
class FieldDefinitionController extends Controller
{
    ...
    {
        return view('core::field-definitions.index');
    }
    ...
    public function create()
    {
        ...
        return view('core::field-definitions.create', compact('modules', 'fieldTypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.core.field-definitions.index')
    ...
    public function show($id)
    {
        ...
        $modules = FieldDefinition::getModuleRegistry();
        $fieldTypes = FieldDefinition::getFieldTypes();
        return view('core::field-definitions.show', compact('fieldDefinition', 'modules', 'fieldTypes'));
    }
    ...
    public function edit($id)
    {
        ...
        $modules = FieldDefinition::getModuleRegistry();
        $fieldTypes = FieldDefinition::getFieldTypes();
        return view('core::field-definitions.edit', compact('fieldDefinition', 'modules', 'fieldTypes'));
    }
