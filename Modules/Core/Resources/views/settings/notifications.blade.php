                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                                <div class="kt-card p-4">
                                    <div class="flex flex-nowrap items-center justify-between">
                                        ...
                                        <input type="checkbox" name="app_email_notifications" class="kt-checkbox kt-checkbox-lg" value="1"
                                ...
                                <div class="kt-card p-4">
                                    <div class="flex flex-nowrap items-center justify-between">
                                        ...
                                        <input type="checkbox" name="app_sms_notifications" class="kt-checkbox kt-checkbox-lg" value="1"
                                ...
                                <div class="kt-card p-4">
                                    <div class="flex flex-nowrap items-center justify-between">
                                        ...
                                        <input type="checkbox" name="app_push_notifications" class="kt-checkbox kt-checkbox-lg" value="1"
