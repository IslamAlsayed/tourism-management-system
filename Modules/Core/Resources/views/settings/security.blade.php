        ...
        <div class="grid gap-4 lg:gap-6">
            ...
            <div class="kt-card">
                ...
                <div class="kt-card-body">
                    <form method="POST" action="{{ route('dashboard.core.settings.update', $settings->id) }}" class="space-y-6 p-4">
                        @csrf
                        @method('PUT')
                        <div class="grid lg:grid-cols-2 gap-6 mb-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="app_max_login_attempts" class="kt-input h-[45px]" value="{{ $settings->app_max_login_attempts }}"
                                    minLength="1" />
                            ...
                            <div class="disabled">
                                <div class="p-2 rounded-sm {{ $settings->app_ip_ban_duration_minutes == 1 ? 'bg-success-light' : 'bg-yellow-100' }}">
                        ...
                        <div class="space-y-4 mb-4">
                            ...
                            <div class="disabled">
                                <div
                                    ...
                                    <input type="checkbox" name="app_two_factor_authentication" class="kt-checkbox" id="app_two_factor_authentication"
                                        value="1" {{ $settings->app_two_factor_authentication == 1 ? 'checked' : '' }}>
                    ...
                    <div class="space-y-4 p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div
                                ...
                                <div class="kt-badge {{ $settings->app_two_factor_authentication == 1 ? 'kt-badge-success' : 'kt-badge-warning' }}">
