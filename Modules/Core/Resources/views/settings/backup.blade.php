        ...
        <div class="grid gap-4 lg:gap-6">
            ...
            <div class="kt-card">
                ...
                <div class="kt-card-body">
                    <form method="POST" action="{{ route('dashboard.core.settings.update', $settings->id) }}" class="p-4 space-y-6">
                        @csrf
                        @method('PUT')

                        <div class="flex items-center gap-4 mb-4">
                            <input type="hidden" name="app_auto_backup" class="kt-checkbox kt-checkbox-lg" value="0" />
                            <input type="checkbox" name="app_auto_backup" id="app_auto_backup" class="kt-checkbox kt-checkbox-lg" value="1"
                        ...
                        <div class="mb-4">
                            <label for="app_backup_frequency" class="mb-2 kt-label">{{ __('main.backup_frequency') }}</label>
                            <select name="app_backup_frequency" class="kt-select h-[45px]">
                                ...
                                <option value="monthly" {{ $settings->app_backup_frequency == 'monthly' ? 'selected' : '' }}>
                                    {{ __('main.monthly') }}
                                </option>
                            </select>
                        </div>
