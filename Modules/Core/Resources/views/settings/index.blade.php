            ...
            <div class="grid lg:grid-cols-2 xl:grid-cols-4 gap-5">
                ...
                <div class="kt-card hover:shadow-lg transition-shadow">
                    <div class="kt-card-body text-center p-4">
                        ...
                        <a href="{{ route('dashboard.core.settings.security') }}" class="kt-btn kt-btn-success kt-btn-sm">
                            {{ __('main.security') }}
                        </a>
                    </div>
                </div>
                ...
                <div class="kt-card hover:shadow-lg transition-shadow">
                    <div class="kt-card-body text-center p-4">
                        ...
                        <a href="{{ route('dashboard.core.settings.notifications') }}" class="kt-btn kt-btn-warning kt-btn-sm">
                ...
                <div class="kt-card hover:shadow-lg transition-shadow">
                    <div class="kt-card-body text-center p-4">
                        ...
                        <a href="{{ route('dashboard.core.settings.backup') }}" class="kt-btn kt-btn-info kt-btn-sm">
                            {{ __('main.backup_now') }}
                        </a>
                    </div>
                </div>
                ...
                <div class="kt-card hover:shadow-lg transition-shadow">
                    <div class="kt-card-body text-center p-4">
                        ...
                        <a href="{{ route('dashboard.core.settings.booking') }}" class="kt-btn kt-btn-primary kt-btn-sm">
                            {{ __('main.manage') }}
                        </a>
                    </div>
                </div>
                ...
                <div class="kt-card hover:shadow-lg transition-shadow">
                    <div class="kt-card-body text-center p-4">
                        ...
                        <a href="{{ route('dashboard.core.settings.integration') }}" class="kt-btn kt-btn-success kt-btn-sm">
                            {{ __('main.manage') }}
                        </a>
                    </div>
                </div>
                ...
                <div class="kt-card hover:shadow-lg transition-shadow">
                    <div class="kt-card-body text-center p-4">
                        ...
                        <a href="{{ route('dashboard.core.settings.system') }}" class="kt-btn kt-btn-warning kt-btn-sm">
                            {{ __('main.manage') }}
                        </a>
                    </div>
                </div>
