    ...
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.core.permissions.edit', $permission->id) }}" class="kt-btn kt-btn-primary md:hidden">
    ...
    <div class="kt-container-fixed">
        <div class="grid gap-4 lg:gap-6">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('dashboard.core.permissions.edit', $permission->id) }}" class="kt-btn kt-btn-primary hidden md:inline-flex">
                    <i class="ki-filled ki-pencil text-sm me-2"></i>
                    {{ __('main.edit') }}
                </a>
            </div>
