        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-4">
            <div class="flex flex-col justify-center gap-2">
                ...
                <div class="flex items-center gap-2 text-sm text-secondary-foreground">
                    ...
                    <span
                        class="bg-blue-100 text-blue-700 px-2 py-0.5 rounded text-xs">{{ \Modules\Core\Entities\PricingDefinition::getCategories()[$pricing->category] ?? $pricing->category }}</span>
                    <span class="text-gray-300">|</span>
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.core.pricing-definitions.edit', $pricing->id) }}"
                ...
                <div class="kt-card-body p-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1">
                                <span
                                    class="bg-blue-100 text-blue-700 px-2 py-0.5 rounded text-sm">{{ \Modules\Core\Entities\PricingDefinition::getCategories()[$pricing->category] ?? $pricing->category }}</span>
                            </p>
                        </div>
                    </div>
                </div>
