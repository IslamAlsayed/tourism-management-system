...
@section('content')
    ...
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a class="kt-btn kt-btn-primary" href="{{ route('dashboard.core.profile.edit') }}">
    ...
    <div class="kt-container-fixed">
        <!-- Status Message -->
        @if (session('status'))
            <div class="p-4 mb-5 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">
                {{ session('status') }}
            </div>
        @endif
                            ...
                            <ul class="flex flex-col gap-4 w-full">
                                @if ($user->phone)
                                    <li class="flex items-center gap-3">
                                        <div class="size-10 bg-muted/30 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div class="kt-card min-w-full mb-5 lg:mb-7.5">
                    <div class="kt-card-header">
                        ...
                        <div class="kt-card-toolbar">
                            <a href="{{ route('dashboard.core.profile.edit') }}" class="kt-btn kt-btn-icon kt-btn-sm kt-btn-ghost kt-btn-primary">
                    ...
                    <div class="kt-card-body p-2">
                        ...
                        @else
                            <p class="text-secondary-foreground italic" style="padding: 10px">
                                {{ __('main.no_bio_provided') }} <a href="{{ route('dashboard.core.profile.edit') }}"
                        ...
                        <div class="relative">
                            ...
                            <div class="space-y-8 relative">
                                ...
                                @if ($user->email_verified_at)
                                    <div class="flex items-start gap-4" style="padding: 10px">
                                        <div class="size-8 bg-success/10 rounded-full flex items-center justify-center z-10">
                                        ...
                                        <div>
                                            ...
                                            <span class="text-xs text-muted-foreground">{{ $user->email_verified_at->diffForHumans() }}</span>
                                        </div>
                                    </div>
                                @endif
