            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="d-flex align-items-center">
                        <img src="{{ $user->photo ? asset('storage/' . $user->photo) : asset('metronic/media/avatars/300-2.png') }}" alt="Profile Picture"
                            class="custom-avatar me-4">
                        <div>
                                                    ...
                                                    <div class="d-flex align-items-center gap-4">
                                                        <div class="symbol symbol-100px">
                                                            <img src="{{ $user->photo ? asset('storage/' . $user->photo) : asset('metronic/media/avatars/300-2.png') }}"
                                                                alt="photo" class="w-100 h-100 rounded-circle object-fit-cover">
                                                        </div>
                                                        <div>
                                                            <button type="button" class="kt-btn kt-btn-primary kt-btn-sm me-2">Upload
                                                                New</button>
