                ...
                <div class="col-span-1 xl:col-span-3">
                    <div class="kt-card min-w-full mb-6">
                        ...
                        <div class="kt-card-content p-6">
                            <form action="{{ route('dashboard.core.profile.photo') }}" method="POST" enctype="multipart/form-data"
                                class="flex flex-col items-center gap-5">
                                @csrf
                                <div class="" data-kt-image-input="true">
                                    <label class="kt-image-input-change" data-kt-image-input-trigger="true" style="cursor: pointer">
                                        ...
                                        <input accept=".png, .jpg, .jpeg, .webp" name="photo" type="file" style="display: none;" id="photo-input" />
                                    </label>
                                </div>
                    ...
                    <div class="kt-card min-w-full mb-6">
                        ...
                        <div class="kt-card-content p-6">
                            <form action="{{ route('dashboard.core.profile.update') }}" method="POST" class="flex flex-col gap-5">
                                @csrf
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <input class="kt-input h-[45px]" name="name" type="text" value="{{ old('name', $user->name) }}" required />
                                        @error('name')
                                            <span class="text-red-600 text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <input class="kt-input h-[45px]" name="email" type="email" value="{{ old('email', $user->email) }}" required />
                                        @error('email')
                                            <span class="text-red-600 text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <input class="kt-input h-[45px]" name="phone" type="text" value="{{ old('phone', $user->phone) }}" />
                                    @error('phone')
                                        <span class="text-red-600 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                    ...
                    <div class="kt-card min-w-full lg:mt-7.5">
                        ...
                        <div class="kt-card-content p-6">
                            ...
                            <form action="{{ route('dashboard.core.profile.destroy') }}" method="POST">
                                @csrf
                                @method('DELETE')
...
@push('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof KTUI !== 'undefined' && KTUI.init) {
