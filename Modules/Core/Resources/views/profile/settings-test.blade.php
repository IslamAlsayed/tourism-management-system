                            ...
                            <form>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-modern" value="{{ explode(' ', $user->name)[0] ?? '' }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Last Name *</label>
                                        <input type="text" class="form-control form-control-modern" value="{{ explode(' ', $user->name)[1] ?? '' }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control form-control-modern" value="{{ $user->email }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Phone Number</label>
                                        <input type="tel" class="form-control form-control-modern" value="{{ $user->phone ?? '' }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-modern" value="{{ $user->department ?? '' }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Position</label>
                                        <input type="text" class="form-control form-control-modern" value="{{ $user->position ?? '' }}">
                                    </div>
                                </div>
