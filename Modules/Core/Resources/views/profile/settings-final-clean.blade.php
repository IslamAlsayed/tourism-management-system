                                            ...
                                            <table class="table table-borderless">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <span class="fw-bold">{{ $user->department ?? __('main.not_set') }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-semibold text-muted">{{ __('main.phone') }}</td>
                                                        <td class="text-end">
                                                            <span class="fw-bold">{{ $user->phone ?? __('main.not_set') }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                    ...
                    <div class="tab-pane fade" id="v-pills-personal" role="tabpanel">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="row mb-4">
                                        <label class="col-lg-3 col-form-label fw-semibold">{{ __('main.full_name') }}</label>
                                        <div class="col-lg-9">
                    ...
                    <div class="tab-pane fade" id="v-pills-security" role="tabpanel">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    <div class="row mb-4">
                                        <label class="col-lg-3 col-form-label fw-semibold">{{ __('main.current_password') }}</label>
                                        <div class="col-lg-9">
                                    ...
                                    <div class="row mb-4">
                                        <label class="col-lg-3 col-form-label fw-semibold">{{ __('main.new_password') }}</label>
                                        <div class="col-lg-9">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="submit" class="btn btn-primary">{{ __('main.update_password') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="v-pills-notifications" role="tabpanel">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary">{{ __('main.save_preferences') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
