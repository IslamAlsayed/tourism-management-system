                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="flex items-center gap-2 justify-end">
                                <a href="{{ route('dashboard.core.permissions.show', $permission->id) }}"
                                ...
                                <a href="{{ route('dashboard.core.permissions.edit', $permission->id) }}"
                                    class="inline-flex items-center justify-center w-8 h-8 rounded-lg hover:bg-gray-100">
                                    <i class="ki-filled ki-pencil text-gray-600"></i>
                                </a>
                                <button wire:click="destroy({{ $permission->id }})" wire:confirm="{{ __('messages.confirm_delete') }}"
