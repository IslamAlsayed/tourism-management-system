        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('dashboard.core.reports.index') }}" class="kt-btn kt-btn-outline">
                    {{ __('main.back_to_types', ['types' => __('main.reports')]) }}
                </a>
                ...
                <div class="kt-card-body">
                    <div class="grid gap-5 lg:grid-cols-3">
                        <div class="flex items-center justify-center gap-2 p-2">
                            <div class="text-2xl font-bold text-primary {{ $analytics['growth_metrics']['users_growth'] >= 0 ? 'text-success' : 'text-danger' }}">
                                {{ $analytics['growth_metrics']['users_growth'] }}%
                            </div>
                            <div class="text-sm text-secondary-foreground">{{ __('main.users_growth') }}</div>
                        </div>
                        <div class="flex items-center justify-center gap-2 p-2">
                            <div class="text-2xl font-bold text-primary {{ $analytics['growth_metrics']['cities_growth'] >= 0 ? 'text-success' : 'text-danger' }}">
