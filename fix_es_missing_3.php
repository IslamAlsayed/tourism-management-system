...
// === PART A: main.php remaining nested keys ===
...
$mainNested = [
    'main' => [
        ...
        'dashboard_welcome_description' => 'Descripción de bienvenida del panel',
...
echo "-> main.php (ES): Part 3 applied.\n";

// === PART B: activity.php nested keys ===
...
echo "-> activity.php (ES): Nested keys applied.\n";

echo "=====================================\n";
echo "SUCCESS! Applied ES fix part 3 (FINAL).\n";
echo "=====================================\n";
