...
class GuidesTypes extends Component
{
    ...
    {
        $this->safeDestroy($id, TourGuideType::class, 'tour_guide_type');
    }
    ...
    {
        $paginator = TourGuideType::paginate(getPaginate());
    ...
    public function render()
    {
        ...
        // }
        return view('livewire.tours.guides-types', ['data' => $data, 'totalCount' => $this->totalCount ?: TourGuideType::count(), 'selectedIds' => $this->selectedIds]);
    }
}