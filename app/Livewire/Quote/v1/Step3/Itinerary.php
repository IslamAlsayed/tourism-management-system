...
namespace App\Livewire\Quote\v1\Step3;
...
class Itinerary extends Component
{
    ...
    public function mount($id, $cities)
    {
        ...
        for ($i = 1; $i <= $this->booking->nights; $i++) {
            $this->itinerary[$i] = [
                'day_number' => $i,
                'city_id' => null,
                'description' => '',
    ...
    public function save()
    {
        ...
        return redirect()->route('dashboard.quote.v1.step4', $this->booking->id);
    }

    public function render()
    {
        return view('livewire.quote.v1.step3.itinerary');
    }
}
