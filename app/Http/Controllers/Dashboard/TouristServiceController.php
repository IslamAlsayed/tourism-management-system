...
class TouristServiceController extends Controller
{
    ...
    public function create()
    {
        ...
        return view(
            'pages.dashboard.tourist-services.create',
            compact('sites', 'difficulty_level', 'currencies', 'countries', 'nationalities', 'subregions')
        );
    }
    ...
    public function edit($id)
    {
        ...
        return view(
            'pages.dashboard.tourist-services.edit',
            compact('touristService', 'sites', 'currencies', 'countries', 'nationalities', 'subregions')
        );
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return redirect()->route('tourist-services.index')->withSuccess(__('messages.type_updated', ['type' => __('main.tourist-service')]));
    }
