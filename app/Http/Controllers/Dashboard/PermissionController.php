...
class PermissionController extends Controller
{
    ...
    {
        return view('pages.dashboard.permissions.create');
    }
    ...
    {
        return view('pages.dashboard.permissions.show', compact('permission'));
    }

    public function edit(Permission $permission)
    {
        return view('pages.dashboard.permissions.edit', compact('permission'));
    }
