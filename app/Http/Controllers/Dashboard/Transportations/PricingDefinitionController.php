...
class PricingDefinitionController extends Controller
{
    ...
    {
        return view('pages.dashboard.pricing-definitions.index');
    }

    public function create()
    {
        return view('pages.dashboard.pricing-definitions.create');
    }
    ...
    public function store(StoreRequest $request)
    {
        ...
        if (!$pricing)
            return redirect()->route('pricing-definitions.index')->withError(__('messages.type_creation_failed', ['type' => __('main.pricing-definition')]));
        return $request->has('save_and_add')
            ? redirect()->back()->withSuccess(__('messages.type_created', ['type' => __('main.pricing-definition')]))
            : redirect()->route('pricing-definitions.index')->withSuccess(__('messages.type_created', ['type' => __('main.pricing-definition')]));
    }
    ...
    public function show($id)
    {
        ...
        dd($pricing->toArray());
        return view('pages.dashboard.pricing-definitions.show', compact('pricing'));
    }
    ...
    public function edit($id)
    {
        ...
        if (!$pricing)
            return redirect()->back()->withError(__('messages.not_found_this_type', ['type' => __('main.pricing-definition')]));
        return view('pages.dashboard.pricing-definitions.edit', compact('pricing'));
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return $updated
            ? redirect()->route('pricing-definitions.index')->withSuccess(__('messages.type_updated', ['type' => __('main.pricing-definition')]))
