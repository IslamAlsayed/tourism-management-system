...
class ReportsController extends Controller
{
    public function index()
    {
        ...
        return view('pages.dashboard.reports.index', compact('stats'));
    }
    ...
    public function users()
    {
        ...
        return view('pages.dashboard.reports.users', compact('userStats', 'recentUsers'));
    }
    ...
    public function analytics()
    {
        ...
        return view('pages.dashboard.reports.analytics', compact('analytics'));
    }
