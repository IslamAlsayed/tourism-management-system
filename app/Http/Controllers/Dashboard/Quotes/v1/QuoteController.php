...
namespace App\Http\Controllers\Dashboard\Quotes\v1;
...
class QuoteController extends Controller
{
    ...
    public function step1()
    {
        ...
        return view('pages.dashboard.quote.v1.step1', compact('currencies'));
    }
    ...
    public function postStep1(Step1Request $request)
    {
        ...
        return redirect()->route('dashboard.v1.quote.step2', $booking);
    }
    ...
    public function step2($id)
    {
        ...
        return view('pages.dashboard.quote.v1.step2', compact(
            'booking',
            'hotels',
            'roomTypes',
            'seasons',
    ...
    public function postStep2(Step2Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.v1.quote.step3', $booking->id);
    }
    ...
    public function postStep2_old(Step2Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.v1.quote.step3', $booking);
    }
    ...
    public function step3($id)
    {
        $booking = Booking::findOrFail($id);
        $cities = City::all();
        return view('pages.dashboard.quote.v1.step3', compact('booking', 'cities'));
    }
    ...
    public function postStep3(Step3Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.v1.quote.step4', $booking);
    }
    ...
    public function step4($id)
    {
        ...
        return view('pages.dashboard.quote.v1.step4', compact('booking', 'totals'));
    }
    ...
    public function submit(Step4Request $request, $id)
    {
        ...
        return redirect()->route('dashboard.v1.quote.step1')
            ->withSuccess(__('messages.operation_successful'));
    }
