...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type_id' => ['nullable', 'string', 'max:50', 'exists:restaurant_types,id'],
            ...
            'seasons.*.id' => 'nullable|string|max:255',
            ...
            'meals.*.id' => 'nullable|string|max:255',
            ...
            'meals.*.type' => 'nullable|string|max:255',
            'meals.*.currency_id' => 'nullable|exists:currencies,id',
            'meals.*.season_id' => 'nullable|string|max:255',
