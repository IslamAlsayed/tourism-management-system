...
<div class="bg-center bg-cover bg-no-repeat" style="background-image: url('{{asset('metronic/media/images/2600x1200/bg-1.png')}}');">
        ...
        <div class="col-span-1">
            <div class="card card-bordered">
                <div class="card-body p-0">
                    <div class="menu menu-default menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-active-bg-light-primary menu-hover-bg-light-primary menu-here-bg-light-primary menu-here-text-primary menu-state-text-primary">
                        <div class="menu-item">
                                        ...
                                        <table class="table table-row-dashed table-row-gray-300 gy-7">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <span class="fw-bold text-gray-800 fs-6">{{ $user->department ?? 'Not Set' }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="fw-semibold text-muted">Phone</td>
                                                    <td class="text-end">
                                                        <span class="fw-bold text-gray-800 fs-6">{{ $user->phone ?? 'Not Set' }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="fw-semibold text-muted">Last Updated</td>
                                                    <td class="text-end">
                                                        <span class="fw-bold text-gray-800 fs-6">{{ $user->updated_at->format('M d, Y') }}</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="col-span-1">
                            <div class="card card-bordered mb-5 lg:mb-7.5">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-gray-600 fs-7">Complete your profile to get the most out of your account.</p>
                                </div>
                            </div>
