        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="d-flex align-items-center">
                    <img src="{{ $user->avatar_url ? asset('storage/' . $user->avatar_url) : asset('metronic/media/avatars/300-2.png') }}" 
            ...
            <div class="kt-scrollable-x-auto">
                <div class="kt-menu gap-3" data-kt-menu="true">
                    <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
                        <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="#overview" data-bs-toggle="pill" data-bs-target="#overview">
                    ...
                    <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
                        <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="#personal" data-bs-toggle="pill" data-bs-target="#personal">
                            <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-item-here:text-primary kt-menu-item-here:font-semibold">
                                Personal Info
                            </span>
                        </a>
                    ...
                    <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
                        <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="#security" data-bs-toggle="pill" data-bs-target="#security">
                            <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-item-here:text-primary kt-menu-item-here:font-semibold">
                                Security
                            </span>
                        </a>
                    ...
                    <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
                        <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="#notifications" data-bs-toggle="pill" data-bs-target="#notifications">
                            <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-item-here:text-primary kt-menu-item-here:font-semibold">
                                Notifications
                            </span>
                        </a>
                                        ...
                                        <table class="table table-borderless">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bold">{{ $user->department ?? 'Not specified' }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div class="kt-card">
                                ...
                                <div class="kt-card-content pb-7.5">
                                    <div class="grid grid-cols-2 gap-3">
                                        <div class="flex flex-col gap-1 items-center border border-dashed border-gray-300 rounded-lg p-4">
                            ...
                            <div class="kt-card">
                                ...
                                <div class="kt-card-content pb-7.5">
                                    <div class="flex flex-col gap-5">
                                        ...
                                        <div class="flex items-start gap-3.5">
                                            <div class="flex items-center justify-center size-8 bg-primary-light rounded-full border border-primary-clarity">
                            ...
                            <div class="kt-card-content pb-7.5">
                                <form>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="d-flex align-items-center gap-4">
                                                <div class="symbol symbol-100px">
                                                    <img src="{{ $user->avatar_url ? asset('storage/' . $user->avatar_url) : asset('metronic/media/avatars/300-2.png') }}" 
                                                         alt="Avatar" class="w-100 h-100 rounded-circle object-fit-cover">
                                                </div>
                                                <div>
                                                    <button type="button" class="kt-btn kt-btn-primary kt-btn-sm me-2">Upload New</button>
                                                    <button type="button" class="kt-btn kt-btn-light kt-btn-sm">Remove</button>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mb-3 mb-lg-0">
                                                    <input type="text" name="fname" class="form-control form-control-lg form-control-solid" 
                                                           placeholder="First name" value="{{ explode(' ', $user->name)[0] ?? '' }}" />
                                                </div>
                                                <div class="col-lg-6">
                                                    <input type="text" name="lname" class="form-control form-control-lg form-control-solid" 
                                                           placeholder="Last name" value="{{ explode(' ', $user->name)[1] ?? '' }}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="position" class="form-control form-control-lg form-control-solid" 
                                ...
                                <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6">
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        <div class="fw-semibold">
                                            ...
                                            <div class="fs-6 text-gray-700">Adding more information helps colleagues find and connect with you.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-muted">Add an extra layer of security to your account</div>
                                                </div>
                                            </div>
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox" name="two_factor" />
                                                <span class="form-check-label fw-semibold text-muted">Enable 2FA</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-row-dashed table-row-gray-300 gy-7">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>2 hours ago</td>
                                                        <td>
                                                            <a href="#" class="btn btn-sm btn-light-danger">Revoke</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <div class="d-flex flex-column gap-4">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted fs-7">At least 8 characters with numbers and symbols</div>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-start">
                                        <i class="ki-filled ki-check-circle fs-3 text-success me-3 mt-1"></i>
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted fs-7">Review and revoke suspicious sessions</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="timeline">
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-content mb-10 mt-n1">
                                            <div class="pe-3 mb-5">
                                                <div class="fs-6 text-gray-800 fw-semibold mb-2">Password changed</div>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-content mb-10 mt-n1">
                                            <div class="pe-3 mb-5">
                                                <div class="fs-6 text-gray-800 fw-semibold mb-2">Profile updated</div>
                                                <div class="d-flex align-items-center mt-1 fs-7">
                            ...
                            <div class="kt-card-content pb-7.5">
                                ...
                                <div class="mb-8">
                                    ...
                                    <div class="row mb-6">
                                        <label class="col-lg-8 col-form-label fw-semibold fs-6">
                                            Profile Updates
                                            <div class="text-muted fs-7">Get notified when your profile information is changed</div>
                                        </label>
                                    ...
                                    <div class="row mb-6">
                                        <label class="col-lg-8 col-form-label fw-semibold fs-6">
                                            Security Alerts
                                            <div class="text-muted fs-7">Important security notifications about your account</div>
                                        </label>
                                        <div class="col-lg-4 d-flex justify-content-end">
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                ...
                                <div class="mb-8">
                                    ...
                                    <div class="row mb-6">
                                        <label class="col-lg-8 col-form-label fw-semibold fs-6">
                                            System Updates
                                            <div class="text-muted fs-7">Notifications about system maintenance and updates</div>
                                        </label>
                                        <div class="col-lg-4 d-flex justify-content-end">
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox" name="system_updates" checked />
                                                <span class="form-check-label"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-6">
                                        <label class="col-lg-8 col-form-label fw-semibold fs-6">
                                            Newsletter
                                            <div class="text-muted fs-7">Weekly newsletter with updates and tips</div>
                                        </label>
                                        <div class="col-lg-4 d-flex justify-content-end">
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                ...
                                <div class="notice d-flex bg-light-info rounded border-info border border-dashed p-6 mb-6">
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        <div class="fw-semibold">
                                            ...
                                            <div class="fs-6 text-gray-700">Customize your notifications to stay updated with what matters to you.</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="kt-card-content pb-7.5">
                                <div class="d-flex flex-column gap-4">
                                    <label class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" name="frequency" value="immediate" checked />
                                    ...
                                    <label class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" name="frequency" value="daily" />
                                        <span class="form-check-label fw-semibold">
                                            Daily Summary
                                    ...
                                    <label class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" name="frequency" value="weekly" />
                                        <span class="form-check-label fw-semibold">
                                            Weekly Summary
