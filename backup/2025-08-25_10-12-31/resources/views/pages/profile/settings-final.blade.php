            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="nav nav-pills flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <button class="nav-link active rounded-0 border-0 text-start" id="v-pills-overview-tab" data-bs-toggle="pill" data-bs-target="#v-pills-overview" type="button" role="tab">
                            <i class="ki-filled ki-profile-circle me-3"></i>
                            Overview
                        </button>
                        <button class="nav-link rounded-0 border-0 text-start" id="v-pills-personal-tab" data-bs-toggle="pill" data-bs-target="#v-pills-personal" type="button" role="tab">
                            <i class="ki-filled ki-badge me-3"></i>
                            Personal Info
                        </button>
                        <button class="nav-link rounded-0 border-0 text-start" id="v-pills-security-tab" data-bs-toggle="pill" data-bs-target="#v-pills-security" type="button" role="tab">
                            <i class="ki-filled ki-shield-tick me-3"></i>
                            Security
                        </button>
                        <button class="nav-link rounded-0 border-0 text-start" id="v-pills-notifications-tab" data-bs-toggle="pill" data-bs-target="#v-pills-notifications" type="button" role="tab">
                        ...
                        <div class="col-xl-4">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted small mb-0">Complete your profile to get the most out of your account.</p>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-lg-8">
                                    ...
                                    <div class="text-muted small">Get notified when your profile information is changed</div>
                                </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-8">
                                    ...
                                    <div class="text-muted small">Important security notifications about your account</div>
                                </div>
                                <div class="col-lg-4 text-end">
                                    <div class="form-check form-switch">
