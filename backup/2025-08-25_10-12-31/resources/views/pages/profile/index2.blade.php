     ...
     <div class="bg-center bg-cover bg-no-repeat hero-bg">
      ...
      <div class="kt-container-fixed">
       <div class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
        <img class="rounded-full border-3 border-green-500 size-[100px] shrink-0" src="{{ $user->avatar_url ? asset('storage/' . $user->avatar_url) : asset('metronic/media/avatars/300-2.png') }}">
          ...
          <div class="kt-card-content">
           <div class="flex flex-col gap-3.5">
            <div class="flex items-start gap-3.5">
             <img alt="" class="rounded-full size-9 shrink-0" src="{{ $user->avatar_url ? asset('storage/' . $user->avatar_url) : asset('metronic/media/avatars/300-2.png') }}"/>
