                                ...
                                <a href="{{ route('users.index') }}"
                                    ...
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="text-xs text-secondary-foreground">{{ $stats['users'] }} total
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                <a href="{{ route('countries.index') }}"
                                    ...
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="text-xs text-secondary-foreground">{{ $stats['countries'] }} total
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                <a href="{{ route('cities.index') }}"
                                    ...
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="text-xs text-secondary-foreground">{{ $stats['cities'] }} total
                                            </div>
                                        </div>
                                    </div>
                                </a>
