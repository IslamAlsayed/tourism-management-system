...
return [
    ...
    'Failed to update language status. Please try again.' => 'Failed to 更新 言語 status. Please try again.',
    'ably_key_not_configured' => 'Ably key not configured, skipping Ably broadcast.',
    'access_denied' => 'Access Denied',
    'accommodation_rates_records_info' => 'Accommodation price records will be automatically 作成d for each combination (season × room) and (season × meal) with default values (0). You can modify the prices later.',
    'add_banner' => 'Add New Banner',
    'all_notifications_marked_read' => 'All 通知 marked as read.',
    'are_you_sure' => 'Are you sure?',
    'are_you_sure_delete' => 'This item will be moved to the archive (soft 削除). You can restore it later.',
    'are_you_sure_force_delete' => 'This will PERMANENTLY 削除 this record from the database.',
    'available_columns' => 'Available Columns',
    'backup_created_test' => 'Backup 作成d 成功fully (test mode).',
    'banner_image' => 'Banner Image',
    'cannot_delete_default_role' => 'Cannot 削除 default roles (superadmin, admin, user).',
    'capacity must be at least 1.' => 'Capacity must be at least 1.',
    'change_language_not_successfully' => 'Language change not 成功ful.',
    'change_language_successfully' => 'Language changed 成功fully.',
    ...
    'columns_updated_successfully' => 'System columns 更新d 成功fully.',
    ...
    'confirm_bulk_delete' => 'Are you sure you want to 削除 the selected items? NOTE: This is a',
    'confirm_bulk_disable_auto_update' => 'Are you sure you want to disable auto-更新 (fix exchange rate) for the selected items?',
    'confirm_bulk_enable_auto_update' => 'Are you sure you want to enable auto-更新 for the selected items?',
    'confirm_bulk_force_delete' => 'WARNING: Are you sure you want to PERMANENTLY 削除 the selected items? CRITICAL: This will completely erase the data from the database. Next time you 作成 or インポート items, they will get NEW, higher IDs, which may break relationships with other modules (like Hotels or Restaurants). Use only if absolutely necessary!',
    ...
    'created_language_successfully' => 'Language 作成d 成功fully.',
    'created_not_language_successfully' => 'Language not 作成d 成功fully.',
    ...
    'data_refreshed_successfully' => 'Data refreshed 成功fully.',
    'default_language_updated' => 'تم تحديث اللغة الافتراضية بنجاح.',
    'edit_banner' => 'Edit Banner',
    'error_occurred' => 'Error Occurred',
    'field_deleted_successfully' => ':field has been :status 成功fully.',
    'field_updated_successfully' => ':field has been :status 成功fully.',
    'force_delete_warning' => 'This アクション cannot be undone. All related data may be affected.',
    'general_error' => 'An エラー occurred. Please try again.',
    ...
    'language_deleted_successfully' => 'Language 削除d 成功fully.',
    'language_deletion_failed' => 'Language deletion 提供された資格情報は正しくありません。.',
    ...
    'notification_deleted' => 'Notification 削除d.',
    ...
    'permission_created_successfully' => 'Permission 作成d 成功fully.',
    'permission_creation_failed' => 'Permission creation 提供された資格情報は正しくありません。.',
    'permission_deleted_failed' => 'Permission deletion 提供された資格情報は正しくありません。.',
    'permission_deleted_successfully' => 'Permission 削除d 成功fully.',
    'permission_name_format' => 'Use snake_case format like: 作成_ユーザー, 編集_posts, 削除_comments',
    'permission_updated_failed' => 'Permission 更新 提供された資格情報は正しくありません。.',
    'permission_updated_successfully' => 'Permission 更新d 成功fully.',
    'permissions_count' => 'Permissions count: :count',
    'photo_uploaded_successfully' => 'Photo Uploaded Successfully',
    'please_login_to_continue' => 'Please ログイン to continue.',
    'profile_photo_updated' => 'Profile Photo Updated',
    'profile_updated' => 'Profile Updated',
    'quick_edit_saved' => ':type 更新d 成功fully.',
    ...
    'role_created_successfully' => 'Role 作成d 成功fully.',
    'role_creation_failed' => 'Role creation 提供された資格情報は正しくありません。.',
    'role_deleted_failed' => 'Role deletion 提供された資格情報は正しくありません。.',
    'role_deleted_successfully' => 'Role 削除d 成功fully.',
    'role_updated_failed' => 'Role 更新 提供された資格情報は正しくありません。.',
    'role_updated_successfully' => 'Role 更新d 成功fully.',
    'route' => 'Route',
    'select_at_least_one_notification_type' => 'Select at least one notification type.',
    'select_module' => 'Select Module',
    'select_route' => 'Select Route...',
    'selected_items_deleted' => 'Selected items 削除d 成功fully. :count items removed.',
    ...
    'sidebar_export_error' => 'Error エクスポートing sidebar config: :エラー',
    'sidebar_item_hidden' => 'Menu item hidden.',
    'sidebar_item_shown' => 'Menu item shown.',
    'sidebar_order_update_error' => 'Error updating sidebar order: :エラー',
    'sidebar_order_updated' => 'Sidebar order 更新d 成功fully.',
    'sidebar_reset_default' => 'Sidebar reset to default order.',
    'sidebar_reset_error' => 'Error resetting sidebar: :エラー',
    ...
    'type_created_by' => ':record_name has been 追加ed to :type_name by :user_name',
    'type_creation_failed' => ':type Creation Failed',
    'type_deleted' => ':type Deleted',
    'type_deleted_by' => ':record_name from :type_name has been 削除d by :user_name',
    ...
    'type_updated_by' => ':record_name from :type_name has been 更新d by :user_name',
    ...
    'verification_link_sent' => 'Verification link sent to your メール.',
    'welcome_back_name' => 'Welcome back, :name!',
    'you_logged_in' => 'You logged in 成功fully.',
    'you_logged_out' => 'You logged out 成功fully.',
];
