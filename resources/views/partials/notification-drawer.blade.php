                ...
                <div class="flex grow gap-2.5 px-5">
                    ...
                    <div class="flex flex-col gap-3.5 grow">
                        ...
                        <div
                            ...
                            <img class="h-5"
                                src="{{ asset('metronic/media/file-types/pdf.svg" ') }}/>
							<a class="hover:text-primary
                                font-medium text-secondary-foreground text-xs me-1" href="#">
                            Launch_nov24.pptx
                            </a>
                    ...
                    <div class="flex flex-col gap-3.5 grow">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <img class="h-5"
                                    src="{{ asset('metronic/media/file-types/figma.svg" ') }}/>
							</div>
							<a class="hover:text-primary
                                    font-medium text-secondary-foreground text-xs me-1" href="#">
                                Launcher-UIkit.fig
                ...
                <div class="flex flex-col gap-5 pt-3 pb-4">
                    ...
                    <div class="flex grow gap-2.5 px-5">
                        <div class="kt-avatar size-8">
                            <div class="kt-avatar-image">
                                <img alt="avatar"
                                    src="{{ asset('metronic/media/avatars/300-34.png" ') }}/>
						</div>
						<div class="kt-avatar-indicator
                                    -end-2 -bottom-2">
                                <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col gap-3.5 grow">
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-1.5">
                                    <img class="h-6"
                                        src="{{ asset('metronic/media/file-types/xls.svg" ') }}/>
								<div class="flex
                                        flex-col gap-0.5">
                        ...
                        <div class="flex grow gap-2.5 px-5">
                            ...
                            <div class="flex flex-col gap-3.5 grow">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-1.5">
                                        <img class="h-6"
                                            src="{{ asset('metronic/media/file-types/word.svg" ') }}/>
								<div class="flex
                                            flex-col gap-0.5">
                                        <a class="hover:text-primary font-medium text-secondary-foreground text-xs"
                                            href="#">
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-1.5">
                                    <img class="h-6"
                                        src="{{ asset('metronic/media/file-types/svg.svg" ') }}/>
								<div class="flex
                                        flex-col gap-0.5">
                                    <a class="hover:text-primary font-medium text-secondary-foreground text-xs"
                                        href="#">
                        ...
                        <div class="flex items-center gap-2.5">
                            <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
                                <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24"
                                    style="background-image: url('metronic/media/images/600x600/6.jpg')">
                                </div>
                            ...
                            <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
                                <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24"
                                    style="background-image: url('metronic/media/images/600x600/1.jpg')">
                                </div>
                                <div class="px-2.5 pb-2">
                                    <a class="font-medium block text-secondary-foreground hover:text-primary text-xs leading-4 mb-0.5"
                                        href="#">
                    ...
                    <div class="flex flex-col gap-2.5 grow">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <img class="h-5"
                                    src="{{ asset('metronic/media/brand-logos/jira.svg" ') }}/>
							</div>
							<a class="hover:text-primary
                                    font-medium text-secondary-foreground text-xs me-1" href="#">
                                User-feedback.jira
