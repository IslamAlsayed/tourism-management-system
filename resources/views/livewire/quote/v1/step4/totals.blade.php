<div class="space-y-4">
    ...
    <div class="grid lg:grid-cols-3 gap-4">
        <div>
            ...
            <input type="number" step="0.01" name="discount" wire:model.live="discount" class="kt-input h-[45px]">
        </div>
        <div>
            <label class="kt-label mb-2">Tax (%)</label>
            <input type="number" step="0.01" name="tax" wire:model.live="tax" class="kt-input h-[45px]">
        </div>
    </div>
