<div>
    ...
    <div class="kt-card bg-blue-100">
        <div class="kt-card-header">
            ...
            <button type="button" wire:click="addSeason" class="kt-btn bg-primary-600 text-white hover:bg-primary-700">
        ...
        <div class="kt-card-body p-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 items-end gap-6">
                @foreach ($seasons as $index => $season)
                    <div class="kt-card p-4 border-2" wire:key="season-{{ $season['id'] }}">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 items-end gap-6 mb-4">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="date" name="seasons[{{ $index }}][season_from]"
                                    ...
                                    value="{{ old('seasons.' . $index . '.season_from') }}">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="date" name="seasons[{{ $index }}][season_to]"
                                    ...
                                    value="{{ old('seasons.' . $index . '.season_to') }}">
