<div class="kt-card kt-card-grid min-w-full">
    ...
    <div class="kt-card-content px-2" wire:loading.class="loading"
        ...
        <!-- Filters -->
        <div class="mb-4 grid grid-cols-1 md-grid-cols-3 gap-4 filterTable">
            <div>
        ...
        <div data-kt-datatable-state-save="false" id="meal_types_table">
            <div class="kt-scrollable-x-auto">
                @component('components.data-table', [
                    'data' => $data,
                    'columns' => $columns,
                    'search' => $search,
                    'models' => 'accommodations.meals',
                    'selectedIds' => $selectedIds ?? [],
                ])
                @endcomponent
            </div>
