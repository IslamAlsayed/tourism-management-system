<div>
    ...
    <div class="kt-card bg-pink-100">
        <div class="kt-card-header">
            ...
            <button type="button" wire:click="addSupplement" toggle-button
            ...
            <div class="flex flex-col gap-4">
                @foreach ($supplements as $index => $supplement)
                    <div class="kt-card p-4 border-2" wire:key="supplement-{{ $index }}">
                        ...
                        {{-- description --}}
                        <div class="mb-4">
                            <label for="supplements_{{ $index }}_description"
                                class="kt-label mb-2">{{ __('main.description') }}</label>
                            <input id="supplements_{{ $index }}_description" type="hidden"
                                name="supplements[{{ $index }}][description]"
