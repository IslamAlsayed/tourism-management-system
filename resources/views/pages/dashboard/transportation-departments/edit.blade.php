...
@section('title', __('main.edit_type', ['type' => __('main.transportation_department')]))
...
@section('content')
        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            <div class="flex flex-col justify-center gap-2">
                <h1 class="text-xl font-medium leading-none text-mono">
                    {{ __('main.edit_type', ['type' => __('main.transportation_department')]) }}
                </h1>
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    {{ __('main.edit_type_description', ['type' => __('main.transportation_department')]) }}
                </div>
            </div>
            <div class="flex items-center gap-2.5">
                <a href="{{ route('transportation-departments.index') }}" class="kt-btn kt-btn-outline">
                    {{ __('main.back_to_types', ['types' => __('main.transportation_departments')]) }}
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="kt-container-fixed">
        <div class="grid gap-4 lg:gap-6">
            <!-- transportation_department Form -->
            <div class="kt-card">
                <div class="kt-card-header">
                    <h3 class="kt-card-title">
                        {{ __('main.type_information', ['type' => __('main.transportation_department')]) }}</h3>
                </div>
                    ...
                    <form method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 items-end mb-4">
                            ...
                            <div class="">
                                <label for="department"
                                    class="kt-label mb-2">{{ __('main.transportation_department') }}</label>
                        ...
                        <div class="flex items-center gap-4">
                            <button type="submit" class="kt-btn kt-btn-primary">
                                ...
                                {{ __('main.update_type', ['type' => __('main.transportation_department')]) }}
                            </button>
                            <a href="{{ route('transportation-departments.index') }}" class="kt-btn kt-btn-outline">
                                {{ __('main.cancel') }}
                            </a>
