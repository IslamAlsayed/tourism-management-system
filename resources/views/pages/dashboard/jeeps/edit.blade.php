                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="col-span-full flex flex-col gap-4">
                                {{-- Route --}}
                                <div>
                                    <label for="route" class="kt-label">{{ __('main.route') }}</label>
                                    <textarea name="route" id="route" class="kt-textarea">{{ $jeep->route }}</textarea>
                                    @error('route')
                                ...
                                <div>
                                    ...
                                    <textarea name="route_ar" id="route_ar" class="kt-textarea">{{ $jeep->route_ar }}</textarea>
                                    @error('route_ar')
                                        <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-span-full">
                                ...
                                <input type="text" name="route_itinerary" id="route_itinerary" class="kt-input h-fit"
                                    value="{{ is_array($jeep->route_itinerary) ? implode(',', $jeep->route_itinerary) : $jeep->route_itinerary }}" placeholder="Stop 1, Stop 2, ...">
