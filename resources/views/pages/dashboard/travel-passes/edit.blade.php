...
@section('content')
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('travel-passes.update', $travelPass->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid gap-4 lg:gap-6">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="">
                                ...
                                <input type="text" name="name" id="name" class="kt-input h-[45px]" value="{{ $travelPass->name }}" placeholder="e.g. Jordan Explorer">
                                @error('name')
                            ...
                            <div class="">
                                ...
                                <input type="text" name="name_ar" id="name_ar" class="kt-input h-[45px]" dir="rtl" value="{{ $travelPass->name_ar }}" placeholder="مثال: جوردان اكسبلورر">
                                @error('name_ar')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="number" min="0" name="sort_order" id="sort_order" class="kt-input h-[45px]" value="{{ $travelPass->sort_order }}">
                                @error('sort_order')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="">
                                ...
                                <input type="number" step="0.01" min="0" name="price" id="price" class="kt-input h-[45px]" value="{{ $travelPass->price }}">
                                @error('price')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="number" min="1" name="validity_days" id="validity_days" class="kt-input h-[45px]" value="{{ $travelPass->validity_days }}">
                                @error('validity_days')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="number" min="0" name="min_stay_nights" id="min_stay_nights" class="kt-input h-[45px]" value="{{ $travelPass->min_stay_nights }}">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="url" name="official_purchase_url" id="official_purchase_url" class="kt-input h-[45px]" value="{{ $travelPass->official_purchase_url }}"
                                    placeholder="https://...">
                                                    ...
                                                    @if ($index >= ($step - 1) * 9 && $index < $step * 9)
                                                        <div class="flex items-center gap-3 p-3 border-custom rounded-lg hover:bg-gray-100">
                                                            @component('components.elements.checkbox-button', [
                                                                ...
                                                                @if ($site->name_ar)
                                                                    @slot('checkboxSlot')
                                                                        <label for="site_{{ $site->id }}" class="text-sm text-gray-500 !py-0 block">{{ $site->name_ar }}</label>
                                                                    @endslot
                                                                @endif
                                                            @endcomponent
                                                        </div>
                ...
                <!-- Update Submit -->
                @include('components.elements.update-submit', ['models' => 'travel-passes', 'model' => 'travel-pass'])
            </div>
        </form>
    </div>
@endsection
