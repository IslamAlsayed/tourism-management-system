...
@section('title', __('main.edit_type', ['type' => __('main.transportations-vehicle-type')]))
...
@section('content')
        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-4">
            <div class="flex flex-col justify-center gap-2">
                <h1 class="text-xl font-medium leading-none text-mono">
                    {{ __('main.edit_type', ['type' => __('main.transportations-vehicle-type')]) }}
                </h1>
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    {{ __('main.edit_type_description', ['type' => __('main.transportations-vehicle-type')]) }}
                </div>
            </div>
            <div class="flex items-center gap-2.5">
                <a href="{{ route('transportations.vehicle-types.index') }}" class="kt-btn kt-btn-outline">
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('transportations.vehicle-types.update', $vehicleType->id) }}" method="POST"
