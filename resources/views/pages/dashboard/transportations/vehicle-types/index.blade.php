...
@section('table-content')
    ...
    @include('includes.table-breadcrumb', [
        ...
        'import_url' => route('import.data', ['models' => 'transportations.vehicle-types']),
        'page_create_url' => route('transportations.vehicle-types.create'),
    ...
    <div class="grid gap-4 lg:gap-6">
        <div class="kt-card kt-card-grid min-w-full">
            <livewire:transportations.vehicle-types />
        </div>
    </div>
    <!-- End of Container -->
@endsection
