...
@section('content')
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('transportations.route-assignments.update', $assignment->id) }}" method="POST">
            @csrf
            @method('PUT')
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="base_price" id="base_price" step="0.01"
                                    class="kt-input h-[45px]" value="{{ $assignment->base_price }}" placeholder="0.00">
                                @error('base_price')
                            ...
                            <div>
                                ...
                                <input type="number" name="price_per_km" id="price_per_km" step="0.01"
                                    class="kt-input h-[45px]" value="{{ $assignment->price_per_km }}" placeholder="0.00">
                                @error('price_per_km')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="price_per_person" id="price_per_person" step="0.01"
                                    class="kt-input h-[45px]" value="{{ $assignment->price_per_person }}"
                                    placeholder="0.00">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="frequency_per_day" id="frequency_per_day"
                                    class="kt-input h-[45px]" value="{{ $assignment->frequency_per_day }}" min="1">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="valid_to" id="valid_to" class="kt-input h-[45px]"
                                    value="{{ $assignment->formatted_valid_to }}">
                                @error('valid_to')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
