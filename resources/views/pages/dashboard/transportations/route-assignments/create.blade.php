...
@section('content')
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('transportations.route-assignments.store') }}" method="POST">
            @csrf
            <div class="grid gap-4 lg:gap-6">
                ...
                <div class="kt-card">
                    ...
                    <div class="kt-card-body p-4">
                        <livewire:transportations.route-assignment :routes="$routes" />
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="base_price" id="base_price" step="0.01"
                                    class="kt-input h-[45px]" value="{{ old('base_price', 0) }}" placeholder="0.00">
                                @error('base_price')
                            ...
                            <div>
                                ...
                                <input type="number" name="price_per_km" id="price_per_km" step="0.01"
                                    class="kt-input h-[45px]" value="{{ old('price_per_km', 0) }}" placeholder="0.00">
                                @error('price_per_km')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="price_per_person" id="price_per_person" step="0.01"
                                    class="kt-input h-[45px]" value="{{ old('price_per_person', 0) }}" placeholder="0.00">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="time" name="arrival_time" id="arrival_time" class="kt-input h-[45px]"
                            ...
                            <div>
                                ...
                                <input type="number" name="frequency_per_day" id="frequency_per_day"
                                    class="kt-input h-[45px]" value="{{ old('frequency_per_day', 1) }}" min="1">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="valid_to" id="valid_to" class="kt-input h-[45px]"
                                    value="{{ old('valid_to') }}">
                                @error('valid_to')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
