...
@section('title', 'Create New Transportation Service')
...
@section('content')
        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            <div class="flex flex-col justify-center gap-2">
                ...
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    Add a new transportation service to the system
                </div>
            </div>
    ...
    <div class="kt-container-fixed">
        <div class="grid gap-5 lg:gap-7.5">
                    ...
                    <form class="space-y-6 p-4">
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" class="kt-input" placeholder="Enter company name" required>
                            </div>

                            <!-- Company Name Arabic -->
                            <div class="mb-4">
                                <label for="name_ar" class="kt-label required mb-2">Company Name (Arabic)</label>
                                <input type="text" name="name_ar" id="name_ar" class="kt-input" placeholder="أدخل اسم الشركة" required>
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="fleet_size" id="fleet_size" class="kt-input" placeholder="Enter number of vehicles" required>
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" rows="3" class="kt-input" placeholder="Enter service description"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-3 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" name="email" id="email" class="kt-input" placeholder="info@company.com">
                            </div>

                            <!-- Website -->
                            <div class="mb-4">
                                <label for="website" class="kt-label mb-2">Website</label>
                                <input type="url" name="website" id="website" class="kt-input" placeholder="www.company.com">
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="operating_hours" id="operating_hours" class="kt-input" placeholder="e.g., 24/7 or 6:00 AM - 10:00 PM">
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="license_number" id="license_number" class="kt-input" placeholder="Enter license number">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="airport_pickup" class="kt-checkbox" value="airport_pickup">
                                    <label for="airport_pickup" class="kt-label mb-0">Airport Pickup</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="city_tours" class="kt-checkbox" value="city_tours">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="long_distance" class="kt-checkbox" value="long_distance">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="driver_service" class="kt-checkbox" value="driver_service">
                                    <label for="driver_service" class="kt-label mb-0">Driver Service</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="group_transport" class="kt-checkbox" value="group_transport">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="vehicle_types[]" id="bus" class="kt-checkbox" value="bus">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="vehicle_types[]" id="van" class="kt-checkbox" value="van">
            ...
            <div class="kt-card">
                <div class="kt-card-header">
                    <h3 class="kt-card-title">Transportation Tips</h3>
                </div>
                <div class="kt-card-body p-2">
                    <div class="space-y-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-semibold">Complete Fleet Information</div>
                                <div class="text-sm text-secondary-foreground">Provide detailed information about your vehicles and services</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-semibold">Valid Licenses</div>
                                <div class="text-sm text-secondary-foreground">Ensure all licenses and permits are up to date</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-semibold">Competitive Pricing</div>
                                <div class="text-sm text-secondary-foreground">Set competitive prices to attract more customers</div>
                            </div>
                        </div>
                    </div>
                </div>
