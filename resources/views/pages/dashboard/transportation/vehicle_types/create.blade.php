...
@section('title', __('main.create_type', ['type' => __('main.transportation-vehicle-type')]))
...
@section('content')
        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-4">
            <div class="flex flex-col justify-center gap-2">
                <h1 class="text-xl font-medium leading-none text-mono">
                    {{ __('main.create_type', ['type' => __('main.transportation-vehicle-type')]) }}
                </h1>
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    {{ __('main.create_type_description', ['type' => __('main.transportation-vehicle-type')]) }}
                </div>
            </div>
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('transportation.vehicle-types.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
