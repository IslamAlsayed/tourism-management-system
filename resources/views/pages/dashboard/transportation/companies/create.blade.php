...
@section('content')
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('transportation.companies.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="grid gap-4 lg:gap-6">

                {{-- Transportation Company Photo --}}
                @include('components.input-image', [
                    'column' => 'transportation_company',
                    'columnName' => 'photo',
                ])
                ...
                <div class="kt-card">
                    <div class="kt-card-header">
                        <h3 class="kt-card-title">
                            {{ __('main.type_information', ['type' => __('main.transportation_company')]) }}
                        </h3>
                    </div>
                    <div class="kt-card-body p-4">
