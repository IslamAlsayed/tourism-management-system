...
@section('title', __('main.type_details', ['type' => __('main.transportation_company')]))
    ...
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('transportation.companies.edit', $company->id) }}" class="kt-btn kt-btn-primary md:hidden">
                    <i class="ki-filled ki-pencil text-sm me-2"></i>
                    {{ __('main.edit') }}
                </a>
                <a href="{{ route('transportation.companies.index') }}" class="kt-btn kt-btn-outline">
                    {{ __('main.back_to_types', ['types' => __('main.transportation-companies')]) }}
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="kt-container-fixed">
        <div class="grid gap-4 lg:gap-6">
            ...
            @if ($company->vehicleTypes->count() > 0)
                @include('pages.dashboard.related-components.transportation-vehicle-types', [
                    'record' => $company,
                ])
            @endif
            ...
            @if ($company->seasons->count() > 0)
                @include('pages.dashboard.related-components.seasons', ['record' => $company])
            @endif

            <!-- Supplements -->
            @if ($company->supplements->count() > 0)
                @include('pages.dashboard.related-components.supplements', ['record' => $company])
            @endif
