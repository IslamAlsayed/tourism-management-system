...
@section('title', __('main.import_contacts'))
            ...
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('transportations.import-export.contacts-import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="alert alert-info" role="alert">
                                ...
                                <ul class="mb-0">
                                    ...
                                    <li>{{ __('main.ensure_company_id_or_name_field') }}</li>
                                    <li>{{ __('main.all_contact_records_will_be_inserted') }}</li>
                                    <li>{{ __('main.duplicate_contacts_allowed') }}</li>
                                </ul>
                            </div>
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <form action="{{ route('transportations.import-export.contacts-export') }}" method="POST">
                            @csrf
