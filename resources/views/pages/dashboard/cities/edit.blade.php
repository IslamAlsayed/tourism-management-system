...
@section('title', __('main.edit') . ' ' . __('main.city'))
                ...
                <div class="kt-card-body p-2">
                    <div class="space-y-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-semibold">{{ __('main.verify_data_accuracy') }}</div>
                                <div class="text-sm text-secondary-foreground">
                                    {{ __('main.verify_coordinates_before_save') }}</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">{{ __('main.select_country_before_city') }}
                                </div>
                            </div>
                        </div>
                    </div>
