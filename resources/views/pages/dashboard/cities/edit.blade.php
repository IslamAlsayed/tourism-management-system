        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            <div class="flex flex-col justify-center gap-2">
                ...
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    تعديل معلومات المدينة في قاعدة البيانات الجغرافية
                </div>
            </div>
                    ...
                    <form method="POST" action="{{ route('cities.update', $city->id) }}" class="space-y-6 p-4">
                        ...
                        <div class="grid lg:grid-cols-3 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name_ar" id="name_ar" class="kt-input"
                                    placeholder="أدخل اسم المدينة بالعربية" required value="{{ $city->name_ar }}">
                                @error('name_ar')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" class="kt-input"
                                    placeholder="Enter city name in English" required value="{{ $city->name }}">
                                @error('name')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="grid lg:grid-cols-3 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" step="any" name="latitude" id="latitude" class="kt-input"
                                    placeholder="مثال: 24.7136" value="{{ $city->latitude }}">
                                @error('latitude')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" step="any" name="longitude" id="longitude" class="kt-input"
                                    placeholder="مثال: 46.6753" value="{{ $city->longitude }}">
                                @error('longitude')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="population" id="population" class="kt-input"
                                    placeholder="مثال: 1000000" value="{{ $city->population }}">
                                @error('population')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="4" class="kt-input"
                                placeholder="معلومات إضافية عن المدينة...">{{ $city->description }}</textarea>
                            @error('description')
                                <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="flex items-center gap-3">
                                ...
                                <input type="checkbox" name="is_active" id="is_active" class="kt-checkbox"
                                    value="1" {{ $city->is_active ? 'checked' : '' }}>
