                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-4">
                            ...
                            <div class="">
                                ...
                                <select name="currency_id" id="currency_id" class="kt-select h-[45px]" special-search
                                    value="{{ $tourGuideType->currency_id }}">
                                    <option value="">--</option>
                            ...
                            <!-- State -->
                            <div class="">
                                <label for="all_states" class="kt-label mb-2">
                                    ...
                                    <input type="checkbox" name="all_states" id="all_states" class="kt-checkbox"
                                        ...
                                        value="1" {{ $tourGuideType->all_states == 1 ? 'checked' : '' }}>
                                ...
                                <select name="state_id" id="state_id" class="kt-select h-[45px]" special-search
                                    ...
                                    {{ $tourGuideType->all_states == 1 ? 'disabled' : '' }}>
                                    <option value="">--</option>
                            ...
                            <!-- City -->
                            <div class="">
                                <label for="all_cities" class="kt-label mb-2">
                                    ...
                                    <input type="checkbox" name="all_cities" id="all_cities" class="kt-checkbox"
                                        ...
                                        value="1" {{ $tourGuideType->all_cities == 1 ? 'checked' : '' }}>
                                ...
                                <select name="city_id" id="city_id" class="kt-select h-[45px]" special-search
                                    ...
                                    {{ $tourGuideType->all_cities == 1 ? 'disabled' : '' }}>
                                    <option value="">--</option>
