                    ...
                    <form class="space-y-6 p-4">
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="year" id="year" class="kt-input" required
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="color" id="color" class="kt-input" value="White">
                            </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="features[]" id="air_conditioning" class="kt-checkbox"
                                        value="air_conditioning" checked>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Regularly update maintenance records and
                                    service history</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Track vehicle performance and driver
                                    feedback</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Plan regular maintenance to prevent
                                    breakdowns</div>
                            </div>
                        </div>
                    </div>
