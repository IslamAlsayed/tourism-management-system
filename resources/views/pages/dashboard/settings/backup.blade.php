            ...
            <div class="grid lg:grid-cols-3 gap-5">
                ...
                <div class="kt-card p-4">
                    <div class="kt-card-body text-center">
                        ...
                        <div class="font-semibold">{{ $backupInfo['auto_backup_enabled'] ? __('main.enabled') : __('main.not_enabled') }}</div>
                    </div>
                </div>
            </div>
                    ...
                    <form class="space-y-6 p-4">
                        <div class="flex items-center justify-between">
                            <div class="mb-4">
                                ...
                                <div class="text-sm text-secondary-foreground">{{ __('main.manage_backup_restore_data') }}</div>
                            </div>
                        ...
                        <div>
                            ...
                            <select class="kt-select">
                                ...
                                <option value="monthly"
                                    {{ $backupInfo['backup_frequency'] == 'monthly' ? 'selected' : '' }}>{{ __('main.monthly') }}</option>
                            </select>
                        </div>
                    ...
                    <div class="space-y-3 p-4">
                        <div class="flex items-center justify-between border-b pb-2">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-secondary-foreground">25 {{ __('main.maps.august') }} 2025 - 10:12 {{ __('main.time') }}</div>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between border-b pb-2">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-semibold">{{ __('main.automatic_backup') }}</div>
                                    <div class="text-sm text-secondary-foreground">24 {{ __('main.maps.august') }} 2025 - 03:00 {{ __('main.time') }}</div>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                        ...
                        <div class="flex items-center justify-between border-b pb-2">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-semibold">{{ __('main.backup_now') }}</div>
                                    <div class="text-sm text-secondary-foreground">23 {{ __('main.maps.august') }} 2025 - 14:30 {{ __('main.time') }}</div>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
