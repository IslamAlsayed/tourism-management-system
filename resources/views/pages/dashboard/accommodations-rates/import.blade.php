            ...
            <x-import-form :title="$rate['title']" :description="$rate['description']" :models="$rate['model']">
                ...
                @if (env('DB_MODE') != 'production')
                    ...
                    @if ($rate['models'] == 'AccommodationRoomRate')
                        <table class="border-custom min-w-full divide-y text-center divide-gray-200 mb-3">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-custom px-2 bg-yellow-200" title="{{ __('main.required') }}">
                                        price_per_person_double <span class="text-red-600">*</span>
                                    </th>
                                    <th class="border-custom px-2 bg-blue-100" title="{{ __('main.optional') }}">currency_id
                                    </th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td class="border-custom px-2">100</td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <thead>
                                <tr>
                                    <th class="border-custom px-2 bg-blue-100" title="{{ __('main.optional') }}">
                                        single_room_supplement</th>
                                    <th class="border-custom px-2 bg-blue-100" title="{{ __('main.optional') }}">
                                        triple_room_discount</th>
                                    <th class="border-custom px-2 bg-blue-100" title="{{ __('main.optional') }}">
                                        third_person_price</th>
                                    <th class="border-custom px-2 bg-blue-100" title="{{ __('main.optional') }}">
                                        extra_bed_price</th>
                                    <th class="border-custom px-2 bg-blue-100" title="{{ __('main.optional') }}">
                                        sea_view_supplement</th>
                                    <th class="border-custom px-2 bg-blue-100" title="{{ __('main.optional') }}">notes</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    <td class="border-custom px-2">20</td>
                                    <td class="border-custom px-2">-10</td>
                                    <td class="border-custom px-2">80</td>
                                    <td class="border-custom px-2">30</td>
                                    <td class="border-custom px-2">15</td>
                                    <td class="border-custom px-2">Sample note</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="border-custom min-w-full divide-y text-center divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td class="border-custom px-2">1</td>
                                    <td class="border-custom px-2">1</td>
                                    <td class="border-custom px-2">50</td>
                                    <td class="border-custom px-2">1</td>
                                    <td class="border-custom px-2">Sample note</td>
                                </tr>
                            </tbody>
