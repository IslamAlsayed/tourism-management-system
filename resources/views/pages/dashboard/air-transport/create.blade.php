                    ...
                    <form class="space-y-6 p-4">
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="code" id="code" class="kt-input" placeholder="e.g., RUH, SV" required maxlength="3">
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="capacity" id="capacity" class="kt-input" placeholder="e.g., 35M passengers/year, 150 aircraft">
                            </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="runways" id="runways" class="kt-input" placeholder="Enter number of runways">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="facilities[]" id="shopping" class="kt-checkbox" value="shopping">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="facilities[]" id="lounges" class="kt-checkbox" value="lounges">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="domestic_flights" class="kt-checkbox" value="domestic_flights">
                                    <label for="domestic_flights" class="kt-label mb-0">Domestic Flights</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="international_flights" class="kt-checkbox" value="international_flights">
                                    <label for="international_flights" class="kt-label mb-0">International Flights</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="cargo" class="kt-checkbox" value="cargo">
                                    <label for="cargo" class="kt-label mb-0">Cargo Services</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="charter" class="kt-checkbox" value="charter">
                                    <label for="charter" class="kt-label mb-0">Charter Flights</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="private_jet" class="kt-checkbox" value="private_jet">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="maintenance" class="kt-checkbox" value="maintenance">
                ...
                <div class="kt-card-body p-2">
                    <div class="space-y-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-semibold">Accurate IATA Codes</div>
                                <div class="text-sm text-secondary-foreground">Use correct 3-letter IATA codes for airports and airlines</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-semibold">Safety Standards</div>
                                <div class="text-sm text-secondary-foreground">Ensure all safety standards and certifications are up to date</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Maintain high service quality standards for customer satisfaction</div>
                            </div>
                        </div>
                    </div>
                </div>
