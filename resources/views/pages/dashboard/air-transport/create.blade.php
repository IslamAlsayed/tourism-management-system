                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="services[]" id="international_flights"
                                        class="kt-checkbox" value="international_flights">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Use correct 3-letter IATA codes for airports
                                    and airlines</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Ensure all safety standards and
                                    certifications are up to date</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Maintain high service quality standards for
