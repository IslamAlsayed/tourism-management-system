    ...
    <div class="kt-container-fixed">
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-4 pb-6">
            ...
            <div class="flex items-center gap-2.5">
                <a href="{{ route('visa-requirements.edit', $visaRequirement->id) }}" class="kt-btn kt-btn-primary">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        @if ($visaRequirement->nationality)
                            <div>
                                ...
                                <a href="{{ route('nationalities.show', $visaRequirement->nationality?->id) }}" class="block text-sm text-primary underline">
                        ...
                        @if ($visaRequirement->destinationCountry)
                            <div>
                                ...
                                <a href="{{ route('nationalities.show', $visaRequirement->destinationCountry?->id) }}" class="block text-sm text-primary underline">
                ...
                <div class="kt-card-body p-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        <div>
                            ...
                            <p class="text-sm text-secondary-foreground">{{ $visaRequirement->visa_validity_days ?? '-' }} {{ $visaRequirement->visa_validity_days ? __('main.days') : '' }}</p>
                        </div>
                        <div>
                            <label class="kt-label mb-1">{{ __('main.max_stay_days') }}</label>
                            <p class="text-sm text-secondary-foreground">{{ $visaRequirement->max_stay_days ?? '-' }} {{ $visaRequirement->max_stay_days ? __('main.days') : '' }}</p>
                        </div>
                        <div>
                            <label class="kt-label mb-1">{{ __('main.processing_time_days') }}</label>
                            <p class="text-sm text-secondary-foreground">{{ $visaRequirement->processing_time_days ?? '-' }} {{ $visaRequirement->processing_time_days ? __('main.days') : '' }}</p>
                        </div>
                        <div>
