...
@section('content')
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('visa-requirements.store') }}" method="POST">
            @csrf
            ...
            <div class="grid gap-4 lg:gap-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="">
                                ...
                                <select name="visa_type" id="visa_type" class="kt-select basic-single" required>
                                    <option value="none_required" {{ old('visa_type') == 'none_required' ? 'selected' : '' }}>{{ __('main.none_required') }}</option>
                                    ...
                                    <option value="embassy_required" {{ old('visa_type') == 'embassy_required' ? 'selected' : '' }}>{{ __('main.embassy_required') }}</option>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            ...
                            <div class="">
                                ...
                                <input type="number" step="0.01" min="0" name="visa_fee" id="visa_fee" class="kt-input h-[45px]" value="{{ old('visa_fee', 0) }}">
                                @error('visa_fee')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="number" min="0" name="max_stay_days" id="max_stay_days" class="kt-input h-[45px]" value="{{ old('max_stay_days', 30) }}">
                                @error('max_stay_days')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="number" min="0" name="visa_validity_days" id="visa_validity_days" class="kt-input h-[45px]" value="{{ old('visa_validity_days', 30) }}">
                            ...
                            <div class="">
                                ...
                                <input type="number" step="0.01" min="0" name="departure_tax" id="departure_tax" class="kt-input h-[45px]" value="{{ old('departure_tax', 0) }}">
                                @error('departure_tax')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="">
                                ...
                                <input type="number" min="0" name="processing_time_days" id="processing_time_days" class="kt-input h-[45px]" value="{{ old('processing_time_days', 0) }}">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div class="">
                                ...
                                <input type="url" name="application_url" id="application_url" class="kt-input h-[45px]" value="{{ old('application_url') }}" placeholder="https://...">
                            ...
                            <div class="">
                                ...
                                <input type="url" name="official_source_url" id="official_source_url" class="kt-input h-[45px]" value="{{ old('official_source_url') }}"
                                    placeholder="https://...">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div class="">
                                ...
                                <input type="date" name="effective_until" id="effective_until" class="kt-input h-[45px]" value="{{ old('effective_until') }}">
                ...
                <!-- Save Submit -->
                @include('components.elements.save-submit', ['models' => 'visa-requirements'])
            </div>
        </form>
    </div>
@endsection
