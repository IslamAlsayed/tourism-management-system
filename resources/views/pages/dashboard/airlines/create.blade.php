                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="elevation" id="elevation" class="kt-input h-[45px]" value="{{ old('elevation') }}" step="0.01"
                                    placeholder="meters">
                                @error('elevation')
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="iata_code" id="iata_code" maxlength="3" class="kt-input h-[45px]" value="{{ old('iata_code') }}"
                                    placeholder="e.g., SV">
                                @error('iata_code')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="icao_code" id="icao_code" maxlength="4" class="kt-input h-[45px]" value="{{ old('icao_code') }}"
                                    placeholder="e.g., SVA">
                                @error('icao_code')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="parent_airline_icao_code" id="parent_airline_icao_code" maxlength="4" class="kt-input h-[45px]"
                                    value="{{ old('parent_airline_icao_code') }}" placeholder="e.g., SVX">
                            ...
                            <div>
                                ...
                                <input type="text" name="frequent_flyer_program_name" id="frequent_flyer_program_name" class="kt-input h-[45px]"
                                    value="{{ old('frequent_flyer_program_name') }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="airline_type_code" id="airline_type_code" class="kt-input h-[45px]"
                                    value="{{ old('airline_type_code') }}" placeholder="FSC, LCC, REG">
                            ...
                            <div>
                                ...
                                <input type="text" name="airline_home_country" id="airline_home_country" class="kt-input h-[45px]"
                                    value="{{ old('airline_home_country') }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="airline_home_country_alpha_2_code" id="airline_home_country_alpha_2_code" maxlength="2"
                                    class="kt-input h-[45px]" value="{{ old('airline_home_country_alpha_2_code') }}" placeholder="SA">
                            ...
                            <div>
                                ...
                                <input type="text" name="airline_home_country_alpha_3_code" id="airline_home_country_alpha_3_code" maxlength="3"
                                    class="kt-input h-[45px]" value="{{ old('airline_home_country_alpha_3_code') }}" placeholder="SAU">
                            ...
                            <div>
                                ...
                                <input type="text" name="airline_home_city_iata_code" id="airline_home_city_iata_code" maxlength="3"
                                    class="kt-input h-[45px]" value="{{ old('airline_home_city_iata_code') }}" placeholder="RUH">
                            ...
                            <div>
                                ...
                                <input type="number" name="year_of_foundation" id="year_of_foundation" class="kt-input h-[45px]"
                                    value="{{ old('year_of_foundation') }}" min="1900" max="{{ date('Y') }}">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="international_phone_number" id="international_phone_number" class="kt-input h-[45px]"
                                    value="{{ old('international_phone_number') }}">
