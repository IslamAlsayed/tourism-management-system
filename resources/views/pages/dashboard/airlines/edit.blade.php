                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="parent_airline_icao_code" id="parent_airline_icao_code" maxlength="4" class="kt-input h-[45px]"
                                    value="{{ $airline->parent_airline_icao_code }}" placeholder="e.g., SVX">
                            ...
                            <div>
                                ...
                                <input type="text" name="marketing_name" id="marketing_name" class="kt-input h-[45px]" value="{{ $airline->marketing_name }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="alliance" id="alliance" class="kt-input h-[45px]" value="{{ $airline->alliance }}">
                                @error('alliance')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="frequent_flyer_program_name" id="frequent_flyer_program_name" class="kt-input h-[45px]"
                                    value="{{ $airline->frequent_flyer_program_name }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="airline_type" id="airline_type" class="kt-input h-[45px]" value="{{ $airline->airline_type }}"
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" class="kt-input h-[45px]" value="{{ $airline->email }}">
                                @error('email')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="url" name="website" id="website" class="kt-input h-[45px]" value="{{ $airline->website }}">
                                @error('website')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
