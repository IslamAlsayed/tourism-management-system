                        ...
                        <div class="grid lg:grid-cols-2 gap-6 items-end mb-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="icao" id="icao" maxlength="4" class="kt-input h-[45px]"
                                    value="{{ $airline->icao }}" placeholder="e.g., OERK">
                                @error('icao')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="iata" id="iata" maxlength="3" class="kt-input h-[45px]"
                                    value="{{ $airline->iata }}" placeholder="e.g., RUH">
                                @error('iata')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="lid" id="lid" maxlength="10" class="kt-input h-[45px]"
                                    value="{{ $airline->lid }}" placeholder="Local Identifier">
                                @error('lid')
                                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select name="subd" id="subd" class="kt-input basic-single">
                                    ...
                                    <option value="International"
                                        {{ $airline->subd == 'International' ? 'selected' : '' }}>
