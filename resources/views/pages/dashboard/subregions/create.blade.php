...
@section('title', __('main.add_new_type', ['type' => __('main.subregion')]))
        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            <div class="flex flex-col justify-center gap-2">
                <h1 class="text-xl font-medium leading-none text-mono">
                    {{ __('main.add_type', ['type' => __('main.subregion')]) }}
                </h1>
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    {{ __('main.add_type_description', ['type' => __('main.subregion')]) }}
                </div>
            </div>
                    ...
                    <form method="POST" action="{{ route('subregions.store') }}" class="space-y-6 p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 items-end mb-4">
                            ...
                            <div class="">
                                ...
                                <select name="region_id" id="region_id" class="kt-input h-[45px]">
                                    <option value="">{{ __('main.select_type', ['type' => __('main.region')]) }}
                                    </option>
                        ...
                        <div class="flex items-center gap-4">
                            <button type="submit" class="kt-btn kt-btn-primary">
                                ...
                                {{ __('main.save_type', ['type' => __('main.subregion')]) }}
                            </button>
