                    ...
                    <form class="space-y-6 p-4">
                        ...
                        <div class="text-center">
                            <div class="relative inline-block">
                                <div class="w-24 h-24 rounded-full bg-secondary-light border-4 border-white shadow-lg mx-auto mb-4 overflow-hidden">
                                    <img id="site-preview" src="{{ asset('metronic/media/avatars/300-6.png') }}" alt="Tourist Site Image" class="w-full h-full object-cover">
                                </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" class="kt-input" placeholder="Enter site name" required value="Al-Ula Heritage Site">
                            </div>

                            <!-- Site Name Arabic -->
                            <div class="mb-4">
                                <label for="name_ar" class="kt-label required mb-2">Site Name (Arabic)</label>
                                <input type="text" name="name_ar" id="name_ar" class="kt-input" placeholder="أدخل اسم الموقع" required value="موقع العلا التراثي">
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="city" id="city" class="kt-input" placeholder="Enter city name" required value="Al-Ula">
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="address" id="address" rows="3" class="kt-input" placeholder="Enter full address">Al-Ula Heritage Site, Al-Ula 43512, Saudi Arabia</textarea>
                            </div>

                            <!-- Description -->
                            <div class="mb-4">
                                <label for="description" class="kt-label mb-2">Description</label>
                                <textarea name="description" id="description" rows="3" class="kt-input" placeholder="Enter site description">Ancient Nabatean city with rock-cut tombs and archaeological wonders dating back thousands of years.</textarea>
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-3 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="tel" name="phone" id="phone" class="kt-input" placeholder="+966 11 123 4567" value="+966 14 884 4444">
                            </div>

                            <!-- Email -->
                            <div class="mb-4">
                                <label for="email" class="kt-label mb-2">Email</label>
                                <input type="email" name="email" id="email" class="kt-input" placeholder="info@site.com" value="info@experiencealula.com">
                            </div>

                            <!-- Website -->
                            <div class="mb-4">
                                <label for="website" class="kt-label mb-2">Website</label>
                                <input type="url" name="website" id="website" class="kt-input" placeholder="www.site.com" value="www.experiencealula.com">
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="entrance_fee" id="entrance_fee" class="kt-input" placeholder="e.g., 50 SAR, Free" value="150 SAR">
                            </div>

                            <!-- Opening Hours -->
                            <div class="mb-4">
                                <label for="opening_hours" class="kt-label mb-2">Opening Hours</label>
                                <input type="text" name="opening_hours" id="opening_hours" class="kt-input" placeholder="e.g., 8:00 AM - 6:00 PM, 24/7" value="8:00 AM - 6:00 PM">
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="best_time" id="best_time" class="kt-input" placeholder="e.g., Early morning, Evening" value="Early morning or late afternoon">
                            </div>

                            <!-- Duration -->
                            <div class="mb-4">
                                <label for="duration" class="kt-label mb-2">Recommended Duration</label>
                                <input type="text" name="duration" id="duration" class="kt-input" placeholder="e.g., 2-3 hours, Full day" value="3-4 hours">
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="coordinates" id="coordinates" class="kt-input" placeholder="e.g., 24.7136° N, 46.6753° E" value="26.6089° N, 37.9128° E">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="facilities[]" id="gift_shop" class="kt-checkbox" value="gift_shop" checked>
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="facilities[]" id="guided_tours" class="kt-checkbox" value="guided_tours" checked>
                                    <label for="guided_tours" class="kt-label mb-0">Guided Tours</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="facilities[]" id="audio_guide" class="kt-checkbox" value="audio_guide" checked>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="activities[]" id="photography" class="kt-checkbox" value="photography" checked>
                                    <label for="photography" class="kt-label mb-0">Photography</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="activities[]" id="hiking" class="kt-checkbox" value="hiking" checked>
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="activities[]" id="shopping" class="kt-checkbox" value="shopping" checked>
                                    <label for="shopping" class="kt-label mb-0">Shopping</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="activities[]" id="dining" class="kt-checkbox" value="dining" checked>
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="activities[]" id="education" class="kt-checkbox" value="education" checked>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" id="notes" rows="4" class="kt-input" placeholder="Enter any additional notes about the tourist site">UNESCO World Heritage site with ongoing archaeological discoveries. Best visited during cooler months.</textarea>
                        </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Regularly update opening hours, fees, and special events</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Update photos to reflect seasonal changes and improvements</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Track visitor feedback to improve the tourist experience</div>
                            </div>
                        </div>
                    </div>
                </div>
