                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 mb-4">
                            <div>
                                ...
                                <input type="number" step="0.00000001" min="-90" max="90" name="latitude" id="latitude" class="kt-input h-[45px]" value="{{ $touristSite->latitude }}">
                            </div>
                            <div>
                                <label for="longitude" class="kt-label">{{ __('main.longitude') }}</label>
                                <input type="number" step="0.00000001" min="-180" max="180" name="longitude" id="longitude" class="kt-input h-[45px]" value="{{ $touristSite->longitude }}">
                            </div>
                            <div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="text" list="categoriesList" name="category" id="category" class="kt-input h-[45px]" value="{{ $touristSite->category }}">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="text" name="supplier_name" id="supplier_name" class="kt-input h-[45px]" value="{{ $touristSite->supplier_name }}">
                            </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="entry_feesCheckBox {{ $touristSite->is_free_entry == 1 ? 'disabled' : '' }}">
                                ...
                                <input type="number" step="0.01" min="0" name="entry_fee_foreigner_adult" id="entry_fee_foreigner_adult" class="kt-input h-[45px]"
                                    value="{{ $touristSite->entry_fee_foreigner_adult }}">
                            </div>
                            <div class="entry_feesCheckBox {{ $touristSite->is_free_entry == 1 ? 'disabled' : '' }}">
                                ...
                                <input type="number" step="0.01" min="0" name="entry_fee_foreigner_child" id="entry_fee_foreigner_child" class="kt-input h-[45px]"
                                    value="{{ $touristSite->entry_fee_foreigner_child }}">
                            </div>
                            <div class="entry_feesCheckBox {{ $touristSite->is_free_entry == 1 ? 'disabled' : '' }}">
                                ...
                                <input type="number" step="0.01" min="0" name="entry_fee_arab_adult" id="entry_fee_arab_adult" class="kt-input h-[45px]"
                                    value="{{ $touristSite->entry_fee_arab_adult }}">
                            </div>
                            <div class="entry_feesCheckBox {{ $touristSite->is_free_entry == 1 ? 'disabled' : '' }}">
                                ...
                                <input type="number" step="0.01" min="0" name="entry_fee_arab_child" id="entry_fee_arab_child" class="kt-input h-[45px]"
                                    value="{{ $touristSite->entry_fee_arab_child }}">
                            </div>
                            <div class="entry_feesCheckBox {{ $touristSite->is_free_entry == 1 ? 'disabled' : '' }}">
                                ...
                                <input type="number" step="0.01" min="0" name="entry_fee_local_adult" id="entry_fee_local_adult" class="kt-input h-[45px]"
                                    value="{{ $touristSite->entry_fee_local_adult }}">
                            </div>
                            <div class="entry_feesCheckBox {{ $touristSite->is_free_entry == 1 ? 'disabled' : '' }}">
                                ...
                                <input type="number" step="0.01" min="0" name="entry_fee_local_child" id="entry_fee_local_child" class="kt-input h-[45px]"
                                    value="{{ $touristSite->entry_fee_local_child }}">
                            </div>
                            <div class="entry_feesCheckBox {{ $touristSite->is_free_entry == 1 ? 'disabled' : '' }}">
                                ...
                                <input type="number" step="0.01" min="0" name="entry_fee_resident_adult" id="entry_fee_resident_adult" class="kt-input h-[45px]"
                                    value="{{ $touristSite->entry_fee_resident_adult }}">
                            </div>
                            <div class="entry_feesCheckBox {{ $touristSite->is_free_entry == 1 ? 'disabled' : '' }}">
                                ...
                                <input type="number" step="0.01" min="0" name="entry_fee_resident_child" id="entry_fee_resident_child" class="kt-input h-[45px]"
                                    value="{{ $touristSite->entry_fee_resident_child }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="contact_person" id="contact_person" class="kt-input h-[45px]" value="{{ $touristSite->contact_person }}">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="url" name="facebook_url" id="facebook_url" class="kt-input h-[45px]" value="{{ $touristSite->facebook_url }}">
                            </div>
                            <div>
                                <label for="instagram_url" class="kt-label">{{ __('main.instagram_url') }}</label>
                                <input type="url" name="instagram_url" id="instagram_url" class="kt-input h-[45px]" value="{{ $touristSite->instagram_url }}">
                            </div>
                            <div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" name="club_car_price" id="club_car_price" class="kt-input h-[45px]" value="{{ $touristSite->club_car_price }}">
                            </div>
                            <div class="flex items-center gap-4">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" min="0" name="total_reviews" id="total_reviews" class="kt-input h-[45px]" value="{{ $touristSite->total_reviews }}">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="difficulty_level" id="difficulty_level" class="kt-select basic-single">
                                    ...
                                    @foreach ($difficulty_level as $level)
                                        <option value="{{ $level }}" {{ $touristSite->difficulty_level == $level ? 'selected' : '' }}>{{ $level }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="status" id="status" class="kt-select basic-single">
                                    ...
                                    @foreach ($status as $stat)
                                        <option value="{{ $stat }}" {{ $touristSite->status == $stat ? 'selected' : '' }}>{{ $stat }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
