                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 mb-4">
                            <div>
                                ...
                                <input type="number" step="0.00000001" min="-90" max="90" name="latitude" id="latitude" class="kt-input h-[45px]" value="{{ old('latitude') }}"
                                    placeholder="-90 to 90">
                            </div>
                            <div>
                                <label for="longitude" class="kt-label">{{ __('main.longitude') }}</label>
                                <input type="number" step="0.00000001" min="-180" max="180" name="longitude" id="longitude" class="kt-input h-[45px]" value="{{ old('longitude') }}"
                                    placeholder="-180 to 180">
                            </div>
                            <div>
                                <label for="postal_code" class="kt-label">{{ __('main.postal_code') }}</label>
                                <input type="text" name="postal_code" id="postal_code" class="kt-input h-[45px]" value="{{ old('postal_code') }}" placeholder="Postal code">
                            </div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="text" name="name" id="name" class="kt-input h-[45px]" required value="{{ old('name') }}" placeholder="Enter site name">
                            </div>
                            <div class="align-self-end">
                                <label for="name_ar" class="kt-label">{{ __('main.name_ar') }}</label>
                                <input type="text" name="name_ar" id="name_ar" class="kt-input h-[45px]" value="{{ old('name_ar') }}" placeholder="الاسم بالعربية">
                            </div>
                            <div class="align-self-end">
                                <label for="site_type" class="kt-label">{{ __('main.site_type') }}</label>
                                <input type="text" name="site_type" id="site_type" class="kt-input h-[45px]" value="{{ old('site_type') }}" placeholder="e.g., Museum, Park, Historical Site">
                            </div>
                            <div class="align-self-end">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="text" name="sites_theme" id="sites_theme" class="kt-input h-[45px]" value="{{ old('sites_theme') }}" placeholder="Theme category">
                            </div>
                            <div class="align-self-end">
                                <label for="supplier_name" class="kt-label">{{ __('main.supplier_name') }}</label>
                                <input type="text" name="supplier_name" id="supplier_name" class="kt-input h-[45px]" value="{{ old('supplier_name') }}" placeholder="Supplier name">
                            </div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="entry_feesCheckBox">
                                ...
                                <input type="number" step="0.01" min="0" name="entry_fee_adult" id="entry_fee_adult" class="kt-input h-[45px]" value="{{ old('entry_fee_adult') }}">
                            </div>
                            <div class="entry_feesCheckBox">
                                <label for="entry_fee_child" class="kt-label">{{ __('main.entry_fee_child') }}</label>
                                <input type="number" step="0.01" min="0" name="entry_fee_child" id="entry_fee_child" class="kt-input h-[45px]" value="{{ old('entry_fee_child') }}">
                            </div>
                            <div class="entry_feesCheckBox">
                            ...
                            <div class="entry_feesCheckBox">
                                ...
                                <input type="number" step="0.01" min="0" name="entry_fee_senior" id="entry_fee_senior" class="kt-input h-[45px]" value="{{ old('entry_fee_senior') }}">
                            </div>
                            <div class="entry_feesCheckBox">
                                <label for="entry_fee_group" class="kt-label">{{ __('main.entry_fee_group') }}</label>
                                <input type="number" step="0.01" min="0" name="entry_fee_group" id="entry_fee_group" class="kt-input h-[45px]" value="{{ old('entry_fee_group') }}">
                            </div>
                            <div class="entry_feesCheckBox">
                                <label for="entry_fee_foreigner_adult" class="kt-label">{{ __('main.entry_fee_foreigner_adult') }}</label>
                                <input type="number" step="0.01" min="0" name="entry_fee_foreigner_adult" id="entry_fee_foreigner_adult" class="kt-input h-[45px]"
                                    value="{{ old('entry_fee_foreigner_adult') }}">
                            </div>
                            <div class="entry_feesCheckBox">
                                <label for="entry_fee_foreigner_child" class="kt-label">{{ __('main.entry_fee_foreigner_child') }}</label>
                                <input type="number" step="0.01" min="0" name="entry_fee_foreigner_child" id="entry_fee_foreigner_child" class="kt-input h-[45px]"
                                    value="{{ old('entry_fee_foreigner_child') }}">
                            </div>
                            <div class="entry_feesCheckBox">
                                <label for="entry_fee_arab_adult" class="kt-label">{{ __('main.entry_fee_arab_adult') }}</label>
                                <input type="number" step="0.01" min="0" name="entry_fee_arab_adult" id="entry_fee_arab_adult" class="kt-input h-[45px]"
                                    value="{{ old('entry_fee_arab_adult') }}">
                            </div>
                            <div class="entry_feesCheckBox">
                                <label for="entry_fee_arab_child" class="kt-label">{{ __('main.entry_fee_arab_child') }}</label>
                                <input type="number" step="0.01" min="0" name="entry_fee_arab_child" id="entry_fee_arab_child" class="kt-input h-[45px]"
                                    value="{{ old('entry_fee_arab_child') }}">
                            </div>
                            <div class="entry_feesCheckBox">
                                <label for="entry_fee_local_adult" class="kt-label">{{ __('main.entry_fee_local_adult') }}</label>
                                <input type="number" step="0.01" min="0" name="entry_fee_local_adult" id="entry_fee_local_adult" class="kt-input h-[45px]"
                                    value="{{ old('entry_fee_local_adult') }}">
                            </div>
                            <div class="entry_feesCheckBox">
                                <label for="entry_fee_local_child" class="kt-label">{{ __('main.entry_fee_local_child') }}</label>
                                <input type="number" step="0.01" min="0" name="entry_fee_local_child" id="entry_fee_local_child" class="kt-input h-[45px]"
                                    value="{{ old('entry_fee_local_child') }}">
                            </div>
                            <div class="entry_feesCheckBox">
                                <label for="entry_fee_resident_adult" class="kt-label">{{ __('main.entry_fee_resident_adult') }}</label>
                                <input type="number" step="0.01" min="0" name="entry_fee_resident_adult" id="entry_fee_resident_adult" class="kt-input h-[45px]"
                                    value="{{ old('entry_fee_resident_adult') }}">
                            </div>
                            <div class="entry_feesCheckBox">
                                <label for="entry_fee_resident_child" class="kt-label">{{ __('main.entry_fee_resident_child') }}</label>
                                <input type="number" step="0.01" min="0" name="entry_fee_resident_child" id="entry_fee_resident_child" class="kt-input h-[45px]"
                                    value="{{ old('entry_fee_resident_child') }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="col-span-full">
                                ...
                                <textarea name="special_hours" id="special_hours" class="kt-input h-[120px]" placeholder='JSON format: {"friday":{"opening":"09:00","closing":"18:00"}}'>{{ old('special_hours') }}</textarea>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="tel" name="phone" id="phone" class="kt-input h-[45px]" value="{{ old('phone') }}" placeholder="Phone number">
                            </div>
                            <div>
                                <label for="mobile" class="kt-label">{{ __('main.mobile') }}</label>
                                <input type="tel" name="mobile" id="mobile" class="kt-input h-[45px]" value="{{ old('mobile') }}" placeholder="Mobile number">
                            </div>
                            <div>
                                <label for="email" class="kt-label">{{ __('main.email') }}</label>
                                <input type="email" name="email" id="email" class="kt-input h-[45px]" value="{{ old('email') }}" placeholder="Email address">
                            </div>
                            <div>
                                <label for="fax" class="kt-label">{{ __('main.fax') }}</label>
                                <input type="tel" name="fax" id="fax" class="kt-input h-[45px]" value="{{ old('fax') }}" placeholder="Fax number">
                            </div>
                            <div>
                                <label for="contact_person" class="kt-label">{{ __('main.contact_person') }}</label>
                                <input type="text" name="contact_person" id="contact_person" class="kt-input h-[45px]" value="{{ old('contact_person') }}" placeholder="Contact person name">
                            </div>
                            <div>
                                <label for="website_url" class="kt-label">{{ __('main.website_url') }}</label>
                                <input type="url" name="website_url" id="website_url" class="kt-input h-[45px]" value="{{ old('website_url') }}" placeholder="https://example.com">
                            </div>
                            <div>
                                <label for="facebook_url" class="kt-label">{{ __('main.facebook_url') }}</label>
                                <input type="url" name="facebook_url" id="facebook_url" class="kt-input h-[45px]" value="{{ old('facebook_url') }}" placeholder="https://facebook.com/...">
                            </div>
                            <div>
                                <label for="instagram_url" class="kt-label">{{ __('main.instagram_url') }}</label>
                                <input type="url" name="instagram_url" id="instagram_url" class="kt-input h-[45px]" value="{{ old('instagram_url') }}" placeholder="https://instagram.com/...">
                            </div>
                            <div>
                                <label for="twitter_url" class="kt-label">{{ __('main.twitter_url') }}</label>
                                <input type="url" name="twitter_url" id="twitter_url" class="kt-input h-[45px]" value="{{ old('twitter_url') }}" placeholder="https://twitter.com/...">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" name="club_car_price" id="club_car_price" class="kt-input h-[45px]" value="{{ old('club_car_price') }}">
                            </div>
                            <div class="flex items-center gap-4">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" max="5" name="average_rating" id="average_rating" class="kt-input h-[45px]"
                                    value="{{ old('average_rating') }}">
                            </div>
                            <div>
                                <label for="total_reviews" class="kt-label">{{ __('main.total_reviews') }}</label>
                                <input type="number" min="0" name="total_reviews" id="total_reviews" class="kt-input h-[45px]" value="{{ old('total_reviews') }}">
                            </div>
                            <div>
                                <label for="popularity_score" class="kt-label">{{ __('main.popularity_score') }}</label>
                                <input type="number" min="0" max="100" name="popularity_score" id="popularity_score" class="kt-input h-[45px]" value="{{ old('popularity_score') }}">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="difficulty_level" id="difficulty_level" class="kt-select basic-single">
                                    ...
                                    @foreach ($difficulty_level as $level)
                                        <option value="{{ $level }}" {{ old('difficulty_level') == $level ? 'selected' : '' }}>{{ $level }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <div class="dropzone mt-2 border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-primary transition-colors cursor-pointer" data-input="photo">
                            ...
                            <div>
                                ...
                                <div class="dropzone mt-2 border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-primary transition-colors cursor-pointer" data-input="gallery">
                                    <i class="far fa-cloud-arrow-up text-5xl text-gray-600"></i>
                            ...
                            <div>
                                ...
                                <input type="url" name="video_url" id="video_url" class="kt-input h-[45px]" value="{{ old('video_url') }}" placeholder="https://youtube.com/...">
                            </div>
                            <div>
                                <label for="virtual_tour_url" class="kt-label">{{ __('main.virtual_tour_url') }}</label>
                                <input type="url" name="virtual_tour_url" id="virtual_tour_url" class="kt-input h-[45px]" value="{{ old('virtual_tour_url') }}"
