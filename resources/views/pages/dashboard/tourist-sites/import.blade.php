        ...
        @if (env('DB_MODE') != 'production')
            ...
            <div class="overflow-x-auto">
                <table class="border min-w-full divide-y text-center divide-gray-200 mb-4">
                    ...
                    <tbody>
                        <tr>
                            <td class="border px-2">One of the Seven Wonders of the Ancient World, the Great Pyramid is an iconic symbol of ancient Egyptian civilization.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="border min-w-full divide-y text-center divide-gray-200 mb-4">
                    ...
                    <tbody>
                        <tr>
                            <td class="border px-2">Built during the reign of Pharaoh Khufu, it stands at 146.5 meters tall and was built with approximately 2.3 million limestone blocks.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
