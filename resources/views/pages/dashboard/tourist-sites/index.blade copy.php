...
'title' => __('main.tourist_sites'),
'description' => __('main.manage_system_types', ['types' => __('main.tourist_sites')]),
'page_create_url' => route('tourist-sites.create'),
'page_create_title' => __('main.create_type', ['type' => __('main.tourist_site')]),
])
<!-- End of Container -->
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <div class="d-flex align-items-center">
                @for ($i = 1; $i <= 5; $i++) <i class="ki-filled ki-star text-{{ $i <= $site['rating'] ? 'warning' : 'muted' }} fs-7"></i>
                    @endfor
