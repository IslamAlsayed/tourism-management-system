                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="text" name="street" id="street" class="kt-input h-[45px]" value="{{ old('street') }}" placeholder="Enter street address">
                                @error('street')
                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div class="grid lg:grid-cols-3 gap-6 mb-4">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="text" name="classification" id="classification" class="kt-input h-[45px]" value="{{ old('classification') }}" placeholder="e.g., 5 Stars, Luxury">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid lg:grid-cols-2 gap-6 items-end mb-4">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="tel" name="general_mobile" id="general_mobile" class="kt-input h-[45px]" value="{{ old('general_mobile') }}" placeholder="+1234567890">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="email" name="general_email" id="general_email" class="kt-input h-[45px]" value="{{ old('general_email') }}" placeholder="info@accommodation.com">
                                @error('general_email')
                                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6 items-end mb-4">
                            ...
                            <div class="align-self-end">
                                ...
                                <input type="url" name="website" id="website" class="kt-input h-[45px]" value="{{ old('website') }}" placeholder="https://www.accommodation.com">
                                @error('website')
                                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="border-t pt-4 mt-4">
                            ...
                            <div class="grid lg:grid-cols-2 gap-6 items-end mb-4">
                                <div class="align-self-end">
                                    ...
                                    <input type="text" name="contact_person" id="contact_person" class="kt-input h-[45px]" value="{{ old('contact_person') }}" placeholder="John Doe">
                                ...
                                <div class="align-self-end">
                                    ...
                                    <input type="text" name="contact_position" id="contact_position" class="kt-input h-[45px]" value="{{ old('contact_position') }}" placeholder="Manager">
                            ...
                            <div class="grid lg:grid-cols-2 gap-6">
                                <div class="align-self-end">
                                    ...
                                    <input type="tel" name="contact_mobile" id="contact_mobile" class="kt-input h-[45px]" value="{{ old('contact_mobile') }}" placeholder="+1234567890">
