                    ...
                    <form class="space-y-6 p-4">
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" class="kt-input" placeholder="Enter accommodation name" required>
                            </div>

                            <!-- Name Arabic -->
                            <div class="mb-4">
                                <label for="name_ar" class="kt-label required mb-2">Name (Arabic)</label>
                                <input type="text" name="name_ar" id="name_ar" class="kt-input" placeholder="أدخل اسم الإقامة" required>
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" rows="3" class="kt-input" placeholder="Enter accommodation description"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-3 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email" name="email" id="email" class="kt-input" placeholder="info@accommodation.com">
                            </div>

                            <!-- Website -->
                            <div class="mb-4">
                                <label for="website" class="kt-label mb-2">Website</label>
                                <input type="url" name="website" id="website" class="kt-input" placeholder="www.accommodation.com">
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="rooms" id="rooms" class="kt-input" placeholder="Enter number of rooms" required>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="facilities[]" id="pool" class="kt-checkbox" value="pool">
                                    <label for="pool" class="kt-label mb-0">Swimming Pool</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="facilities[]" id="gym" class="kt-checkbox" value="gym">
                                    <label for="gym" class="kt-label mb-0">Gym</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="facilities[]" id="restaurant" class="kt-checkbox" value="restaurant">
                                    <label for="restaurant" class="kt-label mb-0">Restaurant</label>
                                </div>
                                <div class="flex items-center gap-3">
                                    <input type="checkbox" name="facilities[]" id="spa" class="kt-checkbox" value="spa">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Provide detailed information to help guests make informed decisions</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Upload clear, high-resolution photos of your accommodation</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-secondary-foreground">Select the appropriate star rating based on your facilities and services</div>
                            </div>
                        </div>
                    </div>
                </div>
