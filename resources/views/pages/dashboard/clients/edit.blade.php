                ...
                <div class="kt-card-body p-4">
                    <form class="space-y-6" method="POST" action="{{ route('clients.update', $client->id) }}"
                        ...
                        @include('components.input-image', [
                            'modelKey' => $client->name ?? 'C',
                            'column' => 'client',
                            'columnName' => 'photo',
                            'photoUrl' => $client->photo ? asset('storage/' . $client->photo) : '',
                        ])
                        ...
                        <div class="grid lg:grid-cols-2 gap-6 mb-4">
                            <div class="">
                                ...
                                <select name="client_type" id="client_type" class="kt-input h-[45px]" required>
                                    ...
                                    <option value="individual" {{ $client->client_type == 'individual' ? 'selected' : '' }}>
                                        {{ __('main.individual') }}
                                    </option>
                                    <option value="corporate" {{ $client->client_type == 'corporate' ? 'selected' : '' }}>
                                        {{ __('main.corporate') }}
                                    </option>
                                </select>
                                @error('client_type')
                            ...
                            <div class="">
                                ...
                                <select name="client_status" id="client_status" class="kt-input h-[45px]" required>
                                    ...
                                    <option value="blacklisted"
                                        {{ $client->client_status == 'blacklisted' ? 'selected' : '' }}>
                                        {{ __('main.blacklisted') }}
                                    </option>
                                </select>
                                @error('client_status')
                        ...
                        <div class="kt-card mb-4" id="company-info" style="display: none;">
                            ...
                            <div class="kt-card-body p-4">
                                <div class="grid lg:grid-cols-2 gap-6 mb-4">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="text" name="company_name" id="company_name"
                                            class="kt-input h-[45px]" value="{{ $client->company_name }}">
                                        @error('company_name')
                                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="">
                                        ...
                                        <input type="email" name="company_email" id="company_email"
                                            class="kt-input h-[45px]" value="{{ $client->company_email }}">
                                        @error('company_email')
                                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="grid lg:grid-cols-3 gap-6 mb-4">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="text" name="tax_number" id="tax_number"
                                            class="kt-input h-[45px]" value="{{ $client->tax_number }}">
                                        @error('tax_number')
                                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="">
                                        ...
                                        <input type="text" name="commercial_registration" id="commercial_registration"
                                            class="kt-input h-[45px]" value="{{ $client->commercial_registration }}">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="text" name="company_phone" id="company_phone"
                                            class="kt-input h-[45px]" value="{{ $client->company_phone }}">
                                        @error('company_phone')
                                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="">
                                    ...
                                    <textarea name="company_address" id="company_address" class="kt-input" rows="2">{{ $client->company_address }}</textarea>
                                ...
                                <div class="grid lg:grid-cols-3 gap-6">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="text" name="passport_number" id="passport_number"
                                            class="kt-input h-[45px]" value="{{ $client->passport_number }}">
                                ...
                                <div class="grid lg:grid-cols-2 gap-6 mt-4">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="date" name="birth_date" id="birth_date"
                                            class="kt-input h-[45px]" value="{{ $client->birth_date }}">
                                        @error('birth_date')
                                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="kt-card-body p-4">
                                ...
                                <div class="grid lg:grid-cols-2 gap-6 mb-4">
                                    <div class="">
                                        ...
                                        <select name="preferred_language" id="preferred_language"
                                            ...
                                            <option value="en"
                                                {{ $client->preferred_language == 'en' ? 'selected' : '' }}>
                                                {{ __('main.english') }}
                                            </option>
                                            <option value="ar"
                                                {{ $client->preferred_language == 'ar' ? 'selected' : '' }}>
                                                {{ __('main.arabic') }}
                                            </option>
                                        </select>
                                ...
                                <div class="grid lg:grid-cols-2 gap-6 mb-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <input type="checkbox" name="is_active" id="is_active" class="kt-checkbox"
                                            value="1" {{ $client->is_active ?? '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <input type="checkbox" name="is_verified" id="is_verified" class="kt-checkbox"
                                            value="1" {{ $client->is_verified ? 'checked' : '' }}>
                                ...
                                <div class="flex items-center gap-4 pt-4">
                                    <button type="submit" class="kt-btn kt-btn-primary">
                                        ...
                                        {{ __('main.update_type', ['type' => __('main.client')]) }}
                                    </button>
                                    <a href="{{ route('clients.index') }}" class="kt-btn kt-btn-outline">
                                        {{ __('main.cancel') }}
                                    </a>
