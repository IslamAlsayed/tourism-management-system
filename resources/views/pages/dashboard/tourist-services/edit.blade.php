...
@section('content')
    ...
    <div class="kt-container-fixed">
        <form action="{{ route('tourist-services.update', $touristService->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="grid gap-6 lg:gap-4">
                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 border-custom-b pb-6">
                            <div>
                                ...
                                <input type="text" name="name" class="kt-input h-[42px] font-medium" value="{{ $touristService->name }}">
                            </div>
                            <div>
                                <label class="kt-label font-bold text-sm mb-1">
                                    {{ __('main.service_name_ar') }}
                                </label>
                                <input type="text" name="name_ar" class="kt-input h-[42px] font-medium" value="{{ $touristService->name_ar }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            <div
                                ...
                                <h4 class="flex items-center gap-2 font-bold text-sm uppercase mb-6 text-slate-700 tracking-wide border-custom-b pb-3">
                                ...
                                <!-- 4 Items in One Row -->
                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 items-end gap-4 mb-4 border-custom-b pb-6">
                                    <!-- Currency -->
                                    @include('components.selects.currency', ['record' => $touristService])

                                    <!-- Pricing Unit -->
                                    <div class="relative group">
                                        <label class="text-xs font-bold text-gray-600 uppercase mb-2 block flex items-center gap-1">
                                        ...
                                        <div class="relative">
                                            <select name="pricing_unit" id="pricing_unit"
                                                ...
                                                <option value="person" {{ $touristService->pricing_unit == 'person' ? 'selected' : '' }}>
                                                    {{ __('main.per_person') }}</option>
                                                <option value="group" {{ $touristService->pricing_unit == 'group' ? 'selected' : '' }}>{{ __('main.per_group') }}
                                                </option>
                                                <option value="bus" {{ $touristService->pricing_unit == 'bus' ? 'selected' : '' }}>Per Vehicle</option>
                                                <option value="meal" {{ $touristService->pricing_unit == 'meal' ? 'selected' : '' }}>Per Meal</option>
                                                <option value="trip" {{ $touristService->pricing_unit == 'trip' ? 'selected' : '' }}>{{ __('main.per_trip') }}
                                                </option>
                                                <option value="person_day" {{ $touristService->pricing_unit == 'person_day' ? 'selected' : '' }}>
                                                    {{ __('main.per_person_per_day') }}</option>
                                                <option value="group_day" {{ $touristService->pricing_unit == 'group_day' ? 'selected' : '' }}>
                                                    {{ __('main.per_group_per_day') }}</option>
                                                <option value="person_night" {{ $touristService->pricing_unit == 'person_night' ? 'selected' : '' }}>
                                                    {{ __('main.per_person_per_night') }}</option>
                                                <option value="group_night" {{ $touristService->pricing_unit == 'group_night' ? 'selected' : '' }}>
                                                    {{ __('main.per_group_per_night') }}</option>
                                                <option value="day" {{ $touristService->pricing_unit == 'day' ? 'selected' : '' }}>{{ __('main.per_day') }}
                                                </option>
                                                <option value="night" {{ $touristService->pricing_unit == 'night' ? 'selected' : '' }}>{{ __('main.per_night') }}
                                                </option>
                                                <option value="unit" {{ $touristService->pricing_unit == 'unit' ? 'selected' : '' }}>{{ __('main.per_unit') }}
                                                </option>
                                                <option value="extra_hour_person" {{ $touristService->pricing_unit == 'extra_hour_person' ? 'selected' : '' }}>Per
                                                    extra hour per person</option>
                                                <option value="extra_hour_group" {{ $touristService->pricing_unit == 'extra_hour_group' ? 'selected' : '' }}>Per
                                                    extra hour per group</option>
                                                <option value="extra_hour_vehicle" {{ $touristService->pricing_unit == 'extra_hour_vehicle' ? 'selected' : '' }}>
                                                    Per extra hour per vehicle</option>
                                                <option value="child" {{ $touristService->pricing_unit == 'child' ? 'selected' : '' }}>Per Child</option>
                                                <option value="child_day" {{ $touristService->pricing_unit == 'child_day' ? 'selected' : '' }}>Per Child Per Day
                                                </option>
                                                <option value="child_night" {{ $touristService->pricing_unit == 'child_night' ? 'selected' : '' }}>Per Child Per
                                                    Night</option>
                                                <option value="extra_hour_child" {{ $touristService->pricing_unit == 'extra_hour_child' ? 'selected' : '' }}>Per
                                                    extra hour per child</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    @include('components.elements.checkbox-button', [
                                        ...
                                        'id' => 'is_mandatory',
                                        'value' => '1',
                                        'checked' => $touristService->is_mandatory == 1,
                        ...
                        <div class="mb-6">
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 rounded-lg border-custom-1">
                                <div class="flex items-center justify-between mb-3">
                                    <label class="kt-label font-bold text-sm uppercase text-blue-900 flex items-center gap-2">
                                        <i class="ki-filled ki-element-11 text-blue-600"></i>
                                        {{ __('main.target_modules_context') }}
                                        <span class="text-xs font-normal normal-case text-blue-600">({{ __('main.select_one_or_more') }})</span>
                                    </label>
                                    <button type="button" id="toggleAllBtn" onclick="toggleAllModules()" class="kt-btn kt-btn-sm">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-4 gap-2" id="modules_container">
                                    @foreach ($modules ?? [] as $key => $module)
                                        @php
                                            $isSelected = $touristService->modules()->where('module_name', $key)->exists();
                                        @endphp
                                        <label class="module-toggle cursor-pointer">
                                            <input type="checkbox" name="target_modules[]" value="{{ $key }}" class="module-checkbox sr-only"
                                                {{ $isSelected ? 'checked' : '' }} onchange="toggleModuleVisual(this)">
                                            <div
                                                ...
                                                <i class="ki-filled {{ $module['icon'] }} text-lg text-gray-600 peer-checked:text-white"></i>
                        ...
                        <div class="mb-6">
                            <label class="kt-label font-bold text-sm mb-3 block text-gray-700 uppercase tracking-wide">{{ __('main.pricing_model') }}
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <label id="label_flat" class="relative cursor-pointer group">
                                    <input type="radio" name="pricing_type" value="flat" class="peer sr-only"
                                        {{ $touristService->pricing_type === 'flat' ? 'checked' : '' }} onchange="togglePricingMode('flat')">
                                    <div class="p-5 rounded-xl border-custom-1 background transition-all h-full flex flex-col items-center text-center">
                                        <div class="w-12 h-12 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mb-3 transition-colors">
                                            <i class="ki-filled ki-dollar fs-2"></i>
                                        </div>
                                        <h4 class="font-bold text-lg text-gray-600 mb-1 group-hover:text-blue-600 transition-colors">
                                            {{ __('main.flat_rate') }}</h4>
                                        <p class="text-xs text-gray-600 leading-relaxed">
                                            {{ __('main.flat_rate_desc') }}
                                        </p>
                                        <div class="mt-4 opacity-0 transition-opacity">
                                            <span class="inline-flex items-center gap-1 text-xs font-bold text-blue-700 bg-blue-100 px-2 py-1 rounded">
                                ...
                                <label id="label_seasonal" class="relative cursor-pointer group">
                                    <input type="radio" name="pricing_type" value="seasonal" class="peer sr-only"
                                        {{ $touristService->pricing_type === 'seasonal' ? 'checked' : '' }} onchange="togglePricingMode('seasonal')">
                                    <div class="p-5 rounded-xl border-custom-1 background transition-all h-full flex flex-col items-center text-center">
                                        <div class="w-12 h-12 rounded-full bg-green-100 text-green-600 flex items-center justify-center mb-3 transition-colors">
                                            <i class="ki-filled ki-calendar fs-2"></i>
                                        </div>
                                        <h4 class="font-bold text-lg text-gray-600 mb-1 group-hover:text-green-600 transition-colors">
                        ...
                        <div id="flat_pricing_container" class="p-4 bg-gray-50 rounded-lg border-custom border-dashed">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="text-xs font-bold text-gray-600 mb-1 block">{{ __('main.effective_from') }}</label>
                                    <input type="date" name="flat_start_date" class="kt-input h-[40px]"
                                        value="{{ $touristService->seasonalPrices()->where('season_name', 'Standard')->first()?->season_start_date?->format('Y-m-d') ?? '' }}">
                                </div>
                                <div>
                                    <label class="text-xs font-bold text-gray-600 mb-1 block">{{ __('main.effective_until') }}</label>
                                    <input type="date" name="flat_end_date" class="kt-input h-[40px]"
                                        value="{{ $touristService->seasonalPrices()->where('season_name', 'Standard')->first()?->season_end_date?->format('Y-m-d') ?? '' }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="seasonal_pricing_container" class="hidden border-custom rounded-lg p-4 bg-gray-50/50">
                            ...
                            <div class="mt-4">
                                <button type="button" onclick="addSeasonGroup()" class="kt-btn kt-btn-sm kt-btn-primary">
                ...
                <div class="kt-card background border-custom shadow-sm rounded-xl" id="pricing_engine_container">
                    <div class="kt-card-header">
                        <h3 class="kt-card-title flex items-center gap-2 text-lg font-bold text-gray-600 dark:text-white">
                            <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 text-xs font-bold">3</span>
                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div id="generated_pricing_tables" class="space-y-6">
                            ...
                            <div id="flat_rate_table_container">
                                @include('pages.dashboard.tourist-services.services.pricing-table', [
                                    'prefix' => 'seasonal_prices[Standard]',
                                    'seasonName' => 'Standard',
                                    'isStandard' => true,
                                    'nationalities' => $nationalities ?? collect(),
                                    'subregions' => $subregions ?? collect(),
                                    'savedData' => $touristService->seasonal_prices['Standard'] ?? [],
                                ])
                            </div>
                ...
                <div class="kt-card background border-custom shadow-sm rounded-xl">
                    ...
                    <div class="kt-card-body p-4">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    @include('components.elements.checkbox-button', [
                                        ...
                                        'id' => 'yes_inclusive',
                                        'value' => '1',
                                        'checked' => $touristService->is_tax_inclusive == 1,
                        ...
                        <div id="taxes_wrapper" class="border rounded-lg p-4 bg-red-50/10">
                            <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                @if (!empty($touristService->photo))
                                    <div id="existing-photo" class="relative w-fit mt-3">
                                        <img src="{{ asset('storage/' . $touristService->photo) }}" class="h-32 w-32 rounded">
                                        <button type="button"
                            ...
                            <div>
                                ...
                                <div class="mt-4 flex flex-wrap gap-4">
                                    @if (is_array($touristService->gallery))
                                        @foreach ($touristService->gallery as $index => $img)
                            ...
                            <div>
                                ...
                                <input type="url" name="video_url" id="video_url" class="kt-input h-[45px]" value="{{ $touristService->video_url }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    @include('components.elements.checkbox-button', [
                        ...
                        'id' => 'is_active',
                        'value' => '1',
                        'checked' => $touristService->is_active,
    ...
    @include('pages.dashboard.tourist-services.services.pricing-logic')
    @include('pages.dashboard.tourist-services.services.pricing-scripts')
@endsection
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Load saved tax configuration
            const taxConfig = @json($touristService->tax_configuration ?? []);
            if (taxConfig && taxConfig.length > 0) {
                taxConfig.forEach((tax, index) => {
                    ...
                    const html = `
                        <div class="flex flex-row gap-2 items-end tax-row relative background p-3 rounded border border-dashed border-red-200">
                            <div class="flex-1 min-w-0">
                                ...
                                <input type="text" name="tax_configuration[${index}][name]" class="kt-input h-9 w-full" value="${tax.name || ''}">
                            </div>
                            ...
                            <div class="w-1/3 min-w-[150px] flex items-center gap-2">
                                <div class="relative w-full">
                                    ...
                                    <div class="relative w-full">
                                        <input type="number" step="0.01" name="tax_configuration[${index}][value]" class="kt-input h-9 w-full pe-8 font-bold text-gray-700" value="${tax.value || ''}">
                                        <span class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 font-bold text-xs tax-symbol ${tax.type === 'fixed' ? 'currency-symbol' : ''}">${tax.type === 'percentage' ? '%' : currentCurrency}</span>
                                    </div>
                                </div>
            ...
            // Load saved commission configuration
            const commissionConfig = @json($touristService->commission_configuration ?? []);
            if (commissionConfig && commissionConfig.length > 0) {
                commissionConfig.forEach((commission, index) => {
                    ...
                    const html = `
                        <div class="flex flex-row gap-2 items-end commission-row relative background p-3 rounded border border-dashed border-green-200">
                            <div class="flex-1 min-w-0">
                                <label class="text-xs font-bold text-gray-600 mb-1 block">{{ __('main.name') }}</label>
                                <input type="text" name="commission_configuration[${index}][name]" class="kt-input h-9 w-full" value="${commission.name || ''}">
                            </div>
                            <div class="w-1/4 min-w-[140px]">
                                ...
                                <select name="commission_configuration[${index}][applies_to]" class="kt-select h-9 py-1 text-sm bg-gray-50 w-full">
                                    <option value="all" ${commission.applies_to === 'all' ? 'selected' : ''}>{{ __('main.all_nationalities') }}</option>
                                    <option value="foreigner" ${commission.applies_to === 'foreigner' ? 'selected' : ''}>{{ __('main.foreigner') }}</option>
                                    <option value="arab" ${commission.applies_to === 'arab' ? 'selected' : ''}>{{ __('main.arab') }}</option>
                                    <option value="resident" ${commission.applies_to === 'resident' ? 'selected' : ''}>{{ __('main.resident') }}</option>
                                </select>
                            </div>
                            <div class="w-1/6 min-w-[120px]">
                                ...
                                <select name="commission_configuration[${index}][type]" class="kt-select h-9 py-1 text-sm bg-gray-50 w-full" onchange="updateCommissionSymbol(this)">
                                    <option value="percentage" ${commission.type === 'percentage' ? 'selected' : ''}>{{ __('main.percentage') }} (%)</option>
                                    <option value="fixed" ${commission.type === 'fixed' ? 'selected' : ''}>{{ __('main.fixed_amount') }}</option>
                                </select>
                            </div>
                            <div class="w-1/6 min-w-[120px] flex items-center gap-2">
                                <div class="relative w-full">
                                    <label class="text-xs font-bold text-gray-600 mb-1 block">{{ __('main.value') }}</label>
                                    <div class="relative w-full">
                                        <input type="number" step="0.01" name="commission_configuration[${index}][value]" class="kt-input h-9 w-full pe-8 text-center font-bold text-gray-700" value="${commission.value || ''}">
                                        <span class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 font-bold text-xs commission-symbol pointer-events-none ${commission.type === 'fixed' ? 'currency-symbol' : ''}">${commission.type === 'percentage' ? '%' : currentCurrency}</span>
                                    </div>
                                </div>
        ...
        function addSeasonRow() {
            ...
            const html = `
                <div class="flex flex-row gap-4 items-end season-row background mb-4 p-4 rounded border-custom shadow-sm relative">
                    <div class="flex-1 min-w-0">
                        <label class="text-sm font-bold text-gray-700 mb-2 block">{{ __('main.season_name') }}</label>
                        <input type="text" name="service_seasons[${index}][name]" class="kt-input h-[45px] font-medium season-name-input w-full" >
                    </div>
                    <div class="w-1/4 min-w-[150px]">
                        <label class="text-sm font-bold text-gray-700 mb-2 block">{{ __('main.start_date') }}</label>
                        <input type="date" name="service_seasons[${index}][start]" class="kt-input h-[45px] season-start-date w-full" onchange="validateSeasonDates(this)" >
                    </div>
                    <div class="w-1/4 min-w-[150px]">
                        <label class="text-sm font-bold text-gray-700 mb-2 block">{{ __('main.end_date') }}</label>
                        <input type="date" name="service_seasons[${index}][end]" class="kt-input h-[45px] season-end-date w-full" onchange="validateSeasonDates(this)" >
                    </div>
        ...
        function addTaxRow() {
            ...
            const html = `
                <div class="flex flex-row gap-2 items-end tax-row relative background p-3 rounded border border-dashed border-red-200">
                    ...
                    <div class="flex-1 min-w-0">
                        <label class="text-xs font-bold text-gray-600 mb-1 block">{{ __('main.name') }}</label>
                        <input type="text" name="tax_configuration[${index}][name]" class="kt-input h-9 w-full" >
                    </div>
                    <!-- Type -->
                    <div class="w-1/4 min-w-[120px]">
                        <label class="text-xs font-bold text-gray-600 mb-1 block">{{ __('main.type') }}</label>
                    ...
                    <div class="w-1/3 min-w-[150px] flex items-center gap-2">
                         <div class="relative w-full">
                            <label class="text-xs font-bold text-gray-600 mb-1 block">{{ __('main.value') }}</label>
                            <div class="relative w-full">
                                <input type="number" step="0.01" name="tax_configuration[${index}][value]" class="kt-input h-9 w-full pe-8 font-bold text-gray-700" >
        ...
        function addCommissionRow() {
            ...
            const html = `
                <div class="flex flex-row gap-2 items-end commission-row relative background p-3 rounded border border-dashed border-green-200">
                    ...
                    <div class="flex-1 min-w-0">
                        <label class="text-xs font-bold text-gray-600 mb-1 block">{{ __('main.name') }}</label>
                        <input type="text" name="commission_configuration[${index}][name]" class="kt-input h-9 w-full" >
                    </div>
                    <!-- Applies To (W-1/4) -->
                    <div class="w-1/4 min-w-[140px]">
                        <label class="text-xs font-bold text-gray-600 mb-1 block">{{ __('main.applies_to') }}</label>
                    ...
                    <div class="w-1/6 min-w-[120px] flex items-center gap-2">
                        <div class="relative w-full">
                            <label class="text-xs font-bold text-gray-600 mb-1 block">{{ __('main.value') }}</label>
                            <div class="relative w-full">
                                <input type="number" step="0.01" name="commission_configuration[${index}][value]" class="kt-input h-9 w-full pe-8 text-center font-bold text-gray-700" >
        ...
        function updatePricingModelVisuals(selectedMode) {
            ...
            const blueActive = ['border-blue-600', 'bg-gray-100', 'shadow-md'];
