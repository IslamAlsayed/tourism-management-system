                ...
                <div class="kt-card">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6">
                            <!-- Site -->
                            <div>
                                <label for="site_id" class="kt-label">
                                    {{ __('main.site') }} <span class="text-red-600">*</span>
                                </label>
                                <select name="site_id" id="site_id" class="kt-select basic-single">
                                    <option value="" selected>--</option>
                                    @foreach ($sites as $site)
                                        <option value="{{ $site->id }}"
                                            {{ $touristService->site_id == $site->id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="total_day_visit" id="total_day_visit"
                                    class="kt-input h-[45px]" value="{{ $touristService->total_day_visit }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="sort_order" id="sort_order"
                                    class="kt-input h-[45px]" value="{{ $touristService->sort_order }}">
                            </div>
                            ...
                            <div class="col-span-full flex flex-wrap" style="gap: 10px 40px;">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    @include('components.elements.checkbox-button', [
                                        ...
                                        'value' => '1',
                                        'checked' => $touristService->include_unified_ticket,
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    @include('components.elements.checkbox-button', [
                                        ...
                                        'id' => 'credit_cards',
                                        'value' => '1',
                                        'checked' => $touristService->credit_cards,
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" step="0.01" name="per_adult_foreigners" id="per_adult_foreigners"
                                    class="kt-input h-[45px]" value="{{ $touristService->per_adult_foreigners }}">
                            </div>
                            <div>
                                ...
                                <input type="number" step="0.01" name="per_child_foreigners" id="per_child_foreigners"
                                    class="kt-input h-[45px]" value="{{ $touristService->per_child_foreigners }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" step="0.01" name="per_adult_local" id="per_adult_local"
                                    class="kt-input h-[45px]" value="{{ $touristService->per_adult_local }}">
                            </div>
                            <div>
                                ...
                                <input type="number" step="0.01" name="per_child_local" id="per_child_local"
                                    class="kt-input h-[45px]" value="{{ $touristService->per_child_local }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" step="0.01" name="per_adult_arab" id="per_adult_arab"
                                    class="kt-input h-[45px]" value="{{ $touristService->per_adult_arab }}">
                            </div>
                            <div>
                                ...
                                <input type="number" step="0.01" name="per_child_arab" id="per_child_arab"
                                    class="kt-input h-[45px]" value="{{ $touristService->per_child_arab }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" step="0.01" name="per_adult_residents" id="per_adult_residents"
                                    class="kt-input h-[45px]" value="{{ $touristService->per_adult_residents }}">
                            </div>
                            <div>
                                ...
                                <input type="number" step="0.01" name="per_child_residents" id="per_child_residents"
                                    class="kt-input h-[45px]" value="{{ $touristService->per_child_residents }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" step="0.01" name="non_accommodated_visitors_adult"
                                    ...
                                    value="{{ $touristService->non_accommodated_visitors_adult }}">
                            </div>
                            <div>
                                ...
                                <input type="number" step="0.01" name="non_accommodated_visitors_child"
                                    ...
                                    value="{{ $touristService->non_accommodated_visitors_child }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            <div>
                                ...
                                <input type="time" name="summer_opening_time" id="summer_opening_time"
                                    class="kt-input h-[45px]" value="{{ $touristService->summer_opening_time }}">
                            </div>
                            <div>
                                ...
                                <input type="time" name="summer_closing_time" id="summer_closing_time"
                                    class="kt-input h-[45px]" value="{{ $touristService->summer_closing_time }}">
                            </div>
                            <div>
                                ...
                                <input type="time" name="winter_opening_time" id="winter_opening_time"
                                    class="kt-input h-[45px]" value="{{ $touristService->winter_opening_time }}">
                            </div>
                            <div>
                                ...
                                <input type="time" name="winter_closing_time" id="winter_closing_time"
                                    class="kt-input h-[45px]" value="{{ $touristService->winter_closing_time }}">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            @foreach (['saturday', 'sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday'] as $day)
                                <div class="flex items-center gap-3">
                                    ...
                                    @include('components.elements.checkbox-button', [
                                        ...
                                        'value' => $day,
                                        'checked' =>
                                            is_array($touristService->operating_days) &&
                                            in_array($day, $touristService->operating_days ?? []),
                                        'label' => __('main.' . $day),
                                    ])
                                </div>
                            @endforeach
                ...
                <div class="kt-card">
                    ...
                    <div class="kt-card-body p-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6"
                            ...
                            @if (is_array($touristService->annual_holidays) && count($touristService->annual_holidays) > 0)
                                @foreach ($touristService->annual_holidays as $index => $date)
                ...
                <div class="kt-card">
                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6"
                            ...
                            @if (is_array($touristService->yearly_holidays) && count($touristService->yearly_holidays) > 0)
                                @foreach ($touristService->yearly_holidays as $index => $holiday)
                                ...
                                @foreach (['saturday', 'sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday'] as $day)
                                    <div class="flex items-center gap-3">
                                        ...
                                        @include('components.elements.checkbox-button', [
                                            ...
                                            'value' => $day,
                                            'checked' =>
                                                is_array($touristService->day_off) &&
                                                in_array($day, $touristService->day_off ?? []),
                                            'label' => __('main.' . $day),
                                        ])
                                    </div>
                                @endforeach
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="tel" name="mobile_01" id="mobile_01" class="kt-input h-[45px]"
                                    value="{{ $touristService->mobile_01 }}">
                            </div>
                            <div>
                                ...
                                <input type="tel" name="mobile_02" id="mobile_02" class="kt-input h-[45px]"
                                    value="{{ $touristService->mobile_02 }}">
                            </div>
                            <div>
                                ...
                                <input type="text" name="person_name_01" id="person_name_01"
                                    class="kt-input h-[45px]" value="{{ $touristService->person_name_01 }}">
                            </div>
                            <div>
                    ...
                    <div class="kt-card-body p-4">
                            ...
                            @for ($i = 1; $i <= 3; $i++)
                                <div>
                                    ...
                                    <input type="number" step="0.01" name="local_guide_fees_0{{ $i }}"
                                        ...
                                        value="{{ $touristService->{'local_guide_fees_0' . $i} }}">
                                </div>
                            @endfor
                        </div>
                        ...
                        <div class="col-span-full flex items-center gap-3">
                            ...
                            @include('components.elements.checkbox-button', [
                                ...
                                'value' => '1',
                                'checked' => $touristService->local_guide_available,
                    ...
                    <div class="kt-card-body p-4">
                        <div class="flex items-center gap-3">
                            ...
                            @include('components.elements.checkbox-button', [
                                ...
                                'value' => '1',
                                'checked' => $touristService->club_cars_available,
                            ...
                            @for ($i = 1; $i <= 8; $i++)
                                <div>
                                    ...
                                    <input type="number" step="0.01" name="club_car_prices_0{{ $i }}"
                                        ...
                                        value="{{ $touristService->{'club_car_prices_0' . $i} }}">
                                </div>
                            @endfor
                        </div>
                    </div>
