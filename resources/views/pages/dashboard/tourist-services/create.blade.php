                    ...
                    <div class="kt-card-body p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 border-custom-b pb-6">
                            <div>
                                ...
                                <input type="text" name="name" class="kt-input h-[42px] font-medium" required value="{{ old('name') }}"
                                    placeholder="e.g. Meet and Assist Airport">
                            </div>
                            <div>
                                <label class="kt-label font-bold text-sm mb-1">
                                    {{ __('main.service_name_ar') }}
                                </label>
                                <input type="text" name="name_ar" class="kt-input h-[42px] font-medium" value="{{ old('name_ar') }}"
                                    placeholder="مثال: خدمة استقبال بالمطار">
                            </div>
                        </div>
                                    ...
                                    <div class="relative group">
                                        ...
                                        <div class="relative">
                                            <select name="pricing_unit" id="pricing_unit"
                                                ...
                                                <option value="person">{{ __('main.per_person') }}</option>
                                                <option value="group">{{ __('main.per_group') }}</option>
                                                <option value="bus">Per Vehicle</option>
                                                <option value="meal">Per Meal</option>
                                                <option value="trip">{{ __('main.per_trip') }}</option>
                                                <option value="person_day">{{ __('main.per_person_per_day') }}</option>
                                                <option value="group_day">{{ __('main.per_group_per_day') }}</option>
                                                <option value="person_night">{{ __('main.per_person_per_night') }}
                                                </option>
                                                <option value="group_night">{{ __('main.per_group_per_night') }}
                                                </option>
                                                <option value="day">{{ __('main.per_day') }}</option>
                                                <option value="night">{{ __('main.per_night') }}</option>
                                                <option value="unit">{{ __('main.per_unit') }}</option>
                                                <option value="extra_hour_person">Per extra hour per person</option>
                                                <option value="extra_hour_group">Per extra hour per group</option>
                                                <option value="extra_hour_vehicle">Per extra hour per vehicle</option>
                                                <option value="child">Per Child</option>
                                                <option value="child_day">Per Child Per Day</option>
                                                <option value="child_night">Per Child Per Night</option>
                                                <option value="extra_hour_child">Per extra hour per child</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <label id="label_flat" class="relative cursor-pointer group">
                                    <input type="radio" name="pricing_type" value="flat" class="peer sr-only" checked onchange="togglePricingMode('flat')">
                                ...
                                <label id="label_seasonal" class="relative cursor-pointer group">
                                    <input type="radio" name="pricing_type" value="seasonal" class="peer sr-only" onchange="togglePricingMode('seasonal')">
                                    <div class="p-5 rounded-xl border-custom-1 background transition-all h-full flex flex-col items-center text-center">
                        ...
                        <div id="flat_pricing_container" class="p-4 bg-gray-50 rounded-lg border-custom border-dashed">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="date" name="flat_start_date" class="kt-input h-[40px]" placeholder="YYYY/MM/DD">
                                </div>
                                <div>
                                    <label class="text-xs font-bold text-gray-600 mb-1 block">{{ __('main.effective_until') }}</label>
                                    <input type="date" name="flat_end_date" class="kt-input h-[40px]" placeholder="YYYY/MM/DD">
                                </div>
                            </div>
                        </div>
