            ...
            <div class="grid lg:grid-cols-3 gap-y-5 lg:gap-7.5 items-stretch">
                                            ...
                                            <div class="kt-image-input size-16" data-kt-image-input="true">
                                                ...
                                                <div class="kt-image-input-placeholder border-2 border-green-500 kt-image-input-empty:border-input"
                                                    ...
                                                    <div class="kt-image-input-preview" data-kt-image-input-preview="true"
                                                        style="background-image:url('metronic/media/avatars/300-2.png')">
                                                    </div>
                                                    <div
                ...
                <div class="lg:col-span-1">
                    <div class="grid grid-cols-1 gap-5 lg:gap-7.5 h-full items-stretch">
                        ...
                        <div
                            class="kt-card px-5 lg:px-7.5 h-full bg-[length:85%] [background-position:7.5rem_-3.5rem] rtl:[background-position:-3rem_-3.5rem] bg-no-repeat channel-stats-bg">
                            <div class="flex flex-col gap-4 pt-6">
                                <i class="ki-filled ki-badge text-2xl text-muted-foreground">
                                </i>
                                <div class="flex flex-col gap-2.5 mb-2">
                                    <a class="text-base font-semibold leading-none text-mono hover:text-primary"
                                        href="{{ url('demo5/account/members/team-info') }}">
                                        Seats
                                    </a>
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-4 pt-6">
                                ...
                                <div class="flex flex-col gap-2.5 mb-2">
                                    <a class="text-base font-semibold leading-none text-mono hover:text-primary"
                                        href="{{ url('demo5/account/security/security-log') }}">
                                        Login & Security
                                    </a>
                                    <span class="text-sm font-medium text-secondary-foreground leading-5">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-24.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-7.png') }}" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-3.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-8.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-9.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <span
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-6.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-5.png') }}" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-10.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-11.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-12.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <span
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-13.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-14.png') }}" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-15.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-16.png') }}" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-17.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-18.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-19.png') }}" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-20.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-21.png') }}" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-22.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-23.png') }}" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        ...
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-25.png') }}" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-26.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-27.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-28.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <span
                                                                class="relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-[30px] text-white ring-background bg-violet-500">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex -space-x-2">
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-29.png') }}" />
                                                        </div>
                                                        <div class="flex">
                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                src="{{ asset('metronic/media/avatars/300-30.png') }}" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                            ...
                            <div class="kt-accordion-item not-last:border-b border-b-border"
                                ...
                                <div class="kt-accordion-content hidden" id="faq_1_content">
                                    <div class="text-secondary-foreground text-base pb-4">
                                        Metronic embraces flexible licensing options that empower you to choose the perfect
                                        fit for your project's needs and budget. Understanding the factors influencing each
                                        ...
                                        needs and budget. Understanding the factors influencing each plan's pricing helps
                                        you make an informed decision. Metronic embraces flexible licensing options that
                                        empower you to choose the perfect fit for your project's needs and budget.
                            ...
                            <div class="kt-accordion-item not-last:border-b border-b-border"
                                ...
                                <div class="kt-accordion-content hidden" id="faq_2_content">
                                    <div class="text-secondary-foreground text-base pb-4">
                                        Metronic embraces flexible licensing options that empower you to choose the perfect
                                        fit for your project's needs and budget. Understanding the factors influencing each
                                        plan's pricing helps you make an informed decision
                                    </div>
                                </div>
                            </div>
                            <div class="kt-accordion-item not-last:border-b border-b-border"
