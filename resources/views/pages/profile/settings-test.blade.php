                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="fs-6 fw-semibold text-gray-800">{{ $user->department ?? 'Not specified' }}</div>
                            </div>
                            <div class="col-12 mb-4">
                                <label class="fs-7 fw-bold text-muted mb-2">BIO</label>
                                <div class="fs-6 fw-semibold text-gray-800">{{ $user->bio ?? 'No bio provided yet.' }}</div>
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="timeline-modern">
                            <div class="timeline-item-modern">
                                ...
                                <div class="text-muted fs-7">{{ $user->updated_at ? $user->updated_at->diffForHumans() : '2 hours ago' }}</div>
                            ...
                            <div class="timeline-item-modern">
                                ...
                                <div class="text-muted fs-7">{{ $user->created_at ? $user->created_at->diffForHumans() : '1 week ago' }}</div>
                        ...
                        <form>
                            ...
                            <div class="row mb-6">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex align-items-center gap-4">
                                        <img src="{{ $user->avatar_url ? asset('storage/' . $user->avatar_url) : asset('metronic/media/avatars/300-2.png') }}"
                                             alt="Avatar" class="custom-avatar">
                                        <div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-modern"
                                           value="{{ explode(' ', $user->name)[0] ?? '' }}" placeholder="Enter first name">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Last Name *</label>
                                    <input type="text" class="form-control form-control-modern"
                                           value="{{ explode(' ', $user->name)[1] ?? '' }}" placeholder="Enter last name">
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control form-control-modern" rows="4"
                    ...
                    <div class="form-section">
                        ...
                        <div class="notice notice-light-primary rounded border-primary border border-dashed p-4">
                            ...
                            <div class="notice-content">
                                ...
                                <div class="fs-7 text-muted">Adding more information helps colleagues find and connect with you.</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="kt-card-body">
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="password" class="form-control form-control-lg form-control-solid" placeholder="Current password" />
                            </div>
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="password" class="form-control form-control-lg form-control-solid" placeholder="Confirm password" />
                            </div>
                        </div>
                        ...
                        <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6 mb-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                <div class="fw-semibold">
                                    ...
                                    <div class="fs-6 text-gray-700">Add an extra layer of security to your account by enabling two-factor authentication.</div>
                                </div>
                            </div>
                        </div>
