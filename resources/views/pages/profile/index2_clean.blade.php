                ...
                <div class="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
                    ...
                    <div class="flex gap-1.25 items-center">
                        ...
                        <a class="text-secondary-foreground font-medium hover:text-primary"
                            href="mailto:{{ $user->email ?? 'jenny@kteam.com' }}">
                ...
                <div class="kt-scrollable-x-auto">
                    <div class="kt-menu gap-3" data-kt-menu="true">
                        <div
                            ...
                            <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="{{ route('user.profile') }}">
                                <span
                            ...
                            <table class="kt-table-auto">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm text-mono pb-3.5">
                                            <a class="text-foreground hover:text-primary"
                        ...
                        <div class="kt-card-content">
                            <div class="grid gap-y-5">
                                <div class="flex align-start gap-3.5">
                                    <img alt="" class="h-9"
                                        src="{{ asset('metronic/media/brand-logos/zircon.svg') }}" />
                                ...
                                <div class="flex align-start gap-3.5">
                                    <img alt="" class="h-9"
                                        src="{{ asset('metronic/media/brand-logos/weave.svg') }}" />
                                    <div class="flex flex-col gap-1">
                                        <a class="text-sm font-medium text-primary leading-none hover:text-primary"
                                            href="#">
                                            Pesto Plus
                                ...
                                <div class="flex align-start gap-3.5">
                                    <img alt="" class="h-9"
                                        src="{{ asset('metronic/media/brand-logos/perrier.svg') }}" />
                                    <div class="flex flex-col gap-1">
                                        <a class="text-sm font-medium text-primary leading-none hover:text-primary"
                                            href="#">
                        ...
                        <div class="kt-card-content px-10 py-7.5 lg:pe-12.5">
                            <div class="flex flex-wrap md:flex-nowrap items-center gap-6 md:gap-10">
                                ...
                                <img alt="image" class="dark:hidden max-h-[160px]"
                                    src="{{ asset('metronic/media/illustrations/1.svg') }}" />
                                <img alt="image" class="light:hidden max-h-[160px]"
                                    src="{{ asset('metronic/media/illustrations/1-dark.svg') }}" />
                            </div>
                        </div>
                        <div class="kt-card-footer justify-center">
                            ...
                            <div class="flex flex-col gap-3.5">
                                <div class="flex items-start gap-3.5">
                                    <img alt="" class="rounded-full size-9 shrink-0"
                                        src="{{ $user->photo ? asset('storage/' . $user->photo) : asset('metronic/media/avatars/300-1.png') }}" />
