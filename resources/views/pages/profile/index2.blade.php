...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/default" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo1/public-profile/profiles/default" property="og:url"/>
   ...
   <div class="kt-sidebar bg-background border-e border-e-border fixed top-0 bottom-0 z-20 hidden lg:flex flex-col items-stretch shrink-0 [--kt-drawer-enable:true] lg:[--kt-drawer-enable:false]" data-kt-drawer="true" data-kt-drawer-class="kt-drawer kt-drawer-start top-0 bottom-0" id="sidebar">
    <div class="kt-sidebar-header hidden lg:flex items-center relative justify-between px-3 lg:px-6 shrink-0" id="sidebar_header">
     <a class="dark:hidden" href="html/demo1.html">
      <img class="default-logo min-h-[22px] max-w-none" src="{{asset('metronic/media/app/default-logo.svg"')}}/>
      <img class="small-logo min-h-[22px] max-w-none" src="{{asset('metronic/media/app/mini-logo.svg"')}}/>
     </a>
     <a class="hidden dark:block" href="html/demo1.html">
      <img class="default-logo min-h-[22px] max-w-none" src="{{asset('metronic/media/app/default-logo-dark.svg"')}}/>
      <img class="small-logo min-h-[22px] max-w-none" src="{{asset('metronic/media/app/mini-logo.svg"')}}/>
     </a>
      ...
      <div class="flex items-center gap-2.5">
         ...
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="grow flex flex-col gap-5 pt-3 pb-4 divider-y divider-border">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{asset('metronic/media/avatars/300-11.png')}}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
         ...
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
           <div class="flex grow gap-2.5 px-5" id="notification_request_13">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{asset('metronic/media/avatars/300-25.png')}}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{asset('metronic/media/avatars/300-29.png')}}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
             ...
             <div class="kt-card shadow-none p-3.5 gap-3.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-between flex-wrap gap-2.5">
               ...
               <div class="flex -space-x-2">
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-3.png"')}}/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-2.png"')}}/>
                </div>
               </div>
              </div>
              <div class="flex items-center gap-2.5">
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_3">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{asset('metronic/media/avatars/300-30.png')}}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{asset('metronic/media/avatars/300-24.png')}}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
         ...
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
            ...
            <div class="flex flex-col gap-3 grow" id="notification_request_10">
             ...
             <div class="kt-card shadow-none p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-between flex-wrap gap-2.5">
               ...
               <div class="flex -space-x-2">
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-4.png"')}}/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-1.png"')}}/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-2.png"')}}/>
                </div>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{asset('metronic/media/avatars/300-6.png')}}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{asset('metronic/media/avatars/300-12.png')}}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{asset('metronic/media/avatars/300-21.png')}}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
         ...
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{asset('metronic/media/avatars/300-1.png')}}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
       ...
       <div class="hidden kt-drawer kt-drawer-end card flex-col max-w-[90%] w-[450px] top-5 bottom-5 end-5 rounded-xl border border-border" data-kt-drawer="true" data-kt-drawer-container="body" id="chat_drawer">
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5">
           <div class="flex items-center flex-wrap gap-2">
            <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-11">
             <img alt="" class="size-7" src="{{asset('metronic/media/brand-logos/gitlab.svg"')}}/>
            </div>
            <div class="flex flex-col">
           ...
           <div class="flex items-center gap-2.5">
            <div class="flex -space-x-2">
             <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{asset('metronic/media/avatars/300-4.png"')}}/>
             </div>
             <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{asset('metronic/media/avatars/300-1.png"')}}/>
             </div>
             <div class="flex">
              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]" src="{{asset('metronic/media/avatars/300-2.png"')}}/>
             </div>
             <div class="flex">
        ...
        <div class="kt-scrollable-y-auto grow" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="230px">
         <div class="flex flex-col gap-5 py-5">
          <div class="flex items-end gap-3.5 px-5">
           <img alt="" class="rounded-full size-9" src="{{asset('metronic/media/avatars/300-5.png"')}}/>
           <div class="flex flex-col gap-1.5">
          ...
          <div class="flex items-end gap-3.5 px-5">
           <img alt="" class="rounded-full size-9" src="{{asset('metronic/media/avatars/300-4.png"')}}/>
           <div class="flex flex-col gap-1.5">
            <div class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
          ...
          <div class="flex items-end gap-3.5 px-5">
           <img alt="" class="rounded-full size-9" src="{{asset('metronic/media/avatars/300-1.png"')}}/>
           <div class="flex flex-col gap-1.5">
            <div class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
        ...
        <div class="mb-2.5">
         ...
         <div class="relative grow mx-5">
          <img alt="" class="rounded-full size-[30px] absolute start-0 top-2/4 -translate-y-2/4 ms-2.5" src="{{asset('metronic/media/avatars/300-2.png')}}">
        ...
        <div class="kt-dropdown-menu p-0 w-screen max-w-[320px]" data-kt-dropdown-menu="true">
         ...
         <div class="flex flex-col kt-scrollable-y-auto max-h-[400px] divide-y divide-border">
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex items-center flex-wrap gap-2">
            <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
             <img alt="" class="size-6" src="{{asset('metronic/media/brand-logos/jira.svg')}}">
             </img>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex items-center flex-wrap gap-2">
            <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
             <img alt="" class="size-6" src="{{asset('metronic/media/brand-logos/inferno.svg')}}">
             </img>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex items-center flex-wrap gap-2">
            <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
             <img alt="" class="size-6" src="{{asset('metronic/media/brand-logos/evernote.svg"')}}/>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
              Evernote
          ...
          <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div class="flex items-center flex-wrap gap-2">
            <div class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
             <img alt="" class="size-6" src="{{asset('metronic/media/brand-logos/google-webdev.svg"')}}/>
            </div>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
              Google webdev
       ...
       <div class="shrink-0" data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-20px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
        <div class="cursor-pointer shrink-0" data-kt-dropdown-toggle="true">
         <img alt="" class="size-9 rounded-full border-2 border-green-500 shrink-0" src="{{asset('metronic/media/avatars/300-2.png"')}}/>
        </div>
        <div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
         <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
          <div class="flex items-center gap-2">
           <img alt="" class="size-9 shrink-0 rounded-full border-2 border-green-500" src="{{asset('metronic/media/avatars/300-2.png"')}}/>
           <div class="flex flex-col gap-1.5">
          ...
          <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start" data-kt-dropdown-trigger="hover">
           <button class="kt-dropdown-menu-toggle py-1" data-kt-dropdown-toggle="true">
            ...
            <span class="ms-auto kt-badge kt-badge-stroke shrink-0">
             English
             <img alt="" class="inline-block size-3.5 rounded-full" src="{{asset('metronic/media/flags/united-states.svg"')}}/>
            </span>
           </button>
            ...
            <ul class="kt-dropdown-menu-sub">
             <li class="active">
              <a class="kt-dropdown-menu-link" href="?dir=ltr">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block size-4 rounded-full" src="{{asset('metronic/media/flags/united-states.svg"')}}/>
                <span class="kt-menu-title">
                 English
                </span>
               </span>
             ...
             <li class="">
              <a class="kt-dropdown-menu-link" href="?dir=rtl">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block size-4 rounded-full" src="{{asset('metronic/media/flags/saudi-arabia.svg"')}}/>
                <span class="kt-menu-title">
                 Arabic(Saudi)
                </span>
               </span>
             ...
             <li class="">
              <a class="kt-dropdown-menu-link" href="?dir=ltr">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block size-4 rounded-full" src="{{asset('metronic/media/flags/spain.svg"')}}/>
                <span class="kt-menu-title">
                 Spanish
                </span>
               </span>
             ...
             <li class="">
              <a class="kt-dropdown-menu-link" href="?dir=ltr">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block size-4 rounded-full" src="{{asset('metronic/media/flags/germany.svg"')}}/>
                <span class="kt-menu-title">
                 German
                </span>
               </span>
             ...
             <li class="">
              <a class="kt-dropdown-menu-link" href="?dir=ltr">
               <span class="flex items-center gap-2">
                <img alt="" class="inline-block size-4 rounded-full" src="{{asset('metronic/media/flags/japan.svg"')}}/>
                <span class="kt-menu-title">
                 Japanese
                </span>
               </span>
       ...
       <div class="grid">
        <div class="kt-scrollable-x-auto">
         <div class="kt-menu gap-3" data-kt-menu="true">
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary here" data-kt-menu-item-overflow="true" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
           ...
           <div class="kt-menu-dropdown kt-menu-default py-2 min-w-[200px]">
            ...
            <div class="kt-menu-item" data-kt-menu-item-offset="-10px, 0" data-kt-menu-item-placement="right-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary" data-kt-menu-item-overflow="true" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
           <div class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2">
            <span class="kt-menu-title text-nowrap text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-medium kt-menu-item-here:text-primary kt-menu-item-here:font-medium kt-menu-item-show:text-primary kt-menu-link-hover:text-primary">
             Projects
            </span>
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
           <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="html/demo1/public-profile/works.html">
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
           <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="html/demo1/public-profile/teams.html">
            <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-item-here:text-primary kt-menu-item-here:font-semibold kt-menu-item-show:text-primary kt-menu-link-hover:text-primary">
             Teams
            </span>
           </a>
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
           <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="html/demo1/public-profile/network.html">
            <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-item-here:text-primary kt-menu-item-here:font-semibold kt-menu-item-show:text-primary kt-menu-link-hover:text-primary">
             Network
            </span>
           </a>
          ...
          <div class="kt-menu-item border-b-2 border-b-transparent kt-menu-item-active:border-b-primary kt-menu-item-here:border-b-primary">
           <a class="kt-menu-link gap-1.5 pb-2 lg:pb-4 px-2" href="html/demo1/public-profile/activity.html">
            <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-primary kt-menu-item-active:font-semibold kt-menu-item-here:text-primary kt-menu-item-here:font-semibold kt-menu-item-show:text-primary kt-menu-link-hover:text-primary">
             Activity
            </span>
           </a>
        ...
        <div data-kt-dropdown="true" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
         ...
         <div class="kt-dropdown-menu w-full max-w-[220px]" data-kt-dropdown-menu="true">
          <ul class="kt-dropdown-menu-sub">
           ...
           <li>
            <button class="kt-dropdown-menu-link" data-kt-dropdown-dismiss="true" data-kt-modal-toggle="#give_award_modal">
           ...
           <li>
            <button class="kt-dropdown-menu-link" data-kt-dropdown-dismiss="true" data-kt-modal-toggle="#report_user_modal">
        ...
        <div class="grid gap-5 lg:gap-7.5">
         ...
         <div class="kt-card">
          ...
          <div class="kt-card-content">
           <div class="grid gap-y-5">
            <div class="flex align-start gap-3.5">
             <img alt="" class="h-9" src="{{asset('metronic/media/brand-logos/jira.svg"')}}/>
             <div class="flex flex-col gap-1">
          ...
          <div class="kt-card-footer justify-center">
           <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo1/public-profile/works.html">
            Open to Work
           </a>
          </div>
         </div>
           ...
           <div class="grid gap-2.5 lg:gap-5">
            <div class="flex items-center gap-3">
             <div class="flex items-center grow gap-2.5">
              <img src="{{asset('metronic/media/file-types/pdf.svg')}}">
               <div class="flex flex-col">
...
MB 26 Sep 2024 3:20 PM
            ...
            <div class="flex items-center gap-3">
             <div class="flex items-center grow gap-2.5">
              <img src="{{asset('metronic/media/file-types/doc.svg')}}">
               <div class="flex flex-col">
                <span class="text-sm font-medium text-mono cursor-pointer hover:text-primary mb-px">
                 Report-v1.docx
                </span>
            ...
            <div class="flex items-center gap-3">
             <div class="flex items-center grow gap-2.5">
              <img src="{{asset('metronic/media/file-types/ai.svg')}}">
               <div class="flex flex-col">
                <span class="text-sm font-medium text-mono cursor-pointer hover:text-primary mb-px">
                 Framework-App.js
                </span>
            ...
            <div class="flex items-center gap-3">
             <div class="flex items-center grow gap-2.5">
              <img src="{{asset('metronic/media/file-types/js.svg')}}">
               <div class="flex flex-col">
                <span class="text-sm font-medium text-mono cursor-pointer hover:text-primary mb-px">
                 Mobile-logo.ai
                </span>
        ...
        <div class="flex flex-col gap-5 lg:gap-7.5">
         <div class="flex flex-col gap-5 lg:gap-7.5">
          <div class="kt-card">
           ...
           <div class="kt-card-footer justify-center">
            <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo1/network/get-started.html">
             Get Started
            </a>
           </div>
          </div>
          ...
          <div class="kt-card">
           ...
           <div class="kt-card-content">
            <div class="flex flex-col gap-2 lg:gap-5">
             <div class="flex items-center gap-2">
              <div class="flex items-center grow gap-2.5">
               <img alt="" class="rounded-full size-9 shrink-0" src="{{asset('metronic/media/avatars/300-3.png')}}">
                <div class="flex flex-col">
             ...
             <div class="flex items-center gap-2">
              <div class="flex items-center grow gap-2.5">
               <img alt="" class="rounded-full size-9 shrink-0" src="{{asset('metronic/media/avatars/300-1.png')}}">
                <div class="flex flex-col">
                 <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
                  Esther Howard
                 </a>
             ...
             <div class="flex items-center gap-2">
              <div class="flex items-center grow gap-2.5">
               <img alt="" class="rounded-full size-9 shrink-0" src="{{asset('metronic/media/avatars/300-14.png')}}">
                <div class="flex flex-col">
                 <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
                  Cody Fisher
                 </a>
             ...
             <div class="flex items-center gap-2">
              <div class="flex items-center grow gap-2.5">
               <img alt="" class="rounded-full size-9 shrink-0" src="{{asset('metronic/media/avatars/300-7.png')}}">
                <div class="flex flex-col">
                 <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
                  Arlene McCoy
                 </a>
           ...
           <div class="kt-card-footer justify-center">
            <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo1/public-profile/network.html">
             All Contributors
            </a>
           </div>
          </div>
         ...
         <div class="kt-card">
             ...
             <tr>
              ...
              <td>
               <div class="flex justify-end rtl:justify-start shrink-0">
                <div class="flex -space-x-2">
                 <div class="flex">
                  <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-20.png"')}}/>
                 </div>
                 <div class="flex">
                  <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-7.png"')}}/>
                 </div>
                </div>
               </div>
              </td>
             ...
             <tr>
              ...
              <td>
               <div class="flex justify-end rtl:justify-start shrink-0">
                <div class="flex -space-x-2">
                 <div class="flex">
                  <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-6.png"')}}/>
                 </div>
                 <div class="flex">
                  <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-23.png"')}}/>
                 </div>
                 <div class="flex">
                  <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-12.png"')}}/>
                 </div>
                 <div class="flex">
              ...
              <td>
               <div class="flex justify-end rtl:justify-start shrink-0">
                <div class="flex -space-x-2">
                 ...
                 <div class="flex">
                  <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-15.png"')}}/>
                 </div>
                 <div class="flex">
                  <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-18.png"')}}/>
                 </div>
                 <div class="flex">
                  <span class="relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-6 text-white ring-background bg-green-500">
                   +2
          ...
          <div class="kt-card-footer justify-center">
           <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo1/public-profile/projects/3-columns.html">
            All Projects
           </a>
          </div>
         </div>
         ...
         <div class="kt-menu kt-menu-default px-0.5 flex-col">
           ...
           <div class="kt-menu-link flex items-center jistify-between gap-2">
            <div class="flex items-center grow gap-2">
             <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
              <img alt="" class="size-6 shrink-0" src="{{asset('metronic/media/brand-logos/jira.svg"')}}/>
             </div>
             <div class="flex flex-col gap-0.5">
              <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
               Jira
          ...
          <div class="kt-menu-item">
           <div class="kt-menu-link flex items-center jistify-between gap-2">
            <div class="flex items-center grow gap-2">
             <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
              <img alt="" class="size-6 shrink-0" src="{{asset('metronic/media/brand-logos/inferno.svg"')}}/>
             </div>
             <div class="flex flex-col gap-0.5">
              <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
               Inferno
            ...
            <div class="flex justify-end shrink-0">
             <div class="flex -space-x-2">
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-14.png"')}}/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-12.png"')}}/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-9.png"')}}/>
              </div>
             </div>
            </div>
           </div>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{asset('metronic/media/brand-logos/evernote.svg"')}}/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Evernote
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            ...
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-8.png"')}}/>
            </div>
           </div>
          </div>
         </div>
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{asset('metronic/media/brand-logos/gitlab.svg"')}}/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Gitlab
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            ...
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-17.png"')}}/>
            </div>
           </div>
          </div>
         </div>
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{asset('metronic/media/brand-logos/google-webdev.svg"')}}/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Google webdev
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            ...
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{asset('metronic/media/avatars/300-21.png"')}}/>
            </div>
           </div>
          </div>
         </div>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        <div class="grid gap-1">
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{asset('metronic/media/avatars/300-11.png"')}}/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              Jacob Jones
             </a>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{asset('metronic/media/avatars/300-5.png"')}}/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              TLeslie Alexander
             </a>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{asset('metronic/media/avatars/300-2.png"')}}/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              Cody Fisher
             </a>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        <div class="grid">
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{asset('metronic/media/file-types/javascript.svg"')}}/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              Framework-App.js
             </span>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{asset('metronic/media/file-types/php.svg"')}}/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              appController.js
             </span>
      ...
      <div class="hidden" id="search_modal_empty">
       <div class="flex flex-col text-center py-9 gap-5">
        <div class="flex justify-center">
         <img alt="image" class="dark:hidden max-h-[113px]" src="{{asset('metronic/media/illustrations/33.svg"')}}/>
         <img alt="image" class="light:hidden max-h-[113px]" src="{{asset('metronic/media/illustrations/33-dark.svg"')}}/>
        </div>
        <div class="flex flex-col gap-1.5">
     ...
     <div class="p-5">
      <div class="grid place-items-center gap-1">
       <div class="flex justify-center items-center rounded-full">
        <img class="rounded-full max-h-[55px] max-w-full" src="{{asset('metronic/media/avatars/300-1.png"')}}/>
       </div>
  ...
  <!-- End of Page -->
  <!-- Scripts -->
  <script src="{{asset('metronic/js/core.bundle.js')}}">
  </script>
  <script src="{{asset('metronic/vendors/ktui/ktui.min.js')}}">
  </script>
  <script src="{{asset('metronic/vendors/apexcharts/apexcharts.min.js')}}">
  </script>
  <script src="{{asset('metronic/js/widgets/general.js')}}">
  </script>
  <script src="{{asset('metronic/js/layouts/demo1.js')}}">
  </script>
  <!-- End of Scripts -->
 </body>
</html>