                            ...
                            <div class="grid lg:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="app_default_currency" class="kt-select h-[45px]">
                                        <option value="SAR"
                                            {{ $settings->app_default_currency == 'SAR' ? 'selected' : '' }}>
                                            {{ __('main.sar') }} (﷼)
                                        </option>
                                        <option value="USD"
                                            {{ $settings->app_default_currency == 'USD' ? 'selected' : '' }}>
                                            {{ __('main.usd') }} ($)
                                        </option>
                                        <option value="EUR"
                                            {{ $settings->app_default_currency == 'EUR' ? 'selected' : '' }}>
                                            {{ __('main.eur') }} (€)
                                        </option>
                                        <option value="GBP"
                                            {{ $settings->app_default_currency == 'GBP' ? 'selected' : '' }}>
                                            {{ __('main.gbp') }} (£)
                                        </option>
                                    </select>
                                </div>
