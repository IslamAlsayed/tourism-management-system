...
@section('content')
    ...
    <div class="kt-container-fixed">
        <div class="grid gap-4 lg:gap-6">
            <form method="POST" action="{{ route('settings.update', $settings->id) }}" class="space-y-6">
                @csrf
                @method('PUT')
                <!-- System Information -->
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                            <div class="kt-card px-4 py-6 hover:bg-gray-100 shadow-sm">
                                <div class="text-center">
                                    <div
                                        class="mx-auto mb-3 rounded-full bg-primary/30 p-3 w-[60px] h-[60px] text-center content-center">
                                        <i class="fas fa-list-alt text-2xl text-primary"></i>
                                    </div>
                                    <div class="text-sm text-secondary-foreground">
                                        <a href="{{ route('activity-log.index') }}" class="text-primary font-semibold">
                            ...
                            <div class="kt-card px-4 py-6 hover:bg-gray-100 shadow-sm">
                                <div class="text-center">
                                    <div
                                        class="mx-auto mb-3 rounded-full bg-success/30 p-3 w-[60px] h-[60px] text-center content-center">
                                        <i class="fas fa-users text-2xl text-green-600"></i>
                                    </div>
                                    <div class="text-sm text-secondary-foreground">
                                        <a href="{{ route('users.index') }}" class="text-primary font-semibold">
                                            {{ __('main.total_users') }}
                                        </a>
                                    </div>
                            ...
                            <div class="kt-card px-4 py-6 hover:bg-gray-100 shadow-sm">
                                <div class="text-center">
                                    <div
                                        class="mx-auto mb-3 rounded-full bg-yellow/30 p-3 w-[60px] h-[60px] text-center content-center">
