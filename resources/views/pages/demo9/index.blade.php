                        ...
                        <div class="flex flex-col gap-4 pt-6">
                            ...
                            <div class="flex flex-col gap-2.5 mb-2">
                                ...
                                <span class="text-sm text-secondary-foreground leading-5">
                                    Central hub for users: view data, change settings, see activity logs, manage tasks, read
                                    notes, get alerts, and more
                                </span>
                            </div>
                        </div>
                        <div class="mb-4">
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-4 pt-6">
                            ...
                            <div class="flex flex-col gap-2.5 mb-2">
                                ...
                                <span class="text-sm text-secondary-foreground leading-5">
                                    Set passwords, enable 2FA, view login logs, update security questions, track account
                                    activity for better safety
                                </span>
                            </div>
                        </div>
                        <div class="mb-4">
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-4 pt-6">
                            ...
                            <div class="flex flex-col gap-2.5 mb-2">
                                ...
                                <span class="text-sm text-secondary-foreground leading-5">
                                    Manage billing info, update payment methods, view transaction history, set up autopay,
                                    and track expenses easily
                                </span>
                            </div>
                        </div>
                        <div class="mb-4">
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-4 pt-6">
                            ...
                            <div class="flex flex-col gap-2.5 mb-2">
                                ...
                                <span class="text-sm text-secondary-foreground leading-5">
                                    Manage members, assign roles, create teams, update permissions, view activity logs, and
                    ...
                    <div class="kt-card-content grid gap-5 lg:gap-7.5 lg:py-7.5 py-5">
                        <div class="grid gap-5">
                            ...
                            <div
                                ...
                                <div class="flex items-center flex-wrap gap-3.5">
                                    <img alt="" class="size-8 shrink-0"
                                        src="{{ asset('metronic/media/brand-logos/equacoin.svg') }}">
                                    <div class="flex flex-col">
                                        <div class="flex items-center gap-1.5">
                                            <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                                                Equacoin
                ...
                <div class="kt-card h-full">
                    ...
                    <div class="kt-card-content flex flex-col gap-5">
                        <div class="text-sm text-foreground">
                            Users on the block list are unable to send chat requests or messages to you anymore, ever, or
                            again
                        </div>
                        ...
                        <div class="flex flex-col gap-5">
                                ...
                                <div class="flex items-center gap-2.5">
                                    <div class="">
                                        <img class="h-9 rounded-full"
                                            src="{{ asset('metronic/media/avatars/gray/1.png') }}">
                                    </div>
                            ...
                            <div class="flex items-center justify-between gap-2.5">
                                <div class="flex items-center gap-2.5">
                                    <div class="">
                                        <img class="h-9 rounded-full"
                                            src="{{ asset('metronic/media/avatars/gray/2.png') }}">
                                    </div>
                                    <div class="flex flex-col gap-0.5">
                                        <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                            href="#">
                            ...
                            <div class="flex items-center justify-between gap-2.5">
                                <div class="flex items-center gap-2.5">
                                    <div class="">
                                        <img class="h-9 rounded-full"
                                            src="{{ asset('metronic/media/avatars/gray/3.png') }}">
                                    </div>
                                    <div class="flex flex-col gap-0.5">
                                        <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                            href="#">
                            ...
                            <div class="flex items-center justify-between gap-2.5">
                                <div class="flex items-center gap-2.5">
                                    <div class="">
                                        <img class="h-9 rounded-full"
                                            src="{{ asset('metronic/media/avatars/gray/4.png') }}">
                                    </div>
                                    <div class="flex flex-col gap-0.5">
                                        <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                            href="#">
                                    ...
                                    <table class="kt-table kt-table-border table-fixed" data-kt-datatable-table="true"
                                        ...
                                        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
                                            ...
                                            <div class="kt-datatable-loading">
                                                <svg class="animate-spin -ml-1 h-5 w-5 text-gray-600"
                                    ...
                                    <div class="flex items-center gap-2 order-2 md:order-1">
                                        ...
                                        <div data-kt-select-wrapper="" class="kt-select-wrapper w-16">
                                            <div data-kt-select-display="" class="kt-select-display kt-select"
                                                ...
                                                aria-expanded="false" aria-label="Select an option">5</div>
