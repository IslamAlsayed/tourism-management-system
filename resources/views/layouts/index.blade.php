                ...
                <div class="lg:col-span-1">
                    <div class="grid h-full grid-cols-2 items-stretch gap-5 lg:gap-7.5">
                        ...
                        <div
                            ...
                            <img alt="" class="ms-5 mt-4 w-7" src="assets/mediaia/brand-logos/linkedin-2.svg" />
                        ...
                        <div
                            class="kt-card channel-stats-bg h-full assets/mediaiatify-between gap-6 bg-cover bg-[right_top_-1.7rem] bg-no-repeat rtl:bg-[left_top_-1.7rem]">
                        ...
                        <div
                            class="kt-card channel-stats-bg h-full flex-col justify-between gap-6 bg-cover bg-[right_top_-1.7rem] bg-no-repeat rtl:bg-[left_top_-1.7rem]">
                            <img alt="" class="ms-5 mt-4 w-7"assets/media
                        ...
                        <div
                            class="kt-card channel-stats-bg h-full flex-col justify-between gap-6 bg-cover bg-[right_top_-1.7rem] bg-no-repeat rtl:bg-[left_top_-1.7rem]">
                            <img alt=assets/media-5 mt-4 w-7 dark:hidden" src="assets/media/brand-logos/tiktok.svg" />
