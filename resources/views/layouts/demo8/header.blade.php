...
<header class="flex items-center shrink-0 bg-background h-(--header-height)" data-kt-sticky="true"
    ...
    data-kt-sticky-name="header" data-kt-sticky-offset="100px" id="header" data-kt-sticky-initialized="true">
    <!-- Container -->
    <div class="kt-container-fixed flex lg:justify-between items-center gap-2.5">
        ...
        <div class="flex items-center gap-1 lg:w-[400px] grow lg:grow-0">
            ...
            <div class="flex items-center gap-2">
                <a href="#">
                    <img class="dark:hidden min-h-[34px]" src="{{ asset('metronic/media/app/mini-logo-circle.svg') }}">
                    <img class="hidden dark:inline-block min-h-[34px]"
                        src="{{ asset('metronic/media/app/mini-logo-circle-dark.svg') }}">
                </a>
        ...
        <div class="flex items-center gap-2 lg:gap-3.5 lg:w-[400px] justify-end">
            <div class="flex items-center gap-2 me-0.5">
                ...
                <div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px"
                    ...
                    data-kt-dropdown-initialized="true">
                    <button
                        class="kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full hover:bg-transparent hover:[&amp;_i]:text-primary"
