<!-- Header -->
<header id="header" class="flex items-center transition-[height] shrink-0 bg-background h-(--header-height)"
    data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="100px"
    ...
    <div class="kt-container-fluid flex flex-wrap justify-between items-center lg:gap-4" id="header_container">
        ...
        <div class="flex items-center gap-2 lg:gap-5">
            ...
            <a href="{{ url('demo5') }}">
                <img src="{{ asset('metronic/media/app/mini-logo-circle.svg') }}" class="dark:hidden min-h-[34px]" />
                <img src="{{ asset('metronic/media/app/mini-logo-circle-dark.svg') }}"
                    class="hidden dark:inline-block min-h-[34px]" />
            </a>
            <!-- Navs -->
            <div class="hidden lg:flex items-center">
                <!-- Nav -->
                <div class="kt-menu kt-menu-default" data-kt-menu="true">
                    <div class="kt-menu-item" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="hover"
                        data-kt-menu-item-placement="bottom-start" data-kt-menu-item-offset="0,10px">
                        ...
                        <div class="kt-menu-dropdown w-48 py-2">
                            <div class="kt-menu-item">
                                <a class="kt-menu-link" href="{{ url('demo5/public-profile/profiles/default') }}"
                                    tabindex="0">
