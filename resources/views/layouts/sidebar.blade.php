                                ...
                                @foreach ($item['children'] as $child)
                                    ...
                                    @php
                                        ...
                                        $childParameters = isset($child['parameters'])
                                            ? array_filter($child['parameters'], fn($key) => $key !== 't', ARRAY_FILTER_USE_KEY)
                                            : [];
                                        ...
                                        if (
                                            ...
                                            $child['title'] ==
                                                str_replace('tours-', 'tour-', pluralLowerCaseName(str_replace('_', '-', key($currentParameters)), '-'))
                                        ) {
                                            ...
                                            <div
                                                ...
                                                <span
                                                    ...
                                                    @if (isset($child['fixed']) && env('DB_MODE') != 'production')
                                                        <span class="inline-block bg-primary/10 text-red-600 font-medium px-2 py-0.5 rounded-full ms-2"
                                                            style="font-size: 10px">
                        ...
                        <div class="kt-menu-item">
                            <a class="kt-menu-link mb-1 flex items-center grow border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px] {{ $isActive ? 'active bg-accent/60' : '' }} hover:bg-accent/60 rounded-[9px] hover:rounded-[9px]"
                                ...
                                <span class="kt-menu-title text-sm font-medium {{ $isActive ? 'text-primary font-semibold' : '' }}">
                                    ...
                                    @if (isset($item['status']) && env('DB_MODE') != 'production')
                                        <span class="inline-block bg-primary/10 text-primary font-medium px-2 py-0.5 rounded-full ms-2"
                                            style="font-size: 10px">
                                            {{ __('sidebar.' . $item['status']) }}
                                        </span>
                                    @endif
