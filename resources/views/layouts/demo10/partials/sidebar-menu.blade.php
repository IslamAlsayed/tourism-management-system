            ...
            <div class="kt-menu-item">
                <a class="kt-menu-link py-1 px-2.5" href="https://keenthemes.com/metronic/tailwind/docs/">
                    <span
                        ...
                        <img alt="" class="size-3.5"
                            src="{{ asset('metronic/media/brand-logos/x-dark.svg') }}" />
                    </span>
                    <span
            ...
            <div class="kt-menu-item">
                <a class="kt-menu-link py-1 px-2.5" href="https://github.com/keenthemes/">
                    <span
                        class="rounded-md flex items-center justify-center size-7 bg-coal-black kt-menu-link-hover:border-none me-2">
                        <img alt="" class="size-3.5"
                            src="{{ asset('metronic/media/brand-logos/slack.svg') }}" />
                    </span>
                    <span
                        class="kt-menu-title text-sm text-secondary-foreground kt-menu-item-here:text-mono kt-menu-item-active:text-mono kt-menu-link-hover:text-mono">
                        @keenthemes_hub
            ...
            <div class="kt-menu-item">
                <a class="kt-menu-link py-1 px-2.5" href="https://keenthemes.com/metronic/tailwind/docs/">
                    <span
                        class="rounded-md flex items-center justify-center size-7 bg-coal-black kt-menu-link-hover:border-none me-2">
                        <img alt="" class="size-3.5"
                            src="{{ asset('metronic/media/brand-logos/figma.svg') }}" />
                    </span>
                    <span
                        class="kt-menu-title text-sm text-secondary-foreground kt-menu-item-here:text-mono kt-menu-item-active:text-mono kt-menu-link-hover:text-mono">
                        metronic
