            ...
            <div class="grid items-stretch gap-y-5 lg:grid-cols-3 lg:gap-7.5">
                <div class="lg:col-span-1">
                    <div class="grid h-full grid-cols-2 items-stretch gap-5 lg:gap-7.5">
                        <style>
                            .channel-stats-bg {
                                background-image: url('metronic/media/images/2600x1600/bg-3.png');
                            }

                            .dark .channel-stats-bg {
                                background-image: url('metronic/media/images/2600x1600/bg-3-dark.png');
                            }
                        </style>
                        <div
                            ...
                            <img alt="" class="ms-5 mt-4 w-7"
                                src="{{ asset('metronic/media/brand-logos/linkedin-2.svg') }}" />
                        ...
                        <div
                            class="kt-card channel-stats-bg h-full flex-col justify-between gap-6 bg-cover bg-[right_top_-1.7rem] bg-no-repeat rtl:bg-[left_top_-1.7rem]">
                            <img alt="" class="ms-5 mt-4 w-7"
                                src="{{ asset('metronic/media/brand-logos/youtube-2.svg') }}" />
                            <div class="flex flex-col gap-1 px-5 pb-4">
                                <span class="text-3xl font-semibold text-mono">
                                    24k
                                </span>
                        ...
                        <div
                            class="kt-card channel-stats-bg h-full flex-col justify-between gap-6 bg-cover bg-[right_top_-1.7rem] bg-no-repeat rtl:bg-[left_top_-1.7rem]">
                            <img alt="" class="ms-5 mt-4 w-7"
                                src="{{ asset('metronic/media/brand-logos/instagram-03.svg') }}" />
                            <div class="flex flex-col gap-1 px-5 pb-4">
                                <span class="text-3xl font-semibold text-mono">
                                    608
                                </span>
                        ...
                        <div
                            ...
                            <img alt="" class="ms-5 mt-4 w-7 dark:hidden"
                                src="{{ asset('metronic/media/brand-logos/tiktok.svg') }}" />
                            <img alt="" class="ms-5 mt-4 hidden w-7 dark:block"
                                src="{{ asset('metronic/media/brand-logos/tiktok-dark.svg') }}" />
                            <div class="flex flex-col gap-1 px-5 pb-4">
                                <span class="text-3xl font-semibold text-mono">
                                    2.5k
                                </span>
                ...
                <div class="lg:col-span-2">
                    <style>
                        .entry-callout-bg {
                            background-image: url('metronic/media/images/2600x1600/2.png');
                        }

                        .dark .entry-callout-bg {
                            background-image: url('metronic/media/images/2600x1600/2-dark.png');
                        }
                    </style>
                        ...
                        <div class="kt-card-content p-5 lg:p-7.5 lg:pt-6">
                            <div class="mb-7.5 flex flex-wrap items-center justify-between gap-5">
                                ...
                                <img alt="" class="size-7"
                                    src="{{ asset('metronic/media/brand-logos/zoom.svg') }}" />
                            </div>
